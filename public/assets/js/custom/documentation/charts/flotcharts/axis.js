...
var KTFlotDemoAxis = (function () {
    var i = function () {
        ...
        $.plot(
            ...
            ],
            {
                ...
                xaxis: {
                    ticks: 11,
                    tickDecimals: 0,
                    tickColor: KTUtil.getCssVariableValue("--bs-dark"),
                },
                yaxis: {
                    ticks: 11,
                    tickDecimals: 0,
        ...
        var a = null;
        $("#chart_2").bind("plothover", function (i, e, t) {
            if (
                ($("#x").text(e.x.toFixed(2)), $("#y").text(e.y.toFixed(2)), t)
            ) {
                if (a != t.dataIndex) {
                    ((a = t.dataIndex), $("#tooltip").remove());
                    var o = t.datapoint[0].toFixed(2),
                        l = t.datapoint[1].toFixed(2);
                    !(function (i, e, t) {
                        $('<div id="tooltip">' + t + "</div>")
                            .css({
                                position: "absolute",
                                display: "none",
                                top: e + 5,
