                    ...
                    templates: {
                        tag: function (e) {
                            const a =
                                ...
                                ".svg";
                            try {
                                return `<tag ${this.getAttributes(e)} title='${e.value}' contenteditable='false' spellcheck="false" class='tagify__tag ${e.class ? e.class : ""}'>\n                                <x title='remove tag' class='tagify__tag__removeBtn'></x>\n                                <div class="d-flex align-items-center">\n                                    ${e.code ? `<img onerror="this.style.visibility = 'hidden'" class="w-25px rounded-circle me-2" src='${a}' />` : ""}\n                                    <span class='tagify__tag-text'>${e.value}</span>\n                                </div>\n                            </tag>`;
                            } catch (e) {}
                        },
                        dropdownItem: function (e) {
                            const a =
                                ...
                                ".svg";
                            try {
                                return `<div ${this.getAttributes(e)} class='tagify__dropdown__item ${e.class ? e.class : ""}'>\n                                    <img onerror="this.style.visibility = 'hidden'" class="w-25px rounded-circle me-2"\n                                         src='${a}' />\n                                    <span>${e.value}</span>\n                                </div>`;
                            } catch (e) {}
                        },
                    },
                    enforceWhitelist: !0,
