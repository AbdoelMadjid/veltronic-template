    ...
    var t = function () {
        ...
        ($("#showtoast").on("click", function () {
            ...
            ((toastr.options = {
                ...
                p.val().length &&
                    (toastr.options.extendedTimeOut = f ? 0 : p.val()),
                u.val().length && (toastr.options.showEasing = u.val()),
                h.val().length && (toastr.options.hideEasing = h.val()),
                ...
                f &&
                    ((s = (function (t) {
                        return (
                            (t = t || "Clear itself?"),
                            t +
                                '<br /><br /><button type="button" class="btn btn-outline-light btn-sm">Yes</button>'
                        );
                    })(s)),
