...
var KTLayoutBuilder = (function () {
    var e = document.querySelector("#kt_layout_builder_form"),
        t = document.querySelector("#kt_layout_builder_action"),
        o = document.querySelector("#kt_layout_builder_tab"),
        r = e.getAttribute("action"),
        a = document.querySelector("#kt_layout_builder_preview"),
        ...
        init: function () {
            ...
            (a.addEventListener("click", function (o) {
                ...
                [].slice
                    ...
                    .forEach(function (e) {
                        e.addEventListener("shown.bs.tab", function (t) {
                            o.value = e.getAttribute("href").substring(1);
                        });
                    }),
