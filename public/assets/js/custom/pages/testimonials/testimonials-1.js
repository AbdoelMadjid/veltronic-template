                ...
                (a.data.setAll([
                    {
                        ...
                        settings: {
                            fill: n.next(),
                            fillPattern: am5.LinePattern.new(e, {
                                color: am5.color(16777215),
                                rotation: 45,
                                strokeWidth: 1,
                            }),
                        },
                    },
                    {
                        ...
                        settings: {
                            fill: n.next(),
                            fillPattern: am5.RectanglePattern.new(e, {
                                color: am5.color(16777215),
                                checkered: !0,
                            }),
                        },
                    },
                    {
                        ...
                        settings: {
                            fill: n.next(),
                            fillPattern: am5.CirclePattern.new(e, {
                                color: am5.color(16777215),
                                checkered: !0,
                            }),
                        },
                    ...
                    KTThemeMode.on("kt.thememode.change", function () {
                        (t.rendered && t.self.destroy(), initChart());
                    }));
            }
        })();
    },
