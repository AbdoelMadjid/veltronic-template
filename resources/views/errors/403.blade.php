...
@section('title', getPageTitle() ?: '403 Forbidden')
                    ...
                    <div class="card-body p-7 p-lg-12">
                        ...
                        <div class="d-flex flex-column flex-center text-center">
                            ...
                            <h2 class="fw-bolder fs-2hx text-gray-900 mb-3">
                                {{ __('Akses Ditolak (403 Forbidden)') }}
                            </h2>
                            <!--end::Title-->

                            <!--begin::Description-->
                            <div class="fw-semibold fs-5 text-gray-600 mb-8 max-w-600px">
                                {{ (isset($exception) && $exception->getMessage()) ? $exception->getMessage() : __('Anda tidak memiliki hak akses atau izin (permission) yang cukup untuk membuka halaman ini.') }}
                            </div>
                            <!--end::Description-->
                            ...
                            <div class="notice d-flex bg-light-danger rounded border-danger border border-dashed p-6 text-start mb-8 mw-650px w-100">
                                ...
                                <div class="d-flex flex-stack flex-grow-1">
                                    <div class="fw-semibold">
                                        <h4 class="text-gray-900 fw-bold mb-2">Informasi Akses & Permission</h4>
                                        <div class="fs-6 text-gray-700">
                                            ...
                                            @endif
                                            <div><span class="fw-bold text-gray-800">Status:</span> <span class="badge badge-light-danger fw-bold">403 Unauthorized Access</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
