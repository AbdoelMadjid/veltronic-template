                        ...
                        <div class="container">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-flex align-items-center flex-equal">
                                    ...
                                    <!--begin::Logo image-->
                                    <a href="/">
                                        <img alt="Logo" src="{{ \App\Support\ThemeAsset::url('media/logos/landing.svg', $theme_asset_pack ?? null) }}"
                                            class="logo-default h-25px h-lg-30px" />
                                        <img alt="Logo" src="{{ \App\Support\ThemeAsset::url('media/logos/landing-dark.svg', $theme_asset_pack ?? null) }}"
                    ...
                    <div class="tns tns-default" style="direction: ltr">
                        ...
                        <div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000"
                            ...
                            <div class="text-center">
                                ...
                                <div class="mb-0">
                                    <!--begin::Name-->
                                    <a href="javascript:void(0)" class="text-gray-900 fw-bold text-hover-primary fs-3">Melisa
                                        Marcus</a>
                                    <!--end::Name-->
                                    <!--begin::Position-->
                            ...
                            <div class="text-center">
                                ...
                                <div class="mb-0">
                                    <!--begin::Name-->
                                    <a href="javascript:void(0)" class="text-gray-900 fw-bold text-hover-primary fs-3">Carles
                                        Puyol</a>
                                    <!--end::Name-->
                                    <!--begin::Position-->
                            ...
                            <div
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-circle symbol-50px me-5">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-1.jpg', $theme_asset_pack ?? null) }}" class=""
                                            alt="" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Name-->
                        ...
                        <div class="col-lg-4">
                            ...
                            <div
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-circle symbol-50px me-5">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-2.jpg', $theme_asset_pack ?? null) }}" class=""
                                            alt="" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Name-->
                        ...
                        <div class="col-lg-4">
                            ...
                            <div
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-circle symbol-50px me-5">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-16.jpg', $theme_asset_pack ?? null) }}" class=""
                                            alt="" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Name-->
