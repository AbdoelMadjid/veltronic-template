    ...
    <div class="col-lg-8">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 mb-6 mb-lg-0">
                <!--begin:Menu heading-->
                <h4 class="fs-6 fs-lg-4 fw-bold mb-3 ms-4" data-kt-translate="menu.user_profile">{{ __('menu.user_profile') }}</h4>
                <!--end:Menu heading-->
                <!--begin:Menu item-->
            ...
            <div class="col-lg-3 mb-6 mb-lg-0">
                ...
                <div class="mb-6">
                    <!--begin:Menu heading-->
                    <h4 class="fs-6 fs-lg-4 fw-bold mb-3 ms-4" data-kt-translate="menu.corporate">{{ __('menu.corporate') }}</h4>
                    <!--end:Menu heading-->
                    <!--begin:Menu item-->
                ...
                <div class="mb-0">
                    <!--begin:Menu heading-->
                    <h4 class="fs-6 fs-lg-4 fw-bold mb-3 ms-4" data-kt-translate="menu.careers">{{ __('menu.careers') }}</h4>
                    <!--end:Menu heading-->
                    <!--begin:Menu item-->
            ...
            <div class="col-lg-3 mb-6 mb-lg-0">
                ...
                <div class="mb-6">
                    <!--begin:Menu heading-->
                    <h4 class="fs-6 fs-lg-4 fw-bold mb-3 ms-4" data-kt-translate="menu.faq">{{ __('menu.faq') }}</h4>
                    <!--end:Menu heading-->
                    <!--begin:Menu item-->
                ...
                <div class="mb-6">
                    <!--begin:Menu heading-->
                    <h4 class="fs-6 fs-lg-4 fw-bold mb-3 ms-4" data-kt-translate="menu.blog">{{ __('menu.blog') }}</h4>
                    <!--end:Menu heading-->
                    <!--begin:Menu item-->
                ...
                <div class="mb-0">
                    <!--begin:Menu heading-->
                    <h4 class="fs-6 fs-lg-4 fw-bold mb-3 ms-4" data-kt-translate="menu.pricing">{{ __('menu.pricing') }}</h4>
                    <!--end:Menu heading-->
                    <!--begin:Menu item-->
            ...
            <div class="col-lg-3 mb-6 mb-lg-0">
                ...
                <div class="mb-0">
                    <!--begin:Menu heading-->
                    <h4 class="fs-6 fs-lg-4 fw-bold mb-3 ms-4" data-kt-translate="menu.social">{{ __('menu.social') }}</h4>
                    <!--end:Menu heading-->
                    <!--begin:Menu item-->
