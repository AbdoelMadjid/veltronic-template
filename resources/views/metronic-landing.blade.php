...
<body id="kt_body" data-bs-spy="scroll" data-bs-target="#kt_landing_menu" class="bg-body position-relative app-blank">
                    ...
                    <div class="container">
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="d-flex align-items-center flex-equal">
                                ...
                                <a href="/">
                                    <img alt="Logo"
                                        src="{{ \App\Support\ThemeAsset::url('media/logos/landing.svg', $theme_asset_pack ?? null) }}"
                                        class="logo-default h-25px h-lg-30px" />
                                    <img alt="Logo"
                                        src="{{ \App\Support\ThemeAsset::url('media/logos/landing-dark.svg', $theme_asset_pack ?? null) }}"
                ...
                <div class="row w-100 gy-10 mb-md-20">
                    ...
                    <div class="col-md-4 px-5">
                        ...
                        <div class="text-center mb-10 mb-md-0">
                            <!--begin::Illustration-->
                            <img src="{{ \App\Support\ThemeAsset::url('media/illustrations/sketchy-1/2.png', $theme_asset_pack ?? null) }}"
                    ...
                    <div class="col-md-4 px-5">
                        ...
                        <div class="text-center mb-10 mb-md-0">
                            <!--begin::Illustration-->
                            <img src="{{ \App\Support\ThemeAsset::url('media/illustrations/sketchy-1/8.png', $theme_asset_pack ?? null) }}"
                                class="mh-125px mb-9" alt="" />
                            <!--end::Illustration-->
                            <!--begin::Heading-->
                            <div class="d-flex flex-center mb-5">
                    ...
                    <div class="col-md-4 px-5">
                        ...
                        <div class="text-center mb-10 mb-md-0">
                            <!--begin::Illustration-->
                            <img src="{{ \App\Support\ThemeAsset::url('media/illustrations/sketchy-1/12.png', $theme_asset_pack ?? null) }}"
                                class="mh-125px mb-9" alt="" />
                            <!--end::Illustration-->
                            <!--begin::Heading-->
                            <div class="d-flex flex-center mb-5">
                ...
                <div class="tns tns-default">
                    ...
                    <div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000"
                        ...
                        <div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
                            <img src="{{ \App\Support\ThemeAsset::url('media/preview/demos/demo1/light-ltr.png', $theme_asset_pack ?? null) }}"
                                class="card-rounded shadow mh-lg-650px mw-100" alt="" />
                        </div>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
                            <img src="{{ \App\Support\ThemeAsset::url('media/preview/demos/demo2/light-ltr.png', $theme_asset_pack ?? null) }}"
                                class="card-rounded shadow mh-lg-650px mw-100" alt="" />
                        </div>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
                            <img src="{{ \App\Support\ThemeAsset::url('media/preview/demos/demo4/light-ltr.png', $theme_asset_pack ?? null) }}"
                                class="card-rounded shadow mh-lg-650px mw-100" alt="" />
                        </div>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
                            <img src="{{ \App\Support\ThemeAsset::url('media/preview/demos/demo5/light-ltr.png', $theme_asset_pack ?? null) }}"
                                class="card-rounded shadow mh-lg-650px mw-100" alt="" />
                        </div>
                        <!--end::Item-->
                    </div>
                    ...
                    <div class="d-flex flex-center">
                        ...
                        <div class="d-flex flex-wrap flex-center justify-content-lg-between mb-15 mx-auto w-xl-900px">
                            ...
                            <div class="d-flex flex-column flex-center h-200px w-200px h-lg-250px w-lg-250px m-3 bgi-no-repeat bgi-position-center bgi-size-contain"
                                style="background-image: url('{{ \App\Support\ThemeAsset::url('media/svg/misc/octagon.svg', $theme_asset_pack ?? null) }}');">
                                <!--begin::Symbol-->
                    ...
                    <div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000"
                        ...
                        <div class="text-center">
                            ...
                            <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                style="background-image: url('{{ \App\Support\ThemeAsset::url('media/avatars/300-1.jpg', $theme_asset_pack ?? null) }}');">
                            </div>
                            <!--end::Photo-->
                            <!--begin::Person-->
                            <div class="mb-0">
                        ...
                        <div class="text-center">
                            <!--begin::Photo-->
                            <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                style="background-image: url('{{ \App\Support\ThemeAsset::url('media/avatars/300-2.jpg', $theme_asset_pack ?? null) }}');">
                            </div>
                            <!--end::Photo-->
                            <!--begin::Person-->
                            <div class="mb-0">
                        ...
                        <div class="text-center">
                            <!--begin::Photo-->
                            <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                style="background-image: url('{{ \App\Support\ThemeAsset::url('media/avatars/300-5.jpg', $theme_asset_pack ?? null) }}');">
                            </div>
                            <!--end::Photo-->
                            <!--begin::Person-->
                            <div class="mb-0">
                        ...
                        <div class="text-center">
                            <!--begin::Photo-->
                            <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                style="background-image: url('{{ \App\Support\ThemeAsset::url('media/avatars/300-20.jpg', $theme_asset_pack ?? null) }}');">
                            </div>
                            <!--end::Photo-->
                            <!--begin::Person-->
                            <div class="mb-0">
                        ...
                        <div class="text-center">
                            <!--begin::Photo-->
                            <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                style="background-image: url('{{ \App\Support\ThemeAsset::url('media/avatars/300-23.jpg', $theme_asset_pack ?? null) }}');">
                            </div>
                            <!--end::Photo-->
                            <!--begin::Person-->
                            <div class="mb-0">
                        ...
                        <div class="text-center">
                            <!--begin::Photo-->
                            <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                style="background-image: url('{{ \App\Support\ThemeAsset::url('media/avatars/300-12.jpg', $theme_asset_pack ?? null) }}');">
                            </div>
                            <!--end::Photo-->
                            <!--begin::Person-->
                            <div class="mb-0">
                        ...
                        <div class="text-center">
                            <!--begin::Photo-->
                            <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                style="background-image: url('{{ \App\Support\ThemeAsset::url('media/avatars/300-9.jpg', $theme_asset_pack ?? null) }}');">
                            </div>
                            <!--end::Photo-->
                            <!--begin::Person-->
                            <div class="mb-0">
                                ...
                                <div class="row g-10">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <a class="d-block card-rounded overlay h-lg-100"
                                            ...
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-lg-100 min-h-250px"
                                                style="background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-23.jpg', $theme_asset_pack ?? null) }}');">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="row g-10 mb-10">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <a class="d-block card-rounded overlay"
                                                    ...
                                                    <!--begin::Image-->
                                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                                        style="background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-21.jpg', $theme_asset_pack ?? null) }}');">
                                                    </div>
                                                    <!--end::Image-->
                                                    <!--begin::Action-->
                                                    <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                        ...
                                        <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects"
                                            href="{{ \App\Support\ThemeAsset::url('media/stock/600x400/img-20.jpg', $theme_asset_pack ?? null) }}">
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                                style="background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-20.jpg', $theme_asset_pack ?? null) }}');">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                            <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                            ...
                            <div class="tab-pane fade" id="kt_landing_projects_web_design">
                                ...
                                <div class="row g-10">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <a class="d-block card-rounded overlay h-lg-100"
                                            data-fslightbox="lightbox-projects"
                                            href="{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-11.jpg', $theme_asset_pack ?? null) }}">
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-lg-100 min-h-250px"
                                                style="background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-11.jpg', $theme_asset_pack ?? null) }}');">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                            <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="row g-10 mb-10">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <a class="d-block card-rounded overlay"
                                                    data-fslightbox="lightbox-projects"
                                                    href="{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-12.jpg', $theme_asset_pack ?? null) }}">
                                                    <!--begin::Image-->
                                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="row g-10 mb-10">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <a class="d-block card-rounded overlay"
                                                    data-fslightbox="lightbox-projects"
                                                    href="{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-16.jpg', $theme_asset_pack ?? null) }}">
                                                    <!--begin::Image-->
                                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                                        style="background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-16.jpg', $theme_asset_pack ?? null) }}');">
                                                    </div>
                                                    <!--end::Image-->
                                                    <!--begin::Action-->
                                                    <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                        ...
                                        <!--begin::Item-->
                                        <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects"
                                            href="{{ \App\Support\ThemeAsset::url('media/stock/600x400/img-15.jpg', $theme_asset_pack ?? null) }}">
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                                style="background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-15.jpg', $theme_asset_pack ?? null) }}');">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                            <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                            ...
                            <div class="tab-pane fade" id="kt_landing_projects_development">
                                ...
                                <div class="row g-10">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <a class="d-block card-rounded overlay h-lg-100"
                                            data-fslightbox="lightbox-projects"
                                            href="{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-15.jpg', $theme_asset_pack ?? null) }}">
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-lg-100 min-h-250px"
                                                style="background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-15.jpg', $theme_asset_pack ?? null) }}');">
                                            </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <!--begin::Item-->
                                        <a class="d-block card-rounded overlay" data-fslightbox="lightbox-projects"
                                            href="{{ \App\Support\ThemeAsset::url('media/stock/600x400/img-14.jpg', $theme_asset_pack ?? null) }}">
                                            <!--begin::Image-->
                                            <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-250px"
                                                style="background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-14.jpg', $theme_asset_pack ?? null) }}');">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                            <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                        ...
                        <div
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-circle symbol-50px me-5">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-1.jpg', $theme_asset_pack ?? null) }}"
                                        class="" alt="" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Name-->
                                <div class="flex-grow-1">
                                    <a href="javascript:void(0)"
                                        class="text-gray-900 fw-bold text-hover-primary fs-6">Paul
                                        Miles</a>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    <a href="javascript:void(0)"
                                        class="text-gray-900 fw-bold text-hover-primary fs-6">Janya
                                        Clebert</a>
                                    <span class="text-muted d-block fw-bold">Development Lead</span>
                                </div>
                                <!--end::Name-->
                    ...
                    <div class="col-lg-4">
                        ...
                        <div
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-circle symbol-50px me-5">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-16.jpg', $theme_asset_pack ?? null) }}"
                                        class="" alt="" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Name-->
                                <div class="flex-grow-1">
                                    <a href="javascript:void(0)"
                                        class="text-gray-900 fw-bold text-hover-primary fs-6">Steave
                                        Brown</a>
                                    <span class="text-muted d-block fw-bold">Development Lead</span>
                                </div>
                                <!--end::Name-->
    ...
    <script
        src="{{ \App\Support\ThemeAsset::url('plugins/custom/typedjs/typedjs.bundle.js', $theme_asset_pack ?? null) }}">
    </script>
    <!--end::Vendors Javascript-->
    <!--begin::Custom Javascript(used for this page only)-->
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/landing.js', $theme_asset_pack ?? null) }}"></script>
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/pages/pricing/general.js', $theme_asset_pack ?? null) }}">
    </script>
