                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('apps/customers/view') }}" class="text-gray-800 text-hover-primary mb-1">Emma
                                        Smith</a>
                                </td>
                                <td>
                                    <a href="javascript:void(0)" class="text-gray-600 text-hover-primary mb-1">smith@kpmg.com</a>
                                </td>
                                <td>-</td>
                                <td data-filter="mastercard">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/card-logos/mastercard.svg', $theme_asset_pack ?? null) }}" class="w-35px me-3"
                                        alt="" />**** 6915
                                </td>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{ url('apps/customers/view') }}" class="menu-link px-3">View</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:void(0)" class="text-gray-600 text-hover-primary mb-1">melody@altbox.com</a>
                                </td>
                                <td>Google</td>
                                <td data-filter="visa">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/card-logos/visa.svg', $theme_asset_pack ?? null) }}" class="w-35px me-3"
                                        alt="" />**** 9936
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('apps/customers/view') }}" class="text-gray-800 text-hover-primary mb-1">Max
                                        Smith</a>
                                </td>
                                <td>
                                    <a href="javascript:void(0)" class="text-gray-600 text-hover-primary mb-1">max@kt.com</a>
                                </td>
                                <td>Bistro Union</td>
                                <td data-filter="mastercard">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/card-logos/mastercard.svg', $theme_asset_pack ?? null) }}" class="w-35px me-3"
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('apps/customers/view') }}" class="text-gray-800 text-hover-primary mb-1">Sean
                                        Bean</a>
                                </td>
                                <td>
                                    <a href="javascript:void(0)" class="text-gray-600 text-hover-primary mb-1">sean@dellito.com</a>
                                </td>
                                <td>Astro Limited</td>
                                <td data-filter="american_express">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/card-logos/american-express.svg', $theme_asset_pack ?? null) }}" class="w-35px me-3"
                                        alt="" />**** 1031
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('apps/customers/view') }}" class="text-gray-800 text-hover-primary mb-1">Brian
                                        Cox</a>
                                </td>
                                <td>
                                    <a href="javascript:void(0)" class="text-gray-600 text-hover-primary mb-1">brian@exchange.com</a>
                                </td>
                                <td>-</td>
                                <td data-filter="visa">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/card-logos/visa.svg', $theme_asset_pack ?? null) }}" class="w-35px me-3"
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:void(0)" class="text-gray-600 text-hover-primary mb-1">mik@pex.com</a>
                                </td>
                                <td>Keenthemes</td>
                                <td data-filter="american_express">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/card-logos/american-express.svg', $theme_asset_pack ?? null) }}" class="w-35px me-3"
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:void(0)" class="text-gray-600 text-hover-primary mb-1">f.mit@kpmg.com</a>
                                </td>
                                <td>Paypal</td>
                                <td data-filter="mastercard">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/card-logos/mastercard.svg', $theme_asset_pack ?? null) }}" class="w-35px me-3"
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('apps/customers/view') }}" class="text-gray-800 text-hover-primary mb-1">Neil
                                        Owen</a>
                                </td>
                                <td>
                                    <a href="javascript:void(0)"
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('apps/customers/view') }}" class="text-gray-800 text-hover-primary mb-1">Dan
                                        Wilson</a>
                                </td>
                                <td>
                                    <a href="javascript:void(0)" class="text-gray-600 text-hover-primary mb-1">dam@consilting.com</a>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:void(0)" class="text-gray-600 text-hover-primary mb-1">emma@intenso.com</a>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('apps/customers/view') }}" class="text-gray-800 text-hover-primary mb-1">Ana
                                        Crown</a>
                                </td>
                                <td>
                                    <a href="javascript:void(0)" class="text-gray-600 text-hover-primary mb-1">ana.cf@limtel.com</a>
                                </td>
...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/customers/list/export.js', $theme_asset_pack ?? null) }}"></script>
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/customers/list/list.js', $theme_asset_pack ?? null) }}"></script>
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/customers/add.js', $theme_asset_pack ?? null) }}"></script>
