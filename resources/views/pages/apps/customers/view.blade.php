                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-body pt-15">
                            ...
                            <div class="d-flex flex-center flex-column mb-5">
                                ...
                                <!--end::Avatar-->
                                <!--begin::Name-->
                                <a href="javascript:void(0)" class="fs-3 text-gray-800 text-hover-primary fw-bold mb-1">Max Smith</a>
                                <!--end::Name-->
                                <!--begin::Position-->
                                            ...
                                            <tr>
                                                ...
                                                <td class="pe-0 text-end">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                        ...
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="{{ url('apps/customers/view') }}"
                                    ...
                                    <div class="py-0" data-kt-customer-payment-method="row">
                                        ...
                                        <div class="py-3 d-flex flex-stack flex-wrap">
                                            ...
                                            <div class="d-flex align-items-center collapsible rotate"
                                                ...
                                                <!--end::Arrow-->
                                                <!--begin::Logo-->
                                                <img src="{{ \App\Support\ThemeAsset::url('media/svg/card-logos/mastercard.svg', $theme_asset_pack ?? null) }}" class="w-40px me-3"
                                                    alt="" />
                                                <!--end::Logo-->
                                                <!--begin::Summary-->
                                                <div class="me-3">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-gray-800">
                                                                ...
                                                                <div class="symbol symbol-20px symbol-circle ms-2">
                                                                    <img src="{{ \App\Support\ThemeAsset::url('media/flags/australia.svg', $theme_asset_pack ?? null) }}" />
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                    ...
                                    <div class="py-0" data-kt-customer-payment-method="row">
                                        ...
                                        <div class="py-3 d-flex flex-stack flex-wrap">
                                            ...
                                            <div class="d-flex align-items-center collapsible collapsed rotate"
                                                ...
                                                <!--end::Arrow-->
                                                <!--begin::Logo-->
                                                <img src="{{ \App\Support\ThemeAsset::url('media/svg/card-logos/visa.svg', $theme_asset_pack ?? null) }}" class="w-40px me-3"
                                                    alt="" />
                                                <!--end::Logo-->
                                                <!--begin::Summary-->
                                                <div class="me-3">
                                                    ...
                                                    <table class="table table-flush fw-semibold gy-1">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-gray-800">
                                                                United Kingdom
                                                                <div class="symbol symbol-20px symbol-circle ms-2">
                                                                    <img src="{{ \App\Support\ThemeAsset::url('media/flags/united-kingdom.svg', $theme_asset_pack ?? null) }}" />
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                    ...
                                    <div class="py-0" data-kt-customer-payment-method="row">
                                        ...
                                        <div class="py-3 d-flex flex-stack flex-wrap">
                                            ...
                                            <div class="d-flex align-items-center collapsible collapsed rotate"
                                                ...
                                                <!--end::Arrow-->
                                                <!--begin::Logo-->
                                                <img src="{{ \App\Support\ThemeAsset::url('media/svg/card-logos/american-express.svg', $theme_asset_pack ?? null) }}"
                                                    ...
                                                    <table class="table table-flush fw-semibold gy-1">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-gray-800">
                                                                ...
                                                                <div class="symbol symbol-20px symbol-circle ms-2">
                                                                    <img src="{{ \App\Support\ThemeAsset::url('media/flags/united-states.svg', $theme_asset_pack ?? null) }}" />
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                            ...
                            <div class="card mb-6 mb-xl-9">
                                ...
                                <div class="card-body py-0">
                                    ...
                                    <div class="d-flex flex-wrap flex-stack mb-5">
                                        ...
                                        <!--end::Row-->
                                        <a href="javascript:void(0)" class="btn btn-sm btn-light-primary flex-shrink-0">Withdraw
                                            Earnings</a>
                                    </div>
                                    <!--end::Left Section-->
                                </div>
                                    ...
                                    <div id="kt_modal_update_customer_user_info" class="collapse show">
                                      ...
                                      ">
                                                    ...
                                                    <div class="image-input-wrapper w-125px h-125px"
                                                        style="
                                          background-image: url('{{ \App\Support\ThemeAsset::url('media/avatars/300-1.jpg', $theme_asset_pack ?? null) }}');
                                        ">
                                                    </div>
                                ...
                                <div class="d-flex flex-column mb-7 fv-row">
                                    ...
                                    <div class="position-relative">
                                        ...
                                        <div class="position-absolute translate-middle-y top-50 end-0 me-5">
                                            <img src="{{ \App\Support\ThemeAsset::url('media/svg/card-logos/visa.svg', $theme_asset_pack ?? null) }}" alt=""
                                                class="h-25px" />
                                            <img src="{{ \App\Support\ThemeAsset::url('media/svg/card-logos/mastercard.svg', $theme_asset_pack ?? null) }}" alt=""
                                                class="h-25px" />
                                            <img src="{{ \App\Support\ThemeAsset::url('media/svg/card-logos/american-express.svg', $theme_asset_pack ?? null) }}" alt=""
                                                class="h-25px" />
                                        </div>
                                        <!--end::Card logos-->
                                    </div>
...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/customers/view/add-payment.js', $theme_asset_pack ?? null) }}"></script>
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/customers/view/adjust-balance.js', $theme_asset_pack ?? null) }}"></script>
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/customers/view/invoices.js', $theme_asset_pack ?? null) }}"></script>
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/customers/view/payment-method.js', $theme_asset_pack ?? null) }}"></script>
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/customers/view/payment-table.js', $theme_asset_pack ?? null) }}"></script>
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/customers/view/statement.js', $theme_asset_pack ?? null) }}"></script>
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/customers/update.js', $theme_asset_pack ?? null) }}"></script>
