                                    ...
                                    <div class="d-flex">
                                        ...
                                        <a href="/apps/ecommerce/catalog/edit-category" class="symbol symbol-50px">
                                            <span class="symbol-label"
                                                style="
                                      background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/ecommerce/68.png', $theme_asset_pack ?? null) }}');
                                    "></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <a href="/apps/ecommerce/catalog/edit-category" class="symbol symbol-50px">
                                            <span class="symbol-label"
                                                style="
                                      background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/ecommerce/71.png', $theme_asset_pack ?? null) }}');
                                    "></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <a href="/apps/ecommerce/catalog/edit-category" class="symbol symbol-50px">
                                            <span class="symbol-label"
                                                style="
                                      background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/ecommerce/58.png', $theme_asset_pack ?? null) }}');
                                    "></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <a href="/apps/ecommerce/catalog/edit-category" class="symbol symbol-50px">
                                            <span class="symbol-label"
                                                style="
                                      background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/ecommerce/52.png', $theme_asset_pack ?? null) }}');
                                    "></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <a href="/apps/ecommerce/catalog/edit-category" class="symbol symbol-50px">
                                            <span class="symbol-label"
                                                style="
                                      background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/ecommerce/76.png', $theme_asset_pack ?? null) }}');
                                    "></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <a href="/apps/ecommerce/catalog/edit-category" class="symbol symbol-50px">
                                            <span class="symbol-label"
                                                style="
                                      background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/ecommerce/207.png', $theme_asset_pack ?? null) }}');
                                    "></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <a href="/apps/ecommerce/catalog/edit-category" class="symbol symbol-50px">
                                            <span class="symbol-label"
                                                style="
                                      background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/ecommerce/193.png', $theme_asset_pack ?? null) }}');
                                    "></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <a href="/apps/ecommerce/catalog/edit-category" class="symbol symbol-50px">
                                            <span class="symbol-label"
                                                style="
                                      background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/ecommerce/169.png', $theme_asset_pack ?? null) }}');
                                    "></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <a href="/apps/ecommerce/catalog/edit-category" class="symbol symbol-50px">
                                            <span class="symbol-label"
                                                style="
                                      background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/ecommerce/177.png', $theme_asset_pack ?? null) }}');
                                    "></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        <a href="/apps/ecommerce/catalog/edit-category" class="symbol symbol-50px">
                                            <span class="symbol-label"
                                                style="
                                      background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/ecommerce/151.png', $theme_asset_pack ?? null) }}');
                                    "></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/ecommerce/catalog/categories.js', $theme_asset_pack ?? null) }}"></script>
