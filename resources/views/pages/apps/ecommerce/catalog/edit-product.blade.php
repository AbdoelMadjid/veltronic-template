                        ...
                        <div class="card-body text-center pt-0">
                            ...
                            <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3"
                                ...
                                <div class="image-input-wrapper w-150px h-150px"
                                    style="background-image: url('{{ \App\Support\ThemeAsset::url('media//stock/ecommerce/78.png', $theme_asset_pack ?? null) }}');">
                                </div>
                                                    ...
                                                    <td>
                                                        <a href="apps/inbox/reply"
                                                            ...
                                                            <div class="symbol symbol-circle symbol-25px me-3">
                                                                <span class="symbol-label"
                                                                    style="
                                                background-image: url('{{ \App\Support\ThemeAsset::url('media/avatars/300-5.jpg', $theme_asset_pack ?? null) }}');
                                              "></span>
                                                            </div>
                                                            <!--end::Avatar-->
                                                            <!--begin::Name-->
                                                    ...
                                                    <td>
                                                        <a href="apps/inbox/reply"
                                                            ...
                                                            <div class="symbol symbol-circle symbol-25px me-3">
                                                                <span class="symbol-label"
                                                                    style="
                                                background-image: url('{{ \App\Support\ThemeAsset::url('media/avatars/300-25.jpg', $theme_asset_pack ?? null) }}');
                                              "></span>
                                                            </div>
                                                            <!--end::Avatar-->
                                                            <!--begin::Name-->
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="apps/inbox/reply"
                                                            ...
                                                            <div class="symbol symbol-circle symbol-25px me-3">
                                                                <span class="symbol-label"
                                                                    style="background-image: url('{{ \App\Support\ThemeAsset::url('media/avatars/300-9.jpg', $theme_asset_pack ?? null) }}');"></span>
                                                            </div>
                                                            <!--end::Avatar-->
                                                            <!--begin::Name-->
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="apps/inbox/reply"
                                                            ...
                                                            <div class="symbol symbol-circle symbol-25px me-3">
                                                                <span class="symbol-label"
                                                                    style="background-image: url('{{ \App\Support\ThemeAsset::url('media/avatars/300-13.jpg', $theme_asset_pack ?? null) }}');"></span>
                                                            </div>
                                                            <!--end::Avatar-->
                                                            <!--begin::Name-->
...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/ecommerce/catalog/save-product.js', $theme_asset_pack ?? null) }}"></script>
