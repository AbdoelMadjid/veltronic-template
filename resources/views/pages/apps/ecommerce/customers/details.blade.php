                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-body pt-15">
                            ...
                            <div class="d-flex flex-center flex-column mb-5">
                                ...
                                <!--end::Name-->
                                <!--begin::Email-->
                                <a href="javascript:void(0)" class="fs-5 fw-semibold text-muted text-hover-primary mb-6">max@kt.com</a>
                                <!--end::Email-->
                            </div>
                            <!--end::Summary-->
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="kt_ecommerce_customer_overview" role="tabpanel">
                            <div class="row row-cols-1 row-cols-md-2 mb-6 mb-xl-9">
                                ...
                                <div class="col">
                                    <!--begin::Reward Tier-->
                                    <a href="javascript:void(0)" class="card bg-info hoverable h-md-100">
                                        <!--begin::Body-->
                                        <div class="card-body">
                                        ...
                                        <div class="py-0" data-kt-customer-payment-method="row">
                                            ...
                                            <div class="py-3 d-flex flex-stack flex-wrap">
                                                ...
                                                <div class="accordion-header d-flex align-items-center"
                                                    ...
                                                    <!--end::Arrow-->
                                                    <!--begin::Logo-->
                                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/card-logos/mastercard.svg', $theme_asset_pack ?? null) }}"
...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/ecommerce/customers/details/transaction-history.js', $theme_asset_pack ?? null) }}"></script>
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/ecommerce/customers/details/add-auth-app.js', $theme_asset_pack ?? null) }}"></script>
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/ecommerce/customers/details/add-address.js', $theme_asset_pack ?? null) }}"></script>
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/ecommerce/customers/details/add-one-time-password.js', $theme_asset_pack ?? null) }}"></script>
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/ecommerce/customers/details/update-password.js', $theme_asset_pack ?? null) }}"></script>
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/ecommerce/customers/details/update-phone.js', $theme_asset_pack ?? null) }}"></script>
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/ecommerce/customers/details/update-address.js', $theme_asset_pack ?? null) }}"></script>
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/ecommerce/customers/details/update-profile.js', $theme_asset_pack ?? null) }}"></script>
