                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="apps/ecommerce/customers/details" class="menu-link px-3">View</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
...
@section('scripts')
    ...
    <script
        src="{{ \App\Support\ThemeAsset::url('js/custom/apps/ecommerce/customers/listing/listing.js', $theme_asset_pack ?? null) }}">
    </script>
    <script
        src="{{ \App\Support\ThemeAsset::url('js/custom/apps/ecommerce/customers/listing/add.js', $theme_asset_pack ?? null) }}">
    </script>
    <script
        src="{{ \App\Support\ThemeAsset::url('js/custom/apps/ecommerce/customers/listing/export.js', $theme_asset_pack ?? null) }}">
    </script>
