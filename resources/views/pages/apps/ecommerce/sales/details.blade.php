                                    ...
                                    <tbody class="fw-semibold text-gray-600">
                                        ...
                                        <tr>
                                            ...
                                            <td class="fw-bold text-end">
                                                Online
                                                <img src="{{ \App\Support\ThemeAsset::url('media/svg/card-logos/visa.svg', $theme_asset_pack ?? null) }}" class="w-50px ms-2" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="text-muted">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <a href="/apps/ecommerce/catalog/edit-product"
                                                                ...
                                                                <span class="symbol-label"
                                                                    style="
                                                background-image: url('{{ \App\Support\ThemeAsset::url('media//stock/ecommerce/100.png', $theme_asset_pack ?? null) }}');
                                              "></span>
                                                            </a>
                                                            <!--end::Thumbnail-->
                                                            <!--begin::Title-->
