                                        ...
                                        <td class="w-150px w-md-175px">
                                            <a href="/apps/inbox/reply" class="d-flex align-items-center text-gray-900">
                                                ...
                                                <div class="symbol symbol-35px me-3">
                                                    <span class="symbol-label"
                                                        style="
                                          background-image: url('{{ \App\Support\ThemeAsset::url('media/avatars/300-13.jpg', $theme_asset_pack ?? null) }}');
                                        "></span>
                                                </div>
                                                <!--end::Avatar-->
                                                <!--begin::Name-->
...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/inbox/listing.js', $theme_asset_pack ?? null) }}"></script>
