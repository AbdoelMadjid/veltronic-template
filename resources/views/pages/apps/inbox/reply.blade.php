                                        ...
                                        <div class="pe-5">
                                            ...
                                            <div data-kt-inbox-message="details">
                                                <span class="text-muted fw-semibold">to
                                                    me</span>
                                                <!--begin::Menu toggle-->
                                                <a href="javascript:void(0)" class="me-1" data-kt-menu-trigger="click"
                                ...
                                <div class="d-flex flex-wrap gap-2 flex-stack cursor-pointer"
                                    ...
                                    "></span>
                                        ...
                                        <div class="pe-5">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap gap-1">
                                                <a href="javascript:void(0)"
                                                    class="fw-bold text-gray-900 text-hover-primary">Max
                                                    Smith</a>
                                                <i class="ki-duotone ki-abstract-8 fs-7 text-success mx-3">
                                                    <span class="path1"></span>
                                                    <span class="path2"></span>
                                ...
                                <div class="d-flex flex-wrap gap-2 flex-stack cursor-pointer"
                                    ...
                                    "></span>
                                        ...
                                        <div class="pe-5">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap gap-1">
                                                <a href="javascript:void(0)"
                                                    class="fw-bold text-gray-900 text-hover-primary">Sean
                                                    Bean</a>
                                                <i class="ki-duotone ki-abstract-8 fs-7 text-success mx-3">
                                                    <span class="path1"></span>
                                                    <span class="path2"></span>
                                        ...
                                        <div class="btn-group me-4">
                                            ...
                                            <span class="btn btn-primary btn-icon fs-bold" role="button">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4"
                                                    ...
                                                    <!--begin::Menu item-->
                                                    <div class="menu-item px-3">
                                                        <a href="javascript:void(0)" class="menu-link px-3">Schedule
                                                            send</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    <div class="menu-item px-3">
                                                        <a href="javascript:void(0)" class="menu-link px-3">Save &
                                                            archive</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    <div class="menu-item px-3">
                                                        <a href="javascript:void(0)" class="menu-link px-3">Cancel</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                </div>
                                                <!--end::Menu-->
...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/inbox/reply.js', $theme_asset_pack ?? null) }}"></script>
