                        ...
                        <div class="card-body p-10">
                            ...
                            <div class="mb-0">
                                ...
                                <div class="row mb-5">
                                    <!--begin::Col-->
                                    <div class="col">
                                        <a href="javascript:void(0)" class="btn btn-light btn-active-light-primary w-100">Preview</a>
                                    </div>
                                    <!--end::Col-->
                                    <!--begin::Col-->
                                    <div class="col">
                                ...
                                <!--end::Row-->
                                <button type="submit" href="javascript:void(0)" class="btn btn-primary w-100"
...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/invoices/create.js', $theme_asset_pack ?? null) }}"></script>
