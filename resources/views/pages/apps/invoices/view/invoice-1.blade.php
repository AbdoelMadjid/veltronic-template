                            ...
                            <div class="mt-n1">
                                ...
                                <div class="d-flex flex-stack pb-10">
                                    ...
                                    <a href="javascript:void(0)">
                                        <img alt="Logo" src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/code-lab.svg', $theme_asset_pack ?? null) }}" />
                                    </a>
                                    <!--end::Logo-->
                                    <!--begin::Action-->
                                    <a href="javascript:void(0)" class="btn btn-sm btn-success">Pay Now</a>
                                    <!--end::Action-->
                                </div>
                                <!--end::Top-->
                                <!--begin::Wrapper-->
                            ...
                            <div
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="fw-bold fs-6 text-gray-800">
                                        ...
                                        <a href="javascript:void(0)" class="link-primary ps-1">View Project</a>
                                    </div>
                                </div>
                                <!--end::Item-->
                                <!--begin::Item-->
