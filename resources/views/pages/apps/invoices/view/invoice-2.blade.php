                    ...
                    <div class="mw-lg-950px mx-auto w-100">
                        ...
                        <div class="d-flex justify-content-between flex-column flex-sm-row mb-19">
                            ...
                            <div class="text-sm-end">
                                ...
                                <a href="javascript:void(0)">
                                    <img alt="Logo" src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/duolingo.svg', $theme_asset_pack ?? null) }}" />
                                </a>
                                <!--end::Logo-->
                                <!--begin::Text-->
                        ...
                        <div class="border-bottom pb-12">
                            ...
                            <div class="d-flex flex-row-fluid bgi-no-repeat bgi-position-x-center bgi-size-cover card-rounded h-150px h-lg-250px mb-lg-20"
                                style="
                              background-image: url('{{ \App\Support\ThemeAsset::url('media/misc/pattern-4.jpg', $theme_asset_pack ?? null) }}');
                            ">
                            </div>
                            <!--end::Image-->
                            <!--begin::Wrapper-->
