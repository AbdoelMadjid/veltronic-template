                        ...
                        <div class="card-body p-9">
                            ...
                            <div class="symbol-group symbol-hover mb-9">
                                ...
                                <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                    ...
                                    <img alt="Pic"
                                        src="{{ \App\Support\ThemeAsset::url('media/avatars/300-7.jpg', $theme_asset_pack ?? null) }}" />
                                </div>
                                <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                    title="Francis Mitcham">
                                    <img alt="Pic"
                                        src="{{ \App\Support\ThemeAsset::url('media/avatars/300-20.jpg', $theme_asset_pack ?? null) }}" />
                                </div>
                                <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                    title="Susan Redwood">
                            ...
                            <!--begin::Actions-->
                            <div class="d-flex">
                                <a href="javascript:void(0)" class="btn btn-primary btn-sm me-3" data-bs-toggle="modal"
                                    data-bs-target="#kt_modal_view_users">All Clients</a>
                                <a href="javascript:void(0)" class="btn btn-light btn-sm" data-bs-toggle="modal"
                    ...
                    <a href="/apps/projects/view" class="card border-hover-primary">
                        ...
                        <div class="card-header border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-50px w-50px bg-light">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/disqus.svg', $theme_asset_pack ?? null) }}"
                                        alt="image" class="p-3" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                    ...
                    <a href="/apps/projects/view" class="card border-hover-primary">
                        ...
                        <div class="card-header border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-50px w-50px bg-light">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/figma-1.svg', $theme_asset_pack ?? null) }}"
                                        alt="image" class="p-3" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                    ...
                    <a href="/apps/projects/view" class="card border-hover-primary">
                        ...
                        <div class="card-header border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-50px w-50px bg-light">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/sentry-3.svg', $theme_asset_pack ?? null) }}"
                                        alt="image" class="p-3" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                    ...
                    <a href="/apps/projects/view" class="card border-hover-primary">
                        ...
                        <div class="card-header border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-50px w-50px bg-light">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/xing-icon.svg', $theme_asset_pack ?? null) }}"
                                        alt="image" class="p-3" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                    ...
                    <a href="/apps/projects/view" class="card border-hover-primary">
                        ...
                        <div class="card-header border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-50px w-50px bg-light">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/tvit.svg', $theme_asset_pack ?? null) }}"
                                        alt="image" class="p-3" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                    ...
                    <a href="/apps/projects/view" class="card border-hover-primary">
                        ...
                        <div class="card-header border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-50px w-50px bg-light">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/aven.svg', $theme_asset_pack ?? null) }}"
                                        alt="image" class="p-3" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                        ...
                        <div class="card-body p-9">
                            ...
                            <div class="symbol-group symbol-hover">
                                ...
                                <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                    title="John Mixin">
                                    <img alt="Pic"
                                        src="{{ \App\Support\ThemeAsset::url('media/avatars/300-14.jpg', $theme_asset_pack ?? null) }}" />
                                </div>
                                <!--begin::User-->
                                <!--begin::User-->
                                <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                    ...
                    <a href="/apps/projects/view" class="card border-hover-primary">
                        ...
                        <div class="card-header border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-50px w-50px bg-light">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/treva.svg', $theme_asset_pack ?? null) }}"
                                        alt="image" class="p-3" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                    ...
                    <a href="/apps/projects/view" class="card border-hover-primary">
                        ...
                        <div class="card-header border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-50px w-50px bg-light">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/kanba.svg', $theme_asset_pack ?? null) }}"
                                        alt="image" class="p-3" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                            ...
                            <div class="text-center mb-13">
                                ...
                                <div class="text-muted fw-semibold fs-5">
                                    ...
                                    <a href="javascript:void(0)" class="link-primary fw-bold">Users Directory</a>.
                                </div>
                                <!--end::Description-->
                            </div>
                            <!--end::Heading-->
                                ...
                                <div class="py-5">
                                    ...
                                    <div data-kt-search-element="empty" class="text-center d-none">
                                        ...
                                        <div class="text-center px-5">
                                            <img src="{{ \App\Support\ThemeAsset::url('media/illustrations/sketchy-1/1.png', $theme_asset_pack ?? null) }}"
...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/projects/list/list.js', $theme_asset_pack ?? null) }}">
    </script>
