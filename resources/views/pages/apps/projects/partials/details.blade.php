        ...
        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-center mb-1">
                    <a href="javascript:void(0)" class="text-gray-800 text-hover-primary fs-2 fw-bold me-3">CRM
                        Dashboard</a>
            ...
            <div class="d-flex mb-4">
                <a href="javascript:void(0)" class="btn btn-sm btn-bg-light btn-active-color-primary me-3"
