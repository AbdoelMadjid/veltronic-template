        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card">
                <div class="card-body pt-9 pb-0">
                    ...
                    <!--begin::Nav-->
                    @include('pages.apps.projects.partials.nav', ['active' => 'targets'])
                    <!--end::Nav-->
                </div>
            </div>
            <!--end::Navbar-->
                        ...
                        <div class="col-md-4 col-lg-12 col-xl-4">
                                    ...
                                    <div class="d-flex flex-stack flex-wrapr">
                                        ...
                                        <div class="symbol-group symbol-hover my-1">
                                            ...
                                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                                ...
                                                <img alt="Pic" src="{{ \App\Support\ThemeAsset::url('media/avatars/300-19.jpg', $theme_asset_pack ?? null) }}" />
                                            </div>
                                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                                title="Susan Redwood">
                            ...
                            <div class="card mb-6 mb-xl-9">
                                ...
                                <div class="card-body">
                                    ...
                                    <!--begin::Title-->
                                    <div class="mb-2">
                                        <a href="javascript:void(0)" class="fs-4 fw-bold mb-1 text-gray-900 text-hover-primary">User
                                            Module
                                            Testing</a>
                                    </div>
                                    <!--end::Title-->
                            ...
                            <!--end::Card-->
                            <a href="javascript:void(0)" class="btn btn-primary er w-100 fs-6 px-8 py-4" data-bs-toggle="modal"
                        ...
                        <div class="col-md-4 col-lg-12 col-xl-4">
                            ...
                            <div class="card mb-6 mb-xl-9">
                                ...
                                <div class="card-body">
                                    ...
                                    <!--begin::Title-->
                                    <div class="mb-2">
                                        <a href="javascript:void(0)" class="fs-4 fw-bold mb-1 text-gray-900 text-hover-primary">Sales
                                            report
                                            page</a>
                                    </div>
                                    <!--end::Title-->
                        ...
                        <div class="col-md-4 col-lg-12 col-xl-4">
                            ...
                            <div class="card mb-6 mb-xl-9">
                                ...
                                <div class="card-body">
                                    ...
                                    <!--begin::Title-->
                                    <div class="mb-2">
                                        <a href="javascript:void(0)" class="fs-4 fw-bold mb-1 text-gray-900 text-hover-primary">To
                                            check User
                                            Management</a>
                                    </div>
                                    <!--end::Title-->
                        ...
                        <div class="card-body pt-3">
                            ...
                            <table id="kt_profile_overview_table"
                                ...
                                <tbody class="fs-6">
                                    <tr>
                                        <td class="fw-bold">
                                            <a href="javascript:void(0)" class="text-gray-900 text-hover-primary">Meeting with
                                                customer</a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="fw-bold">
                                            <a href="javascript:void(0)" class="text-gray-900 text-hover-primary">User Module
                                                Testing</a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="fw-bold">
                                            <a href="javascript:void(0)" class="text-gray-900 text-hover-primary">Sales report
                                                page</a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="fw-bold">
                                            <a href="javascript:void(0)" class="text-gray-900 text-hover-primary">Design main
                                                Dashboard</a>
                                        </td>
                                        <td>
                                            <span class="badge badge-light fw-semibold me-auto">UI Design</span>
                                    ...
                                    <tr>
                                        <td class="fw-bold">
                                            <a href="javascript:void(0)" class="text-gray-900 text-hover-primary">To check User
                                                Management</a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="fw-bold">
                                            <a href="javascript:void(0)" class="text-gray-900 text-hover-primary">Create Roles
                                                Module</a>
                                        </td>
                                        <td>
...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/projects/targets/targets.js', $theme_asset_pack ?? null) }}"></script>
