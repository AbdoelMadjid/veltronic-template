        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card mb-8">
                <div class="card-body pt-9 pb-0">
                    ...
                    <!--begin::Nav-->
                    @include('pages.apps.projects.partials.nav', ['active' => 'users'])
                    <!--end::Nav-->
                </div>
            </div>
            <!--end::Navbar-->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                    ...
                                    <div class="symbol symbol-65px symbol-circle mb-5">
                                        <img src="{{ \App\Support\ThemeAsset::url('media//avatars/300-2.jpg', $theme_asset_pack ?? null) }}" alt="image" />
                                        <div
                                    ...
                                    <!--end::Avatar-->
                                    <!--begin::Name-->
                                    <a href="javascript:void(0)" class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">Karina
                                        Clark</a>
                                    <!--end::Name-->
                                    <!--begin::Position-->
                        ...
                        <div class="col-md-6 col-xxl-4">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                    ...
                                    <!--end::Avatar-->
                                    <!--begin::Name-->
                                    <a href="javascript:void(0)" class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">Alan
                                        Johnson</a>
                                    <!--end::Name-->
                                    <!--begin::Position-->
                                    <div class="fw-semibold text-gray-500 mb-6">
                        ...
                        <div class="col-md-6 col-xxl-4">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                    ...
                                    <!--end::Avatar-->
                                    <!--begin::Name-->
                                    <a href="javascript:void(0)" class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">Peter
                                        Marcus</a>
                                    <!--end::Name-->
                                    <!--begin::Position-->
                                    <div class="fw-semibold text-gray-500 mb-6">
                        ...
                        <div class="col-md-6 col-xxl-4">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                    ...
                                    <!--end::Avatar-->
                                    <!--begin::Name-->
                                    <a href="javascript:void(0)" class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">Benjamin
                                        Jacob</a>
                                    <!--end::Name-->
                                    <!--begin::Position-->
                                    <div class="fw-semibold text-gray-500 mb-6">
                                ...
                                <div class="py-5">
                                    ...
                                    <div data-kt-search-element="empty" class="text-center d-none">
                                        ...
                                        <div class="text-center px-5">
                                            <img src="{{ \App\Support\ThemeAsset::url('media/illustrations/sketchy-1/1.png', $theme_asset_pack ?? null) }}" alt=""
...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/projects/list/list.js', $theme_asset_pack ?? null) }}"></script>
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/projects/users/users.js', $theme_asset_pack ?? null) }}"></script>
