        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card mb-6 mb-xl-9">
                <div class="card-body pt-9 pb-0">
                    ...
                    <!--begin::Nav-->
                    @include('pages.apps.projects.partials.nav', ['active' => 'view'])
                    <!--end::Nav-->
                </div>
            </div>
            <!--end::Navbar-->
                    ...
                    <div class="card card-flush h-lg-100">
                        ...
                        <div class="card-header mt-6">
                            ...
                            <div class="card-toolbar">
                                <a href="javascript:void(0)" class="btn btn-light btn-sm">View Tasks</a>
                            </div>
                            <!--end::Card toolbar-->
                        </div>
                        <!--end::Card header-->
                                ...
                                <div class="d-flex flex-stack flex-grow-1">
                                    ...
                                    <div class="fw-semibold">
                                        <div class="fs-6 text-gray-700">
                                            <a href="javascript:void(0)" class="fw-bold me-1">Invite New .NET Collaborators</a>to
                                            create great
                                ...
                                <div id="kt_schedule_day_0" class="tab-pane fade show">
                                    ...
                                    <div class="d-flex flex-stack position-relative mt-8">
                                        ...
                                        <div class="fw-semibold ms-5 text-gray-600">
                                            ...
                                            <div class="text-gray-500">
                                                Lead by <a href="javascript:void(0)">Sean Bean</a>
                                            </div>
                                            <!--end::User-->
                                        </div>
                                        <!--end::Info-->
                                    ...
                                    <div class="d-flex flex-stack position-relative mt-8">
                                        ...
                                        <div class="fw-semibold ms-5 text-gray-600">
                                            ...
                                            <!--begin::User-->
                                            <div class="text-gray-500">
                                                Lead by <a href="javascript:void(0)">Caleb Donaldson</a>
                                            </div>
                                            <!--end::User-->
                                        </div>
                                        <!--end::Info-->
                                ...
                                <div id="kt_schedule_day_1" class="tab-pane fade show active">
                                    ...
                                    <div class="d-flex flex-stack position-relative mt-8">
                                        ...
                                        <div class="fw-semibold ms-5 text-gray-600">
                                            ...
                                            <!--end::Time-->
                                            <!--begin::Title-->
                                            <a href="javascript:void(0)" class="fs-5 fw-bold text-gray-800 text-hover-primary mb-2">9
                                                Degree Project
                                                Estimation Meeting</a>
                                            <!--end::Title-->
                                            <!--begin::User-->
                                            <div class="text-gray-500">
                                                Lead by <a href="javascript:void(0)">Naomi Hayabusa</a>
                                            </div>
                                            <!--end::User-->
                                        </div>
                                        <!--end::Info-->
                                    ...
                                    <div class="d-flex flex-stack position-relative mt-8">
                                        ...
                                        <div class="fw-semibold ms-5 text-gray-600">
                                            ...
                                            <!--begin::User-->
                                            <div class="text-gray-500">
                                                Lead by <a href="javascript:void(0)">Terry Robins</a>
                                            </div>
                                            <!--end::User-->
                                        </div>
                                        <!--end::Info-->
                                    ...
                                    <div class="d-flex flex-stack position-relative mt-8">
                                        ...
                                        <div class="fw-semibold ms-5 text-gray-600">
                                            ...
                                            <!--begin::User-->
                                            <div class="text-gray-500">
                                                Lead by <a href="javascript:void(0)">Yannis Gloverson</a>
                                            </div>
                                            <!--end::User-->
                                        </div>
                                        <!--end::Info-->
                                ...
                                <div id="kt_schedule_day_2" class="tab-pane fade show">
                                    ...
                                    <div class="d-flex flex-stack position-relative mt-8">
                                        ...
                                        <div class="fw-semibold ms-5 text-gray-600">
                                            ...
                                            <!--begin::User-->
                                            <div class="text-gray-500">
                                                Lead by <a href="javascript:void(0)">Mark Randall</a>
                                            </div>
                                            <!--end::User-->
                                        </div>
                                        <!--end::Info-->
                                ...
                                <div id="kt_schedule_day_3" class="tab-pane fade show">
                                    ...
                                    <div class="d-flex flex-stack position-relative mt-8">
                                        ...
                                        <div class="fw-semibold ms-5 text-gray-600">
                                            ...
                                            <!--begin::User-->
                                            <div class="text-gray-500">
                                                Lead by <a href="javascript:void(0)">Bob Harris</a>
                                            </div>
                                            <!--end::User-->
                                        </div>
                                        <!--end::Info-->
                                    ...
                                    <div class="d-flex flex-stack position-relative mt-8">
                                        ...
                                        <div class="fw-semibold ms-5 text-gray-600">
                                            ...
                                            <!--begin::User-->
                                            <div class="text-gray-500">
                                                Lead by <a href="javascript:void(0)">David Stevenson</a>
                                            </div>
                                            <!--end::User-->
                                        </div>
                                        <!--end::Info-->
                                    ...
                                    <div class="d-flex flex-stack position-relative mt-8">
                                        ...
                                        <div class="fw-semibold ms-5 text-gray-600">
                                            ...
                                            <!--begin::User-->
                                            <div class="text-gray-500">
                                                Lead by <a href="javascript:void(0)">Karina Clarke</a>
                                            </div>
                                            <!--end::User-->
                                        </div>
                                        <!--end::Info-->
                                ...
                                <div id="kt_schedule_day_4" class="tab-pane fade show">
                                    ...
                                    <div class="d-flex flex-stack position-relative mt-8">
                                        ...
                                        <div class="fw-semibold ms-5 text-gray-600">
                                            ...
                                            <!--begin::User-->
                                            <div class="text-gray-500">
                                                Lead by <a href="javascript:void(0)">Michael Walters</a>
                                            </div>
                                            <!--end::User-->
                                        </div>
                                        <!--end::Info-->
                                ...
                                <div id="kt_schedule_day_7" class="tab-pane fade show">
                                    ...
                                    <div class="d-flex flex-stack position-relative mt-8">
                                        ...
                                        <div class="fw-semibold ms-5 text-gray-600">
                                            ...
                                            <!--begin::User-->
                                            <div class="text-gray-500">
                                                Lead by <a href="javascript:void(0)">Kendell Trevor</a>
                                            </div>
                                            <!--end::User-->
                                        </div>
                                        <!--end::Info-->
                                    ...
                                    <div class="d-flex flex-stack position-relative mt-8">
                                        ...
                                        <div class="fw-semibold ms-5 text-gray-600">
                                            ...
                                            <!--begin::User-->
                                            <div class="text-gray-500">
                                                Lead by <a href="javascript:void(0)">Walter White</a>
                                            </div>
                                            <!--end::User-->
                                        </div>
                                        <!--end::Info-->
                                ...
                                <div id="kt_schedule_day_9" class="tab-pane fade show">
                                    ...
                                    <div class="d-flex flex-stack position-relative mt-8">
                                        ...
                                        <div class="fw-semibold ms-5 text-gray-600">
                                            ...
                                            <!--begin::User-->
                                            <div class="text-gray-500">
                                                Lead by <a href="javascript:void(0)">Peter Marcus</a>
                                            </div>
                                            <!--end::User-->
                                        </div>
                                        <!--end::Info-->
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card card-flush h-lg-100">
                        ...
                        <div class="card-header mt-6">
                            ...
                            <!--begin::Card toolbar-->
                            <div class="card-toolbar">
                                <a href="javascript:void(0)" class="btn btn-bg-light btn-active-color-primary btn-sm">View All</a>
                            </div>
                            <!--end::Card toolbar-->
                        </div>
                        <!--end::Card header-->
                            ...
                            <div class="d-flex flex-column mb-9">
                                ...
                                <div class="d-flex align-items-center mb-5">
                                    ...
                                    <div class="symbol symbol-30px me-5">
                                        <img alt="Icon" src="{{ \App\Support\ThemeAsset::url('media/svg/files/pdf.svg', $theme_asset_pack ?? null) }}" />
                                    </div>
                                    <!--end::Icon-->
                                    <!--begin::Details-->
                                    <div class="fw-semibold">
                                        <a class="fs-6 fw-bold text-gray-900 text-hover-primary" href="javascript:void(0)">Project
                                            tech
                                            requirements</a>
                                        <div class="text-gray-500">
                                            2 days ago <a href="javascript:void(0)">Karina Clark</a>
                                        </div>
                                    </div>
                                    <!--end::Details-->
                                    <!--begin::Menu-->
                                ...
                                <div class="d-flex align-items-center mb-5">
                                    <!--begin::Icon-->
                                    <div class="symbol symbol-30px me-5">
                                        <img alt="Icon" src="{{ \App\Support\ThemeAsset::url('media/svg/files/doc.svg', $theme_asset_pack ?? null) }}" />
                                    </div>
                                    <!--end::Icon-->
                                    <!--begin::Details-->
                                    <div class="fw-semibold">
                                        <a class="fs-6 fw-bold text-gray-900 text-hover-primary" href="javascript:void(0)">Create
                                            FureStibe
                                            branding proposal</a>
                                        <div class="text-gray-500">
                                            Due in 1 day <a href="javascript:void(0)">Marcus Blake</a>
                                        </div>
                                    </div>
                                    <!--end::Details-->
                                    <!--begin::Menu-->
                                ...
                                <div class="d-flex align-items-center mb-5">
                                    <!--begin::Icon-->
                                    <div class="symbol symbol-30px me-5">
                                        <img alt="Icon" src="{{ \App\Support\ThemeAsset::url('media/svg/files/css.svg', $theme_asset_pack ?? null) }}" />
                                    </div>
                                    <!--end::Icon-->
                                    <!--begin::Details-->
                                    <div class="fw-semibold">
                                        <a class="fs-6 fw-bold text-gray-900 text-hover-primary" href="javascript:void(0)">Completed
                                            Project
                                            Stylings</a>
                                        <div class="text-gray-500">
                                            Due in 1 day <a href="javascript:void(0)">Terry Barry</a>
                                        </div>
                                    </div>
                                    <!--end::Details-->
                                    <!--begin::Menu-->
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Icon-->
                                    <div class="symbol symbol-30px me-5">
                                        <img alt="Icon" src="{{ \App\Support\ThemeAsset::url('media/svg/files/ai.svg', $theme_asset_pack ?? null) }}" />
                                    </div>
                                    <!--end::Icon-->
                                    <!--begin::Details-->
                                    <div class="fw-semibold">
                                        <a class="fs-6 fw-bold text-gray-900 text-hover-primary" href="javascript:void(0)">Create
                                            ...
                                            Wireframes</a>
                                        <div class="text-gray-500">
                                            Due in 3 days <a href="javascript:void(0)">Roth Bloom</a>
                                        </div>
                                    </div>
                                    <!--end::Details-->
                                    <!--begin::Menu-->
                    ...
                    <div class="card card-flush h-lg-100">
                        ...
                        <div class="card-body d-flex flex-column p-9 pt-3 mb-9">
                            ...
                            <div class="d-flex align-items-center mb-5">
                                ...
                                <!--begin::Details-->
                                <div class="fw-semibold">
                                    <a href="javascript:void(0)" class="fs-5 fw-bold text-gray-900 text-hover-primary">Emma Smith</a>
                                    <div class="text-gray-500">
                            ...
                            <div class="d-flex align-items-center mb-5">
                                ...
                                <!--begin::Details-->
                                <div class="fw-semibold">
                                    <a href="javascript:void(0)" class="fs-5 fw-bold text-gray-900 text-hover-primary">Melody
                                        Macy</a>
                                    <div class="text-gray-500">
                            ...
                            <div class="d-flex align-items-center mb-5">
                                ...
                                <!--begin::Details-->
                                <div class="fw-semibold">
                                    <a href="javascript:void(0)" class="fs-5 fw-bold text-gray-900 text-hover-primary">Max
                                        Smith</a>
                                    <div class="text-gray-500">
                            ...
                            <div class="d-flex align-items-center mb-5">
                                ...
                                <!--begin::Details-->
                                <div class="fw-semibold">
                                    <a href="javascript:void(0)" class="fs-5 fw-bold text-gray-900 text-hover-primary">Sean
                                        Bean</a>
                                    <div class="text-gray-500">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <!--begin::Details-->
                                <div class="fw-semibold">
                                    <a href="javascript:void(0)" class="fs-5 fw-bold text-gray-900 text-hover-primary">Brian
                                        Cox</a>
                                    <div class="text-gray-500">
                    ...
                    <div class="card card-flush h-lg-100">
                        ...
                        <div class="card-body d-flex flex-column mb-9 p-9 pt-3">
                            ...
                            <div class="d-flex align-items-center position-relative mb-7">
                                ...
                                <!--begin::Details-->
                                <div class="fw-semibold">
                                    <a href="javascript:void(0)" class="fs-6 fw-bold text-gray-900 text-hover-primary">Create
                                        FureStibe branding
                                        logo</a>
                                    <!--begin::Info-->
                                    <div class="text-gray-500">
                                        Due in 1 day <a href="javascript:void(0)">Karina Clark</a>
                                    </div>
                                    <!--end::Info-->
                                </div>
                                <!--end::Details-->
                            ...
                            <div class="d-flex align-items-center position-relative mb-7">
                                ...
                                <!--begin::Details-->
                                <div class="fw-semibold">
                                    <a href="javascript:void(0)" class="fs-6 fw-bold text-gray-900 text-hover-primary">Schedule a
                                        meeting with
                                        FireBear CTO John</a>
                                    <!--begin::Info-->
                                    <div class="text-gray-500">
                                        Due in 3 days <a href="javascript:void(0)">Rober Doe</a>
                                    </div>
                                    <!--end::Info-->
                                </div>
                                <!--end::Details-->
                            ...
                            <div class="d-flex align-items-center position-relative mb-7">
                                ...
                                <!--begin::Details-->
                                <div class="fw-semibold">
                                    <a href="javascript:void(0)" class="fs-6 fw-bold text-gray-900 text-hover-primary">9 Degree
                                        Porject
                                        Estimation</a>
                                    <!--begin::Info-->
                                    <div class="text-gray-500">
                                        Due in 1 week <a href="javascript:void(0)">Neil Owen</a>
                                    </div>
                                    <!--end::Info-->
                                </div>
                                <!--end::Details-->
                            ...
                            <div class="d-flex align-items-center position-relative mb-7">
                                ...
                                <!--begin::Details-->
                                <div class="fw-semibold">
                                    <a href="javascript:void(0)" class="fs-6 fw-bold text-gray-900 text-hover-primary">Dashgboard
                                        UI & UX for
                                        Leafr CRM</a>
                                    <!--begin::Info-->
                                    <div class="text-gray-500">
                                        Due in 1 week <a href="javascript:void(0)">Olivia Wild</a>
                                    </div>
                                    <!--end::Info-->
                                </div>
                                <!--end::Details-->
                            ...
                            <div class="d-flex align-items-center position-relative">
                                ...
                                <!--begin::Details-->
                                <div class="fw-semibold">
                                    <a href="javascript:void(0)" class="fs-6 fw-bold text-gray-900 text-hover-primary">Mivy App
                                        R&D, Meeting with
                                        clients</a>
                                    <!--begin::Info-->
                                    <div class="text-gray-500">
                                        Due in 2 weeks <a href="javascript:void(0)">Sean Bean</a>
                                    </div>
                                    <!--end::Info-->
                                </div>
                                <!--end::Details-->
                        ...
                        <table id="kt_profile_overview_table"
                            ...
                            <tbody class="fs-6">
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a href="javascript:void(0)" class="btn btn-light btn-sm">View</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/projects/project/project.js', $theme_asset_pack ?? null) }}"></script>
