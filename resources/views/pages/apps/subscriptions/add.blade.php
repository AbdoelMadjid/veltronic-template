                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="d-flex align-items-center p-3 mb-2">
                                    ...
                                    <div class="d-flex flex-column">
                                        <!--begin::Name-->
                                        <a href="javascript:void(0)" class="fs-4 fw-bold text-gray-900 text-hover-primary me-2">Sean
                                            Bean</a>
                                        <!--end::Name-->
                                        <!--begin::Email-->
                                    ...
                                    <div class="d-flex flex-stack flex-grow-1">
                                        ...
                                        <div class="fw-semibold">
                                            ...
                                            <div class="fs-6 text-gray-700">
                                                ...
                                                <a href="javascript:void(0)" class="fw-bold">Learn
                                                    more</a>.
                                            </div>
                                        </div>
                                        <!--end::Content-->
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div
                                    ...
                                    <div class="fs-5 fw-bold form-label mb-3">
                                        ...
                                        <span class="ms-2 cursor-pointer" data-bs-toggle="popover"
                                            ...
                                            data-bs-content="Thresholds help manage risk by limiting the unpaid usage balance a customer can accrue. Thresholds only measure and bill for metered usage (including discounts but excluding tax). &lt;a href='javascript:void(0)'&gt;Learn more&lt;/a&gt;.">
                                            <i class="ki-duotone ki-information fs-7">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                                <span class="path3"></span>
                                ...
                                <div class="d-flex flex-column fv-row rounded-3 p-7 border border-dashed border-gray-300">
                                    ...
                                    <div class="fs-5 fw-bold form-label mb-3">
                                        ...
                                        <span class="ms-2 cursor-pointer" data-bs-toggle="popover"
                                            data-bs-trigger="hover focus" data-bs-html="true" data-bs-delay-hide="1000"
                                            data-bs-content="Pro-rated billing dynamically calculates the remainder amount leftover per billing cycle that is owed. &lt;a href='javascript:void(0)'&gt;Learn more&lt;/a&gt;.">
                                            <i class="ki-duotone ki-information fs-7">
                                                <span class="path1"></span>
                                                <span class="path2"></span>
                                                <span class="path3"></span>
                            ...
                            <div class="mb-10">
                                ...
                                <div class="mb-0">
                                    ...
                                    <div class="fw-semibold text-gray-600 d-flex align-items-center">
                                        Mastercard
                                        <img src="{{ \App\Support\ThemeAsset::url('media/svg/card-logos/mastercard.svg', $theme_asset_pack ?? null) }}" class="w-35px ms-2"
                                            alt="" />
                                    </div>
                                    <!--end::Card info-->
                                    <!--begin::Card expiry-->
                                ...
                                <div class="py-5">
                                    ...
                                    <div data-kt-search-element="suggestions">
                                        ...
                                        <div class="text-center px-4 pt-10">
                                            <img src="{{ \App\Support\ThemeAsset::url('media/illustrations/sketchy-1/4.png', $theme_asset_pack ?? null) }}" alt=""
                                    ...
                                    <div data-kt-search-element="empty" class="text-center d-none">
                                        ...
                                        <div class="text-center px-4">
                                            <img src="{{ \App\Support\ThemeAsset::url('media/illustrations/sketchy-1/9.png', $theme_asset_pack ?? null) }}" alt="user"
                                                class="mw-100 mh-200px" />
                                        </div>
                                        <!--end::Illustration-->
                                    </div>
...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/subscriptions/add/customer-select.js', $theme_asset_pack ?? null) }}"></script>
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/subscriptions/add/products.js', $theme_asset_pack ?? null) }}"></script>
