                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="/apps/subscriptions/view" class="menu-link px-3">View</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="javascript:void(0)" data-kt-subscriptions-table-filter="delete_row"
...
@section('scripts')
    ...
    <script
        src="{{ \App\Support\ThemeAsset::url('js/custom/apps/subscriptions/list/export.js', $theme_asset_pack ?? null) }}">
    </script>
    <script
        src="{{ \App\Support\ThemeAsset::url('js/custom/apps/subscriptions/list/list.js', $theme_asset_pack ?? null) }}">
    </script>
