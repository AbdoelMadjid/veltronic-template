                ...
                <div class="flex-lg-row-fluid me-lg-15 order-2 order-lg-1 mb-10 mb-lg-0">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-gray-800 min-w-200px">
                                                    <a href="javascript:void(0)"
                                                        class="text-gray-800 text-hover-primary">Basic
                                                        Bundle</a>
                                                </td>
                                            </tr>
                                            <!--end::Row-->
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-6 w-200px py-4"
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="javascript:void(0)" class="menu-link px-3">Pause
                                                                Subscription</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu item-->
                    ...
                    <div class="card card-flush pt-3 mb-5 mb-xl-10">
                        ...
                        <div class="card-header">
                            ...
                            <!--begin::Card toolbar-->
                            <div class="card-toolbar">
                                <a href="javascript:void(0)" class="btn btn-light-primary">View All
                                    Events</a>
                            </div>
                            <!--end::Card toolbar-->
                        </div>
