...
@section('styles')
    ...
    <link href="{{ \App\Support\ThemeAsset::url('plugins/custom/leaflet/leaflet.bundle.css', $theme_asset_pack ?? null) }}" rel="stylesheet" type="text/css" />
        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card mb-12">
                ...
                <div class="card-body flex-column p-5">
                    ...
                    <!--end::Hero content-->
                    <!--begin::Hero nav-->
                    @include('pages.apps.support-center.partials.hero-nav', ['active' => 'contact'])
                    <!--end::Hero nav-->
                </div>
                <!--end::Hero body-->
            </div>
...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('plugins/custom/leaflet/leaflet.bundle.js', $theme_asset_pack ?? null) }}"></script>
    ...
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/pages/general/contact.js', $theme_asset_pack ?? null) }}"></script>
