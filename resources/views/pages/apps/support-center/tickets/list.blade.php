                                ...
                                <div class="d-flex align-items-center mb-10">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="fw-semibold">
                                            ...
                                            <!--end::Desc-->
                                            <!--begin::Link-->
                                            <a href="javascript:void(0)" class="link-primary">Support Policy</a>
                                            <!--end::Link-->
                                        </div>
                                        <!--end::Section-->
                                    </div>
                                ...
                                <div class="d-flex align-items-center mb-10">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="fw-semibold">
                                            ...
                                            <!--end::Desc-->
                                            <!--begin::Link-->
                                            <a href="javascript:void(0)" class="link-primary">KeenThemes Twitter</a>
                                            <!--end::Link-->
                                        </div>
                                        <!--end::Section-->
                                    </div>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="fw-semibold">
                                            ...
                                            <!--end::Desc-->
                                            <!--begin::Link-->
                                            <a href="javascript:void(0)" class="link-primary">KeenThemes Github</a>
                                            <!--end::Link-->
                                        </div>
                                        <!--end::Section-->
                                    </div>
