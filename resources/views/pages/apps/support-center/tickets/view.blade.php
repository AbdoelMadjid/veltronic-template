        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card mb-12">
                ...
                <div class="card-body flex-column p-5">
                    ...
                    <!--end::Hero content-->
                    <!--begin::Hero nav-->
                    @include('pages.apps.support-center.partials.hero-nav', ['active' => 'tickets'])
                    <!--end::Hero nav-->
                </div>
                <!--end::Hero body-->
            </div>
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="">
                                            ...
                                            <span class="fw-semibold text-muted me-6">Product:
                                                <a href="javascript:void(0)" class="text-muted text-hover-primary">Metronic</a></span>
                                            <!--end::Label-->
                                            <!--begin::Label-->
                                            <span class="fw-semibold text-muted me-6">By:
                                                <a href="javascript:void(0)" class="text-muted text-hover-primary">Jerry
                                                    Johns</a></span>
                                            <!--end::Label-->
                                            <!--begin::Label-->
                        ...
                        <div class="flex-column flex-lg-row-auto w-100 mw-lg-300px mw-xxl-350px">
                                ...
                                <div class="d-flex align-items-center mb-10">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="fw-semibold">
                                            ...
                                            <!--end::Desc-->
                                            <!--begin::Link-->
                                            <a href="javascript:void(0)" class="link-primary">Support
                                                Policy</a>
                                            <!--end::Link-->
                                        </div>
                                        <!--end::Section-->
                                ...
                                <div class="d-flex align-items-center mb-10">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="fw-semibold">
                                            ...
                                            <!--end::Desc-->
                                            <!--begin::Link-->
                                            <a href="javascript:void(0)" class="link-primary">support@keenthemes.com</a>
                                            <!--end::Link-->
                                        </div>
                                        <!--end::Section-->
                                    </div>
                                ...
                                <div class="d-flex align-items-center mb-10">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="fw-semibold">
                                            ...
                                            <!--end::Desc-->
                                            <!--begin::Link-->
                                            <a href="javascript:void(0)" class="link-primary">KeenThemes
                                                Twitter</a>
                                            <!--end::Link-->
                                        </div>
                                        <!--end::Section-->
                            ...
                            <div class="card-rounded bg-primary bg-opacity-5 p-10 mb-15">
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <!--end::Icon-->
                                    <!--begin::Subtitle-->
                                    <a href="javascript:void(0)" class="fw-semibold text-gray-800 text-hover-primary fs-5 m-0">React
                                        Admin</a>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Item-->
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <!--end::Icon-->
                                    <!--begin::Subtitle-->
                                    <a href="javascript:void(0)" class="fw-semibold text-gray-800 text-hover-primary fs-5 m-0">Vue
                                        Dashboard</a>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Item-->
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <!--end::Icon-->
                                    <!--begin::Subtitle-->
                                    <a href="javascript:void(0)" class="fw-semibold text-gray-800 text-hover-primary fs-5 m-0">Niche
                                        Theme</a>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Item-->
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <!--end::Icon-->
                                    <!--begin::Subtitle-->
                                    <a href="javascript:void(0)" class="fw-semibold text-gray-800 text-hover-primary fs-5 m-0">Dorsey
                                        Front-end</a>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Item-->
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <!--end::Icon-->
                                    <!--begin::Subtitle-->
                                    <a href="javascript:void(0)" class="fw-semibold text-gray-800 text-hover-primary fs-5 m-0">CRM
                                        Admin</a>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Item-->
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <!--end::Icon-->
                                    <!--begin::Subtitle-->
                                    <a href="javascript:void(0)" class="fw-semibold text-gray-800 text-hover-primary fs-5 m-0">Admin
                                        Dashbaord</a>
                                    <!--end::Subtitle-->
                                </div>
                                <!--end::Item-->
...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/support-center/general.js', $theme_asset_pack ?? null) }}"></script>
