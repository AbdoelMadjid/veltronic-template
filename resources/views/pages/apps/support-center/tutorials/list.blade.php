                                    ...
                                    <div class="d-flex flex-stack flex-wrap">
                                        ...
                                        <div class="d-flex align-items-center pe-2">
                                            ...
                                            <div class="symbol symbol-35px symbol-circle me-3">
                                                <img alt="" src="{{ \App\Support\ThemeAsset::url('media/avatars/300-9.jpg', $theme_asset_pack ?? null) }}" />
                                            </div>
                                            <!--end::Avatar-->
                                            <!--begin::Text-->
                                ...
                                <div class="ps-lg-6 mb-16 mt-md-0 mt-17">
                                    ...
                                    <div class="d-flex flex-stack flex-wrap">
                                        ...
                                        <div class="d-flex align-items-center pe-2">
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-35px symbol-circle me-3">
                                                <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-20.jpg', $theme_asset_pack ?? null) }}" class="" alt="" />
                                            </div>
                                            <!--end::Avatar-->
                                            <!--begin::Text-->
                                            <div class="fs-5 fw-bold">
                                ...
                                <div class="ps-lg-6 mb-16">
                                    ...
                                    <div class="d-flex flex-stack flex-wrap">
                                        ...
                                        <div class="d-flex align-items-center pe-2">
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-35px symbol-circle me-3">
                                                <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-9.jpg', $theme_asset_pack ?? null) }}" class=""
                                                    alt="" />
                                            </div>
                                            <!--end::Avatar-->
                                            <!--begin::Text-->
                                ...
                                <div class="ps-lg-6">
                                    ...
                                    <div class="d-flex flex-stack flex-wrap">
                                        ...
                                        <div class="d-flex align-items-center pe-2">
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-35px symbol-circle me-3">
                                                <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-19.jpg', $theme_asset_pack ?? null) }}" class=""
                                                    alt="" />
                                            </div>
                                            <!--end::Avatar-->
                                            <!--begin::Text-->
                    ...
                    <div class="">
                        ...
                        <div class="m-0">
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <!--end::Title-->
                                <!--begin::Link-->
                                <a href="javascript:void(0)" class="fs-6 fw-semibold link-primary">View Instagram</a>
                                <!--end::Link-->
                            </div>
                            <!--end::Content-->
                            <!--begin::Separator-->
                        ...
                        <div class="row g-10 row-cols-2 row-cols-lg-5">
                            ...
                            <div class="col">
                                <!--begin::Overlay-->
                                <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                    href="{{ \App\Support\ThemeAsset::url('media/stock/900x600/16.jpg', $theme_asset_pack ?? null) }}">
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                        style="
                                  background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/900x600/16.jpg', $theme_asset_pack ?? null) }}');
                                ">
                                    </div>
                                    <!--end::Image-->
                                    <!--begin::Action-->
                            ...
                            <div class="col">
                                <!--begin::Overlay-->
                                <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                    href="{{ \App\Support\ThemeAsset::url('media/stock/900x600/13.jpg', $theme_asset_pack ?? null) }}">
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                        style="
                                  background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/900x600/13.jpg', $theme_asset_pack ?? null) }}');
                                ">
                                    </div>
                                    <!--end::Image-->
                                    <!--begin::Action-->
                            ...
                            <div class="col">
                                <!--begin::Overlay-->
                                <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                    href="{{ \App\Support\ThemeAsset::url('media/stock/900x600/19.jpg', $theme_asset_pack ?? null) }}">
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                        style="
                                  background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/900x600/19.jpg', $theme_asset_pack ?? null) }}');
                                ">
                                    </div>
                                    <!--end::Image-->
                                    <!--begin::Action-->
                            ...
                            <div class="col">
                                <!--begin::Overlay-->
                                <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                    href="{{ \App\Support\ThemeAsset::url('media/stock/900x600/15.jpg', $theme_asset_pack ?? null) }}">
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                        style="
                                  background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/900x600/15.jpg', $theme_asset_pack ?? null) }}');
                                ">
                                    </div>
                                    <!--end::Image-->
                                    <!--begin::Action-->
                            ...
                            <div class="col">
                                <!--begin::Overlay-->
                                <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                    href="{{ \App\Support\ThemeAsset::url('media/stock/900x600/12.jpg', $theme_asset_pack ?? null) }}">
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                        style="
                                  background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/900x600/12.jpg', $theme_asset_pack ?? null) }}');
                                ">
                                    </div>
                                    <!--end::Image-->
                                    <!--begin::Action-->
