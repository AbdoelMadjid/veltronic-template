        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card mb-12">
                ...
                <div class="card-body flex-column p-5">
                    ...
                    <!--end::Hero content-->
                    <!--begin::Hero nav-->
                    @include('pages.apps.support-center.partials.hero-nav', ['active' => 'tutorials'])
                    <!--end::Hero nav-->
                </div>
                <!--end::Hero body-->
            </div>
                ...
                <div class="card-body p-lg-15 pb-lg-0">
                        ...
                        <div class="flex-lg-row-fluid me-xl-15">
                            ...
                            <div class="mb-17">
                                ...
                                <div class="mb-8">
                                    ...
                                    <!--end::Info-->
                                    <!--begin::Title-->
                                    <a href="javascript:void(0)" class="text-gray-900 text-hover-primary fs-2 fw-bold">Admin Panel -
                                        How To Get
                                        Started Tutorial.
                                    ...
                                    <div class="overlay mt-8">
                                        ...
                                        <div class="bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-350px"
                                            style="
                                    background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/1600x800/img-1.jpg', $theme_asset_pack ?? null) }}');
                                  ">
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Links-->
                                ...
                                <div
                                    ...
                                    <div class="text-center flex-shrink-0 me-7 me-lg-13">
                                        ...
                                        <div class="symbol symbol-70px symbol-circle mb-2">
                                            <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-2.jpg', $theme_asset_pack ?? null) }}" class="" alt="" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Info-->
                                        <div class="mb-0">
                                ...
                                <div class="d-flex flex-center">
                                    ...
                                    <a href="javascript:void(0)" class="mx-4">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/facebook-4.svg', $theme_asset_pack ?? null) }}" class="h-20px my-2"
                                            alt="" />
                                    </a>
                                    <!--end::Icon-->
                                    <!--begin::Icon-->
                                    <a href="javascript:void(0)" class="mx-4">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/instagram-2-1.svg', $theme_asset_pack ?? null) }}" class="h-20px my-2"
                                            alt="" />
                                    </a>
                                    <!--end::Icon-->
                                    <!--begin::Icon-->
                                    <a href="javascript:void(0)" class="mx-4">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/github.svg', $theme_asset_pack ?? null) }}" class="h-20px my-2"
                                            alt="" />
                                    </a>
                                    <!--end::Icon-->
                                    <!--begin::Icon-->
                                    <a href="javascript:void(0)" class="mx-4">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/behance.svg', $theme_asset_pack ?? null) }}" class="h-20px my-2"
                                            alt="" />
                                    </a>
                                    <!--end::Icon-->
                                    <!--begin::Icon-->
                                    <a href="javascript:void(0)" class="mx-4">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/pinterest-p.svg', $theme_asset_pack ?? null) }}" class="h-20px my-2"
                                            alt="" />
                                    </a>
                                    <!--end::Icon-->
                                    <!--begin::Icon-->
                                    <a href="javascript:void(0)" class="mx-4">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/twitter.svg', $theme_asset_pack ?? null) }}" class="h-20px my-2"
                                            alt="" />
                                    </a>
                                    <!--end::Icon-->
                                    <!--begin::Icon-->
                                    <a href="javascript:void(0)" class="mx-4">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/dribbble-icon-1.svg', $theme_asset_pack ?? null) }}" class="h-20px my-2"
                                            alt="" />
                                    </a>
                                    <!--end::Icon-->
                                </div>
                        ...
                        <div class="flex-column flex-lg-row-auto w-100 w-xl-300px mb-10">
                            ...
                            <div class="mb-16">
                                ...
                                <div class="d-flex flex-stack fw-semibold fs-5 text-muted mb-4">
                                    <!--begin::Text-->
                                    <a href="javascript:void(0)" class="text-muted text-hover-primary pe-2">SaaS Solutions</a>
                                    <!--end::Text-->
                                    <!--begin::Number-->
                                ...
                                <div class="d-flex flex-stack fw-semibold fs-5 text-muted mb-4">
                                    <!--begin::Text-->
                                    <a href="javascript:void(0)" class="text-muted text-hover-primary pe-2">Company News</a>
                                    <!--end::Text-->
                                    <!--begin::Number-->
                                ...
                                <div class="d-flex flex-stack fw-semibold fs-5 text-muted mb-4">
                                    <!--begin::Text-->
                                    <a href="javascript:void(0)" class="text-muted text-hover-primary pe-2">Events & Activities</a>
                                    <!--end::Text-->
                                    <!--begin::Number-->
                                ...
                                <div class="d-flex flex-stack fw-semibold fs-5 text-muted mb-4">
                                    <!--begin::Text-->
                                    <a href="javascript:void(0)" class="text-muted text-hover-primary pe-2">Support Related</a>
                                    <!--end::Text-->
                                    <!--begin::Number-->
                                ...
                                <div class="d-flex flex-stack fw-semibold fs-5 text-muted mb-4">
                                    <!--begin::Text-->
                                    <a href="javascript:void(0)" class="text-muted text-hover-primary pe-2">Innovations</a>
                                    <!--end::Text-->
                                    <!--begin::Number-->
                                ...
                                <div class="d-flex flex-stack fw-semibold fs-5 text-muted">
                                    <!--begin::Text-->
                                    <a href="javascript:void(0)" class="text-muted text-hover-primary pe-2">Product Updates</a>
                                    <!--end::Text-->
                                    <!--begin::Number-->
                            ...
                            <div class="m-0">
                                ...
                                <div class="d-flex flex-stack mb-7">
                                    ...
                                    <div class="symbol symbol-60px symbol-2by3 me-4">
                                        <div class="symbol-label"
                                            style="
                                    background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/600x400/img-1.jpg', $theme_asset_pack ?? null) }}');
                                  ">
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                    <div class="m-0">
                                        <a href="javascript:void(0)" class="text-gray-900 fw-bold text-hover-primary fs-6">About
                                            Bootstrap
                                            Admin</a>
                                ...
                                <div class="d-flex flex-stack mb-7">
                                    ...
                                    <div class="symbol symbol-60px symbol-2by3 me-4">
                                        <div class="symbol-label"
                                            style="
                                    background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/600x400/img-2.jpg', $theme_asset_pack ?? null) }}');
                                  ">
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                    <div class="m-0">
                                        <a href="javascript:void(0)" class="text-gray-900 fw-bold text-hover-primary fs-6">A yellow
                                            sofa</a>
                                        <span class="text-gray-600 fw-semibold d-block pt-1 fs-7">We’ve been a focused on
                                            making a
                                            the
                                ...
                                <div class="d-flex flex-stack mb-7">
                                    ...
                                    <div class="symbol symbol-60px symbol-2by3 me-4">
                                        <div class="symbol-label"
                                            style="
                                    background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/600x400/img-3.jpg', $theme_asset_pack ?? null) }}');
                                  ">
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                    <div class="m-0">
                                        <a href="javascript:void(0)" class="text-gray-900 fw-bold text-hover-primary fs-6">Our Camra
                                            Mega Set</a>
                                        <span class="text-gray-600 fw-semibold d-block pt-1 fs-7">We’ve been a focused on
                                            making a
                                            the
                                ...
                                <div class="d-flex flex-stack">
                                    ...
                                    <div class="symbol symbol-60px symbol-2by3 me-4">
                                        <div class="symbol-label"
                                            style="
                                    background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/600x400/img-4.jpg', $theme_asset_pack ?? null) }}');
                                  ">
                                        </div>
                                    </div>
                                    <!--end::Symbol-->
                                    <!--begin::Title-->
                                    <div class="m-0">
                                        <a href="javascript:void(0)" class="text-gray-900 fw-bold text-hover-primary fs-6">Time to
                                            cook and
                                            eat?</a>
                                        <span class="text-gray-600 fw-semibold d-block pt-1 fs-7">We’ve been a focused on
                                            making a
                    ...
                    <div class="mb-17">
                        ...
                        <div class="d-flex flex-stack mb-5">
                            ...
                            <!--end::Title-->
                            <!--begin::Link-->
                            <a href="javascript:void(0)" class="fs-6 fw-semibold link-primary">View All Videos</a>
                            <!--end::Link-->
                        </div>
                        <!--end::Content-->
                        <!--begin::Separator-->
                        ...
                        <div class="row g-10">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card-xl-stretch me-md-6">
                                    ...
                                    <a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5"
                                        style="
                                  background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/600x400/img-73.jpg', $theme_asset_pack ?? null) }}');
                                "
                                        data-fslightbox="lightbox-video-tutorials"
                                        href="https://www.youtube.com/embed/btornGtLwIo">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/svg/misc/video-play.svg', $theme_asset_pack ?? null) }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card-xl-stretch mx-md-3">
                                    ...
                                    <a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5"
                                        style="
                                  background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/600x400/img-74.jpg', $theme_asset_pack ?? null) }}');
                                "
                                        data-fslightbox="lightbox-video-tutorials"
                                        href="https://www.youtube.com/embed/btornGtLwIo">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/svg/misc/video-play.svg', $theme_asset_pack ?? null) }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card-xl-stretch ms-md-6">
                                    ...
                                    <a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5"
                                        style="
                                  background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/600x400/img-47.jpg', $theme_asset_pack ?? null) }}');
                                "
                                        data-fslightbox="lightbox-video-tutorials"
                    ...
                    <div class="mb-17">
                        ...
                        <div class="d-flex flex-stack mb-5">
                            ...
                            <!--end::Title-->
                            <!--begin::Link-->
                            <a href="javascript:void(0)" class="fs-6 fw-semibold link-primary">View All Offers</a>
                            <!--end::Link-->
                        </div>
                        <!--end::Content-->
                        <!--begin::Separator-->
                        ...
                        <div class="row g-10">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card-xl-stretch me-md-6">
                                    ...
                                    <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                        href="{{ \App\Support\ThemeAsset::url('media/stock/600x400/img-23.jpg', $theme_asset_pack ?? null) }}">
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                            style="
                                    background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/600x400/img-23.jpg', $theme_asset_pack ?? null) }}');
                                  ">
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Action-->
                                    ...
                                    <div class="mt-5">
                                        ...
                                        <div class="fs-6 fw-bold mt-5 d-flex flex-stack">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Action-->
                                            <a href="javascript:void(0)" class="btn btn-sm btn-primary">Purchase</a>
                                            <!--end::Action-->
                                        </div>
                                        <!--end::Text-->
                                    </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card-xl-stretch mx-md-3">
                                    <!--begin::Overlay-->
                                    <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                        href="{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-14.jpg', $theme_asset_pack ?? null) }}">
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                            style="
                                    background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-14.jpg', $theme_asset_pack ?? null) }}');
                                  ">
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Action-->
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card-xl-stretch ms-md-6">
                                    <!--begin::Overlay-->
                                    <a class="d-block overlay" data-fslightbox="lightbox-hot-sales"
                                        href="{{ \App\Support\ThemeAsset::url('media/stock/600x400/img-71.jpg', $theme_asset_pack ?? null) }}">
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                            style="
                                    background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/600x400/img-71.jpg', $theme_asset_pack ?? null) }}');
                                  ">
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Action-->
