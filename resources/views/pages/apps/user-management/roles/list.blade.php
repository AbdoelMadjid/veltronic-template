...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/user-management/roles/list/add.js', $theme_asset_pack ?? null) }}"></script>
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/user-management/roles/list/update-role.js', $theme_asset_pack ?? null) }}"></script>
