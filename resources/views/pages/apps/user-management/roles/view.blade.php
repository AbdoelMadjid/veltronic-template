...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/user-management/roles/view/view.js', $theme_asset_pack ?? null) }}"></script>
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/user-management/roles/view/update-role.js', $theme_asset_pack ?? null) }}"></script>
