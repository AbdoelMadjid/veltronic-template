                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-center flex-column py-5">
                                ...
                                <!--end::Avatar-->
                                <!--begin::Name-->
                                <a href="javascript:void(0)" class="fs-3 text-gray-800 text-hover-primary fw-bold mb-3">Emma Smith</a>
                                <!--end::Name-->
                                <!--begin::Position-->
                                <div class="mb-9">
                                    <!--begin::Badge-->
                            ...
                            <div id="kt_user_view_details" class="collapse show">
                                <div class="pb-5 fs-6">
                                    ...
                                    <div class="text-gray-600">
                                        <a href="javascript:void(0)" class="text-gray-600 text-hover-primary">info@keenthemes.com</a>
                                    </div>
                                    <!--begin::Details item-->
                                    <!--begin::Details item-->
                        ...
                        <div class="card-body pt-2">
                                ...
                                <div class="d-flex flex-stack flex-grow-1">
                                    ...
                                    <div class="fw-semibold">
                                        <div class="fs-6 text-gray-700">
                                            ...
                                            our
                                            <a href="javascript:void(0)" class="me-1">privacy policy</a>and
                            ...
                            <div class="py-2">
                                ...
                                <div class="d-flex flex-stack">
                                    <div class="d-flex">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/google-icon.svg', $theme_asset_pack ?? null) }}" class="w-30px me-6"
                                            alt="" />
                                ...
                                <div class="d-flex flex-stack">
                                    <div class="d-flex">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/github.svg', $theme_asset_pack ?? null) }}" class="w-30px me-6"
                                            alt="" />
                                        <div class="d-flex flex-column">
                                            <a href="javascript:void(0)"
                                ...
                                <div class="d-flex flex-stack">
                                    <div class="d-flex">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/slack-icon.svg', $theme_asset_pack ?? null) }}" class="w-30px me-6"
                                            alt="" />
                                        <div class="d-flex flex-column">
                                            <a href="javascript:void(0)"
                ...
                <div class="flex-lg-row-fluid ms-lg-15">
                    ...
                    <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8">
                        ...
                        <li class="nav-item ms-auto">
                            <!--begin::Action menu-->
                            <a href="javascript:void(0)" class="btn btn-primary ps-7" data-kt-menu-trigger="click"
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold py-4 w-250px fs-6"
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-5">
                                    <a href="javascript:void(0)" class="menu-link px-5">Create invoice</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-5">
                                    <a href="javascript:void(0)" class="menu-link flex-stack px-5">Create payments
                                ...
                                <div class="menu-item px-5" data-kt-menu-trigger="hover"
                                    ...
                                    <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="javascript:void(0)" class="menu-link px-5">Apps</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="javascript:void(0)" class="menu-link px-5">Statements</a>
                                        </div>
                                        <!--end::Menu item-->
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-5">
                                    <a href="javascript:void(0)" class="menu-link text-danger px-5">Delete customer</a>
                                </div>
                                <!--end::Menu item-->
                            </div>
                            <!--end::Menu-->
                            ...
                            <div class="card card-flush mb-6 mb-xl-9">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="d-flex align-items-center position-relative mb-7">
                                        ...
                                        <!--begin::Details-->
                                        <div class="fw-semibold ms-5">
                                            <a href="javascript:void(0)" class="fs-5 fw-bold text-gray-900 text-hover-primary">Create
                                                FureStibe
                                                branding logo</a>
                                            <!--begin::Info-->
                                            <div class="fs-7 text-muted">
                                    ...
                                    <div class="d-flex align-items-center position-relative mb-7">
                                        ...
                                        <!--begin::Details-->
                                        <div class="fw-semibold ms-5">
                                            <a href="javascript:void(0)" class="fs-5 fw-bold text-gray-900 text-hover-primary">9
                                                Degree Project
                                                Estimation</a>
                                            <!--begin::Info-->
                                            <div class="fs-7 text-muted">
                                    ...
                                    <div class="d-flex align-items-center position-relative">
                                        ...
                                        <!--begin::Details-->
                                        <div class="fw-semibold ms-5">
                                            <a href="javascript:void(0)" class="fs-5 fw-bold text-gray-900 text-hover-primary">Mivy
                                                App R&D, Meeting
                                                with clients</a>
                                            <!--begin::Info-->
                                            <div class="fs-7 text-muted">
                            ...
                            <div class="card pt-4 mb-6 mb-xl-9">
                                ...
                                <div class="card-body pb-5">
                                    ...
                                    <div class="text-gray-600">
                                        ...
                                        you can
                                        <a href="javascript:void(0)" class="me-1">generate a backup code</a>to sign in to your
                                        account.
                                    </div>
                                    <!--end::Disclaimer-->
                                </div>
                                        ...
                                        <table class="table align-middle table-row-dashed gy-5"
                                            ...
                                            <tbody class="fs-6 fw-semibold text-gray-600">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>3 days ago</td>
                                                    <td>
                                                        <a href="javascript:void(0)" data-kt-users-sign-out="single_user">Sign
                                                            out</a>
                                                    </td>
                                                </tr>
                                                <tr>
                                ...
                                <div class="card-body py-0">
                                    ...
                                    <table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-semibold gy-5"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="min-w-400px">
                                                    <a href="javascript:void(0)" class="text-gray-600 text-hover-primary me-1">Max
                                                        Smith</a>has made
                                                    payment to
                                                    <a href="javascript:void(0)"
                                            ...
                                            <tr>
                                                <td class="min-w-400px">
                                                    <a href="javascript:void(0)" class="text-gray-600 text-hover-primary me-1">Emma
                                                        Smith</a>has made
                                                    payment to
                                                    <a href="javascript:void(0)"
                                            ...
                                            <div class="mt-1">
                                                ...
                                                <style>
                                                    ...
                                                    [data-bs-theme="dark"] .image-input-placeholder {
                                                        background-image: url('{{ \App\Support\ThemeAsset::url('media/svg/avatars/blank-dark.svg', $theme_asset_pack ?? null) }}');
                                                    }
                                                </style>
                                                ...
                                                <div class="image-input image-input-outline image-input-placeholder"
                                                    ...
                                                    <div class="image-input-wrapper w-125px h-125px"
                                                        style="background-image: url('{{ \App\Support\ThemeAsset::url('media/avatars/300-6.jpg', $theme_asset_pack ?? null) }}')">
                                                    </div>
                        ...
                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                            ...
                            <div class="fw-bold d-flex flex-column justify-content-center mb-5">
                                ...
                                <div class="text-center mb-5" data-kt-add-auth-action="qr-code-label">
                                    Download the <a href="javascript:void(0)">Authenticator app</a>,
                                ...
                                <div class="d-flex flex-center" data-kt-add-auth-action="qr-code">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/misc/qr.png', $theme_asset_pack ?? null) }}" alt="Scan this QR code" />
                                </div>
                                <!--end::QR code-->
                                <!--begin::Text code-->
...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/user-management/users/view/view.js', $theme_asset_pack ?? null) }}"></script>
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/user-management/users/view/update-details.js', $theme_asset_pack ?? null) }}"></script>
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/user-management/users/view/add-schedule.js', $theme_asset_pack ?? null) }}"></script>
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/user-management/users/view/add-task.js', $theme_asset_pack ?? null) }}"></script>
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/user-management/users/view/update-email.js', $theme_asset_pack ?? null) }}"></script>
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/user-management/users/view/update-password.js', $theme_asset_pack ?? null) }}"></script>
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/user-management/users/view/update-role.js', $theme_asset_pack ?? null) }}"></script>
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/user-management/users/view/add-auth-app.js', $theme_asset_pack ?? null) }}"></script>
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/apps/user-management/users/view/add-one-time-password.js', $theme_asset_pack ?? null) }}"></script>
