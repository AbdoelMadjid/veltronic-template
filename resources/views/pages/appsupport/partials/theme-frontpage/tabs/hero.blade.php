        ...
        <form id="kt_form_landing_hero" class="form">
            ...
            <div class="card card-flush shadow-sm mb-6 border-0">
                ...
                <div class="card-body pt-2 pb-6">
                    ...
                    <div class="d-flex align-items-center justify-content-between p-4 bg-light-subtle rounded-3 border border-gray-200">
                        <div class="d-flex flex-column">
                            ...
                            <span class="text-muted fs-8">Tampilkan deretan logo brand (Fujifilm, Vodafone, NASA, dll.) di bawah tombol hero</span>
                        </div>
                ...
                <div class="card-footer d-flex justify-content-end py-4 px-9 border-0">
                    <button type="submit" class="btn btn-primary btn-sm fw-bold rounded-pill px-6" id="kt_btn_save_hero">
        ...
        <form id="kt_form_landing_logos" class="form" enctype="multipart/form-data">
            ...
            <div class="card card-flush shadow-sm mb-6 border-0">
                <div class="card-header pt-6">
                    ...
                    <div class="card-toolbar">
                        <button type="button" class="btn btn-icon btn-light-warning btn-sm" id="kt_btn_reset_landing_logos" data-bs-toggle="tooltip" title="Reset Logo ke Default">
                ...
                <div class="card-body pt-2 pb-6">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex align-items-center gap-3 mb-2">
                            <div class="w-45px h-45px rounded-3 border border-gray-300 d-flex align-items-center justify-content-center bg-body">
                ...
                <div class="card-footer d-flex justify-content-end py-4 px-6 border-0">
                    <button type="submit" class="btn btn-primary btn-sm fw-bold rounded-pill px-6" id="kt_btn_save_logos">
                        <span class="indicator-label">
