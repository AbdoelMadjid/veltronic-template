...
<div class="card card-flush shadow-sm border-0 mb-6">
    <div class="card-header pt-6">
        <div class="card-title">
            ...
            <div>
                ...
                <span class="text-muted fs-7">Uji tampilan landing page langsung dalam berbagai mode layar (Desktop, Tablet, Ponsel).</span>
            </div>
        </div>
        <div class="card-toolbar gap-2">
            ...
            <button type="button" class="btn btn-light-secondary btn-sm fw-bold" id="kt_btn_refresh_preview">
    ...
    <div class="card-body p-4 bg-light-subtle d-flex justify-content-center overflow-hidden">
