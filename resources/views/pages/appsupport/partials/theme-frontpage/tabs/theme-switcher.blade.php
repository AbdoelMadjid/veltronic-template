...
<div class="row g-6 g-xl-9">
        ...
        <div class="card card-flush shadow-sm h-100 border {{ ($currentFrontpage ?? 'landing') === 'landing' ? 'border-primary border-2' : 'border-gray-200' }}">
            ...
            <div class="card-header pt-7">
                <div class="card-title d-flex align-items-center gap-3">
                    <div class="symbol symbol-45px symbol-circle bg-light-primary d-flex align-items-center justify-content-center">
            ...
            <div class="card-body pt-2 pb-6">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    @endif
                    <a href="{{ url('/landing') }}" target="_blank" class="btn btn-light-primary btn-sm fw-bold px-4 text-nowrap">
    ...
    <div class="col-md-6 col-xl-6">
        <div class="card card-flush shadow-sm h-100 border {{ ($currentFrontpage ?? 'landing') === 'education' ? 'border-warning border-2' : 'border-gray-200' }}">
            ...
            <div class="card-header pt-7">
                <div class="card-title d-flex align-items-center gap-3">
                    <div class="symbol symbol-45px symbol-circle bg-light-warning d-flex align-items-center justify-content-center">
            ...
            <div class="card-body pt-2 pb-6">
                ...
                <div class="alert alert-dismissible bg-light-warning d-flex flex-column flex-sm-row p-4 mb-5 border border-warning border-opacity-25 rounded-3">
                    <i class="ki-outline ki-information-5 fs-2 text-warning me-3 mb-2 mb-sm-0"></i>
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    @endif
                    <a href="{{ url('/education') }}" target="_blank" class="btn btn-light-warning btn-sm fw-bold px-4 text-nowrap">
                        <i class="ki-outline ki-eye fs-4 me-1"></i> Preview
                    </a>
                </div>
                <!--end::Action Button-->
