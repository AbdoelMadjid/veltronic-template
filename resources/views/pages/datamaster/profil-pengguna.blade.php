                        ...
                        <div class="card-body d-flex flex-column flex-center">
                            ...
                            <div class="mb-2">
                                ...
                                <div class="py-10 text-center">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/illustrations/easy/1.svg', $theme_asset_pack ?? null) }}"
                            ...
                            <div class="hover-scroll-overlay-y pe-6 me-n6" style="height: 415px">
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="{{ \App\Support\ThemeAsset::url('media/stock/ecommerce/210.png', $theme_asset_pack ?? null) }}"
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="{{ \App\Support\ThemeAsset::url('media/stock/ecommerce/209.png', $theme_asset_pack ?? null) }}"
                                                class="w-50px ms-n1 me-1" alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <a href="/apps/ecommerce/catalog/edit-product"
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="{{ \App\Support\ThemeAsset::url('media/stock/ecommerce/214.png', $theme_asset_pack ?? null) }}"
                                                class="w-50px ms-n1 me-1" alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <a href="/apps/ecommerce/catalog/edit-product"
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="{{ \App\Support\ThemeAsset::url('media/stock/ecommerce/211.png', $theme_asset_pack ?? null) }}"
                                                class="w-50px ms-n1 me-1" alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <a href="/apps/ecommerce/catalog/edit-product"
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="{{ \App\Support\ThemeAsset::url('media/stock/ecommerce/215.png', $theme_asset_pack ?? null) }}"
                                                class="w-50px ms-n1 me-1" alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <a href="/apps/ecommerce/catalog/edit-product"
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="{{ \App\Support\ThemeAsset::url('media/stock/ecommerce/192.png', $theme_asset_pack ?? null) }}"
                                                class="w-50px ms-n1 me-1" alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <a href="/apps/ecommerce/catalog/edit-product"
