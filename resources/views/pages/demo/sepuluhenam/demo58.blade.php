                ...
                <div class="col-xl-8 mb-xl-10">
                    ...
                    <div class="row g-5 g-xl-10">
                        ...
                        <div class="col-lg-6 mb-xl-10">
                            ...
                            @include('partials.widgets-demo.chart.__widget-47')
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col-lg-6 mb-5 mb-xl-10">
                            <x-widget-include-badge name="chart.__widget-48" />
                            @include('partials.widgets-demo.chart.__widget-48')
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Row-->
                    ...
                    @include('partials.widgets-demo.table.__widget-15')
                    <!--begin::Row-->
                    <div class="row gx-5 gx-xl-10">
                        <!--begin::Col-->
                ...
                <div class="col-xl-4">
                    ...
                    <div class="row gx-5 gx-xl-10">
                        ...
                        <div class="col-sm-6 col-xl-12 mb-5 mb-xl-10">
                            ...
                            @include('partials.widgets-demo.list.__widget-10', ['widgetClass' => 'card card-flush'])
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col-sm-6 col-xl-12 mb-xl-10">
                            <x-widget-include-badge name="list.__widget-11" />
                            @include('partials.widgets-demo.list.__widget-11', ['widgetClass' => 'card card-flush'])
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Row-->
