        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="row gx-5 gx-xl-10">
                ...
                <div class="col-xl-6 mb-5 mb-xl-10">
                    ...
                    @include('partials.widgets-demo.table.__widget-11')
                </div>
                <!--end::Col-->
            </div>
            <!--end::Row-->
            ...
            <div class="row gx-5 gx-xl-10">
                ...
                <div class="col-xl-4 mb-5 mb-xl-10">
                    ...
                    @include('partials.widgets-demo.chart.__widget-29', [
                        'vars' => [
                            'trend_icon_class' => 'ki-duotone ki-arrow-up fs-5 text-success ms-n1',
                            'trend_icon_duotone' => true,
                            'menu_icon_class' => 'ki-duotone ki-dots-square fs-1 text-gray-500 me-n1',
            ...
            <div class="row gx-5 gx-xl-10">
                ...
                <div class="col-xl-4 mb-5 mb-xl-0">
                    ...
                    @include('partials.widgets-demo.chart.__widget-30', [
                        'vars' => [
                            'gap_trend_icon_class' => 'ki-duotone ki-arrow-up fs-5 text-success ms-n1',
                            'gap_trend_icon_duotone' => true,
                        ],
                    ])
                </div>
                <!--end::Col-->
