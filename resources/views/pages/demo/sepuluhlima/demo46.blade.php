            ...
            <div class="row gx-5 gx-xl-10">
                ...
                <div class="col-xxl-4 mb-5 mb-xl-10">
                    ...
                    @include('partials.widgets-demo.chart.__widget-27', [
                        'vars' => [
                            'trend_icon_class' => 'ki-duotone ki-arrow-up fs-5 text-danger ms-n1',
                            'trend_icon_duotone' => true,
                            'menu_icon_class' => 'ki-duotone ki-dots-square fs-1 text-gray-500 me-n1',
                ...
                <div class="col-xxl-4 mb-5 mb-xl-10">
                    ...
                    @include('partials.widgets-demo.chart.__widget-28', [
                        'vars' => [
                            'trend_icon_class' => 'ki-duotone ki-arrow-up fs-5 text-success ms-n1',
                            'trend_icon_duotone' => true,
                            'menu_icon_class' => 'ki-duotone ki-dots-square fs-1 text-gray-500 me-n1',
                            'menu_icon_duotone' => true,
                        ],
                    ...
                    <div class="row g-5 g-xl-10">
                        ...
                        <div class="col-md-6 col-xl-6 mb-xxl-10">
                            ...
                            @include('partials.widgets-demo.card.__widget-5', [
                                'vars' => [
                                    'badge_icon_class' => 'ki-duotone ki-arrow-down fs-5 text-danger ms-n1',
                                    'badge_icon_duotone' => true,
                                ],
                            ])
                        </div>
                ...
                <div class="col-xl-4">
                    ...
                    @include('partials.widgets-demo.chart.__widget-14', [
                        'vars' => [
                            'menu_icon_class' => 'ki-duotone ki-dots-square fs-1 text-gray-500 me-n1',
                            'menu_icon_duotone' => true,
                            'info_icon_class' => 'ki-duotone ki-information fs-6',
                            'info_icon_duotone' => true,
                        ],
                    ])
                </div>
                <!--end::Col-->
