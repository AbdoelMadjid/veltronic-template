                ...
                <div class="col-xl-4">
                    <div class="row g-5 g-xl-10">
                        <div class="col-12 mb-xl-10">
                            ...
                            @include('partials.widgets-demo.list.__widget-16')
                        </div>
                        <div class="col-12 mb-xl-10">
                            <x-widget-include-badge name="slider.__widget-7" />
                            @include('partials.widgets-demo.slider.__widget-7')
                        </div>
                        <div class="col-12 mb-xl-10">
                            <x-widget-include-badge name="list.__widget-16a" />
                            @include('partials.widgets-demo.list.__widget-16a')
                        </div>
                        <div class="col-12 mb-xl-10">
                ...
                <div class="col-xl-8">
                    <div class="row g-5 g-xl-10">
                        <div class="col-12 mb-5 mb-xl-10">
                            ...
                            @include('partials.widgets-demo.engage.__widget-12')
                        </div>
                        <div class="col-12 mb-xl-10">
