...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('plugins/custom/flotcharts/flotcharts.bundle.js', $theme_asset_pack ?? null) }}"></script>
    <!--end::Vendors Javascript-->

    <!--begin::Custom Javascript(used for this page only)-->
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/documentation/charts/flotcharts/tracking.js', $theme_asset_pack ?? null) }}"></script>
