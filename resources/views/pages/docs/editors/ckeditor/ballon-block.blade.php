                    ...
                    <div class="pt-10">
                        ...
                        <div class="pt-5">
                            <div id="kt_docs_ckeditor_balloon_block">
                                ...
                                <p>Here goes the <a href="javascript:void(0)">Minitial content of the editor</a>. Lorem Ipsum is simply
                                ...
                                <figure class="image"><img src="{{ \App\Support\ThemeAsset::url('media/stock/600x400/img-1.jpg', $theme_asset_pack ?? null) }}"
                                        alt="CKEditor Demo" /></figure>
                                Here goes the <a href="javascript:void(0)">Minitial content of the editor</a>. Lorem Ipsum is simply
...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('plugins/custom/ckeditor/ckeditor-balloon-block.bundle.js', $theme_asset_pack ?? null) }}"></script>
    <!--end::Vendors Javascript-->

    <!--begin::Custom Javascript(used for this page only)-->
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/documentation/editors/ckeditor/balloon-block.js', $theme_asset_pack ?? null) }}"></script>
