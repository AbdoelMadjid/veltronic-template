...
@section('content')
    ...
    <div class="docs-content d-flex flex-column flex-column-fluid" id="kt_docs_content">
        ...
        <div class="container d-flex flex-column flex-lg-row" id="kt_docs_content_container">
            ...
            <p>Here goes the <a href="javascript:void(0)">Minitial content of the editor</a>. Lorem Ipsum is simply dummy text of the <em>printing and typesetting</em> industry.</p>
            ...
            <figure class="image"><img src="{{ \App\Support\ThemeAsset::url('media/stock/600x400/img-1.jpg', $theme_asset_pack ?? null) }}" alt="CKEditor Demo"/></figure>
            Here goes the <a href="javascript:void(0)">Minitial content of the editor</a>. Lorem Ipsum is simply dummy text of the <em>printing and typesetting</em> industry.
...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('plugins/custom/ckeditor/ckeditor-classic.bundle.js', $theme_asset_pack ?? null) }}"></script>
    <!--end::Vendors Javascript-->

    <!--begin::Custom Javascript(used for this page only)-->
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/documentation/editors/ckeditor/classic.js', $theme_asset_pack ?? null) }}"></script>
