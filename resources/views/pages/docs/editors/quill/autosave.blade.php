                    ...
                    <div class="pt-10">
                        ...
                        <div class="py-5">
                            <div id="kt_docs_quill_autosave" name="kt_docs_quill_autosave">
                                ...
                                <p>Here goes the&nbsp;<a href="javascript:void(0)">Minitial content of the editor</a>. Lorem Ipsum is
...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/documentation/editors/quill/autosave.js', $theme_asset_pack ?? null) }}"></script>
