...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('plugins/custom/tinymce/tinymce.bundle.js', $theme_asset_pack ?? null) }}"></script>
    <!--end::Vendors Javascript-->

    <!--begin::Custom Javascript(used for this page only)-->
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/documentation/editors/tinymce/plugins.js', $theme_asset_pack ?? null) }}"></script>
