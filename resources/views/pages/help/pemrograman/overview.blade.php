        ...
        <div id="kt_app_content_container" class="app-container container-fluid" data-kt-lang-ignore="true">
            ...
            <div class="row g-6" id="documentation_container" data-kt-lang-ignore="true">
                ...
                <div class="col-12 col-xxl-6 doc-main-col" id="col_skema">
                    ...
                    <!-- ========================================== -->
                    <div class="card card-flush shadow-sm border-0 mb-6 bg-body doc-category-group" data-group="core">
                        <div class="card-header pt-5 pb-3 min-h-auto border-0">
                            <div class="card-title m-0">
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <h4 class="fs-6 fw-bold text-gray-900 mb-0">1. Pondasi Inti &amp; Arsitektur Tata Letak</h4>
                                </div>
                            </div>
                            <div class="card-toolbar">
                                <span class="badge badge-light-primary fw-semibold fs-8">5 Topik</span>
                            </div>
                        </div>
                    ...
                    <!-- ========================================== -->
                    <div class="card card-flush shadow-sm border-0 mb-6 bg-body doc-category-group" data-group="security">
                        <div class="card-header pt-5 pb-3 min-h-auto border-0">
                            <div class="card-title m-0">
                                <div class="d-flex align-items-center gap-2">
                                    <span class="symbol symbol-35px symbol-circle bg-light-success me-2">
                                        <i class="ki-duotone ki-shield-tick fs-4 text-success"><span class="path1"></span><span class="path2"></span></i>
                                    </span>
                                    <h4 class="fs-6 fw-bold text-gray-900 mb-0">2. Keamanan, Hak Akses &amp; Profil Pengguna</h4>
                                </div>
                            </div>
                            <div class="card-toolbar">
                                <span class="badge badge-light-success fw-semibold fs-8">2 Topik</span>
                            </div>
                        </div>
                        <div class="card-body pt-2 pb-5">
                            <div class="row g-4">
                    ...
                    <!-- ========================================== -->
                    <div class="card card-flush shadow-sm border-0 mb-6 bg-body doc-category-group" data-group="nav">
                        <div class="card-header pt-5 pb-3 min-h-auto border-0">
                            <div class="card-title m-0">
                                <div class="d-flex align-items-center gap-2">
                                    <span class="symbol symbol-35px symbol-circle bg-light-warning me-2">
                                    ...
                                    <h4 class="fs-6 fw-bold text-gray-900 mb-0">3. Struktur Menu, Navigasi &amp; Pintasan Papan Ketik</h4>
                                </div>
                            </div>
                            <div class="card-toolbar">
                                <span class="badge badge-light-warning fw-semibold fs-8">4 Topik</span>
                            </div>
                        </div>
                        <div class="card-body pt-2 pb-5">
                            <div class="row g-4">
                    ...
                    <!-- ========================================== -->
                    <div class="card card-flush shadow-sm border-0 mb-6 bg-body doc-category-group" data-group="data">
                        <div class="card-header pt-5 pb-3 min-h-auto border-0">
                            <div class="card-title m-0">
                                <div class="d-flex align-items-center gap-2">
                                    <span class="symbol symbol-35px symbol-circle bg-light-danger me-2">
                                        <i class="ki-duotone ki-data-download fs-4 text-danger"><span class="path1"></span><span class="path2"></span></i>
                                    </span>
                                    <h4 class="fs-6 fw-bold text-gray-900 mb-0">4. Lapisan Data, Cadangan &amp; Diagnostik Sistem</h4>
                                </div>
                            </div>
                            <div class="card-toolbar">
                                <span class="badge badge-light-danger fw-semibold fs-8">5 Topik</span>
                            </div>
                        </div>
                        <div class="card-body pt-2 pb-5">
                            <div class="row g-4">
                    ...
                    <!-- ========================================== -->
                    <div class="card card-flush shadow-sm border-0 mb-6 bg-body doc-category-group" data-group="theme">
                        <div class="card-header pt-5 pb-3 min-h-auto border-0">
                            <div class="card-title m-0">
                                <div class="d-flex align-items-center gap-2">
                                    <span class="symbol symbol-35px symbol-circle bg-light-info me-2">
                                        <i class="ki-duotone ki-flag fs-4 text-info"><span class="path1"></span><span class="path2"></span></i>
                                    </span>
                                    <h4 class="fs-6 fw-bold text-gray-900 mb-0">5. Penyesuaian Tema, Halaman Depan &amp; Bahasa</h4>
                                </div>
                            </div>
                            <div class="card-toolbar">
                                <span class="badge badge-light-info fw-semibold fs-8">5 Topik</span>
                            </div>
                        </div>
                        <div class="card-body pt-2 pb-5">
                            <div class="row g-4">
                ...
                <div class="col-12 col-xxl-6 doc-main-col" id="col_operasional">
                    ...
                    <!-- ========================================== -->
                    <div class="card card-flush shadow-sm border-0 mb-6 bg-body doc-category-group" data-group="workflow">
                        <div class="card-header pt-5 pb-3 min-h-auto border-0">
                            <div class="card-title m-0">
                                <div class="d-flex align-items-center gap-2">
                                    <span class="symbol symbol-35px symbol-circle bg-light-primary me-2">
                    ...
                    <div class="card card-flush shadow-sm border-0 mb-6 bg-body doc-category-group" data-group="nav">
                        <div class="card-header pt-5 pb-3 min-h-auto border-0">
                            ...
                            <div class="card-toolbar">
                                <span class="badge badge-light-success fw-semibold fs-8">4 Topik</span>
                            </div>
                        </div>
                        <div class="card-body pt-2 pb-5">
                            <div class="row g-4">
                    ...
                    <div class="card card-flush shadow-sm border-0 mb-6 bg-body doc-category-group" data-group="data">
                        <div class="card-header pt-5 pb-3 min-h-auto border-0">
                            ...
                            <div class="card-toolbar">
                                <span class="badge badge-light-danger fw-semibold fs-8">4 Topik</span>
                            </div>
                        </div>
                        <div class="card-body pt-2 pb-5">
                            <div class="row g-4">
