                            ...
                            <ul class="nav nav-pills d-flex justify-content-between nav-pills-custom gap-3 mb-6">
                                ...
                                <li class="nav-item mb-3 me-0">
                                    ...
                                    <a class="nav-link nav-link-border-solid btn btn-outline btn-flex btn-active-color-primary flex-column flex-stack pt-9 pb-7 page-bg show active"
                                        ...
                                        <div class="nav-icon mb-3">
                                            <!--begin::Food icon-->
                                            <img src="{{ \App\Support\ThemeAsset::url('media/svg/food-icons/spaghetti.svg', $theme_asset_pack ?? null) }}" class="w-50px"
                                                alt="" />
                                            <!--end::Food icon-->
                                        </div>
                                        <!--end::Icon-->
                                ...
                                <li class="nav-item mb-3 me-0">
                                    ...
                                    <a class="nav-link nav-link-border-solid btn btn-outline btn-flex btn-active-color-primary flex-column flex-stack pt-9 pb-7 page-bg"
                                        ...
                                        <div class="nav-icon mb-3">
                                            <!--begin::Food icon-->
                                            <img src="{{ \App\Support\ThemeAsset::url('media/svg/food-icons/salad.svg', $theme_asset_pack ?? null) }}" class="w-50px"
                                                alt="" />
                                            <!--end::Food icon-->
                                        </div>
                                        <!--end::Icon-->
                                ...
                                <li class="nav-item mb-3 me-0">
                                    ...
                                    <a class="nav-link nav-link-border-solid btn btn-outline btn-flex btn-active-color-primary flex-column flex-stack pt-9 pb-7 page-bg"
                                        ...
                                        <div class="nav-icon mb-3">
                                            <!--begin::Food icon-->
                                            <img src="{{ \App\Support\ThemeAsset::url('media/svg/food-icons/cheeseburger.svg', $theme_asset_pack ?? null) }}" class="w-50px"
                                                alt="" />
                                            <!--end::Food icon-->
                                        </div>
                                        <!--end::Icon-->
                                ...
                                <li class="nav-item mb-3 me-0">
                                    ...
                                    <a class="nav-link nav-link-border-solid btn btn-outline btn-flex btn-active-color-primary flex-column flex-stack pt-9 pb-7 page-bg"
                                        ...
                                        <div class="nav-icon mb-3">
                                            <!--begin::Food icon-->
                                            <img src="{{ \App\Support\ThemeAsset::url('media/svg/food-icons/coffee.svg', $theme_asset_pack ?? null) }}" class="w-50px"
                                                alt="" />
                                            <!--end::Food icon-->
                                        </div>
                                        <!--end::Icon-->
                                ...
                                <li class="nav-item mb-3 me-0">
                                    ...
                                    <a class="nav-link nav-link-border-solid btn btn-outline btn-flex btn-active-color-primary flex-column flex-stack pt-9 pb-7 page-bg"
                                        ...
                                        <div class="nav-icon mb-3">
                                            <!--begin::Food icon-->
                                            <img src="{{ \App\Support\ThemeAsset::url('media/svg/food-icons/cheesecake.svg', $theme_asset_pack ?? null) }}" class="w-50px"
                                                alt="" />
                                            <!--end::Food icon-->
                                        </div>
                                        <!--end::Icon-->
                                    ...
                                    <div class="d-flex flex-wrap d-grid gap-5 gap-xxl-9">
                                        ...
                                        <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100">
                                            ...
                                            <div class="card-body text-center">
                                                <!--begin::Food img-->
                                                <img src="{{ \App\Support\ThemeAsset::url('media/stock/food/img-2.jpg', $theme_asset_pack ?? null) }}"
                                        ...
                                        <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100">
                                            ...
                                            <div class="card-body text-center">
                                                <!--begin::Food img-->
                                                <img src="{{ \App\Support\ThemeAsset::url('media/stock/food/img-7.jpg', $theme_asset_pack ?? null) }}"
                                                    class="rounded-3 mb-4 w-150px h-150px w-xxl-200px h-xxl-200px"
                                                    alt="" />
                                                <!--end::Food img-->
                                                <!--begin::Info-->
                                        ...
                                        <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100">
                                            ...
                                            <div class="card-body text-center">
                                                <!--begin::Food img-->
                                                <img src="{{ \App\Support\ThemeAsset::url('media/stock/food/img-8.jpg', $theme_asset_pack ?? null) }}"
                                                    class="rounded-3 mb-4 w-150px h-150px w-xxl-200px h-xxl-200px"
                                                    alt="" />
                                                <!--end::Food img-->
                                                <!--begin::Info-->
                                        ...
                                        <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100">
                                            ...
                                            <div class="card-body text-center">
                                                <!--begin::Food img-->
                                                <img src="{{ \App\Support\ThemeAsset::url('media/stock/food/img-4.jpg', $theme_asset_pack ?? null) }}"
                                                    class="rounded-3 mb-4 w-150px h-150px w-xxl-200px h-xxl-200px"
                                                    alt="" />
                                                <!--end::Food img-->
                                                <!--begin::Info-->
                                        ...
                                        <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100">
                                            ...
                                            <div class="card-body text-center">
                                                <!--begin::Food img-->
                                                <img src="{{ \App\Support\ThemeAsset::url('media/stock/food/img-10.jpg', $theme_asset_pack ?? null) }}"
                                                    class="rounded-3 mb-4 w-150px h-150px w-xxl-200px h-xxl-200px"
                                                    alt="" />
                                                <!--end::Food img-->
                                                <!--begin::Info-->
                                        ...
                                        <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100">
                                            ...
                                            <div class="card-body text-center">
                                                <!--begin::Food img-->
                                                <img src="{{ \App\Support\ThemeAsset::url('media/stock/food/img-9.jpg', $theme_asset_pack ?? null) }}"
                                                    class="rounded-3 mb-4 w-150px h-150px w-xxl-200px h-xxl-200px"
                                                    alt="" />
                                                <!--end::Food img-->
                                                <!--begin::Info-->
                                        ...
                                        <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100">
                                            ...
                                            <div class="card-body text-center">
                                                <!--begin::Food img-->
                                                <img src="{{ \App\Support\ThemeAsset::url('media/stock/food/img-3.jpg', $theme_asset_pack ?? null) }}"
                                                    class="rounded-3 mb-4 w-150px h-150px w-xxl-200px h-xxl-200px"
                                                    alt="" />
                                                <!--end::Food img-->
                                                <!--begin::Info-->
                                        ...
                                        <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100">
                                            ...
                                            <div class="card-body text-center">
                                                <!--begin::Food img-->
                                                <img src="{{ \App\Support\ThemeAsset::url('media/stock/food/img-5.jpg', $theme_asset_pack ?? null) }}"
                                                    class="rounded-3 mb-4 w-150px h-150px w-xxl-200px h-xxl-200px"
                                                    alt="" />
                                                <!--end::Food img-->
                                                <!--begin::Info-->
                                        ...
                                        <div class="card card-flush flex-row-fluid p-6 pb-5 mw-100">
                                            ...
                                            <div class="card-body text-center">
                                                <!--begin::Food img-->
                                                <img src="{{ \App\Support\ThemeAsset::url('media/stock/food/img-11.jpg', $theme_asset_pack ?? null) }}"
                                                    class="rounded-3 mb-4 w-150px h-150px w-xxl-200px h-xxl-200px"
                                                    alt="" />
                                                <!--end::Food img-->
                                                <!--begin::Info-->
...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/pages/general/pos.js', $theme_asset_pack ?? null) }}"></script>
