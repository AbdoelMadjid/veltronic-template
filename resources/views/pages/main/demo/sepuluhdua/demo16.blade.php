        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <div class="col-xl-4">
                    ...
                    <div class="row g-5 g-lg-10">
                        ...
                        <div class="col-lg-6 mb-lg-10">
                            ...
                            @include('partials.widgets-demo.tiles.__widget-5', ['variant' => 'a'])
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                    ...
                    <div class="row g-5 g-lg-10">
                        ...
                        <div class="col-lg-6 mb-lg-10">
                            ...
                            @include('partials.widgets-demo.tiles.__widget-1', ['variant' => 'a'])
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col-lg-6 mb-5 mb-lg-10">
                            <x-widget-include-badge name="tiles.__widget-5" />
                            @include('partials.widgets-demo.tiles.__widget-5', ['variant' => 'b'])
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Row-->
                    <x-widget-include-badge name="engage.__widget-4" />
                    @include('partials.widgets-demo.engage.__widget-4')
                </div>
                <!--end::Col-->
                <!--begin::Col-->
                <div class="col-xl-4 mb-xl-10">
                    <x-widget-include-badge name="engage.__widget-3" />
                    @include('partials.widgets-demo.engage.__widget-3')
                </div>
                <!--end::Col-->
            </div>
            <!--end::Row-->
            ...
            <div class="row g-5 g-lg-10">
                ...
                <div class="col-xxl-4 col-md-4 mb-5 mb-lg-10">
                    ...
                    @include('partials.widgets-demo.mixed.__widget-6')
                </div>
                <!--end::Col-->
                <!--begin::Col-->
                <div class="col-xxl-4 col-md-4 mb-5 mb-lg-10">
