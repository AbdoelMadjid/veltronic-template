        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="row g-5 g-xl-8">
                ...
                <div class="col-xl-4">
                    ...
                    @include('partials.widgets-demo.list.__widget-4', ['widgetClass' => 'card mb-xl-8'])
                </div>
                <!--end::Col-->
                <!--begin::Col-->
                <div class="col-xl-8 ps-xl-12">
                    ...
                    <div class="row g-5 g-xl-8">
                        ...
                        <div class="col-xl-6">
                            ...
                            @include('partials.widgets-demo.mixed.__widget-5', ['variant' => 'a'])
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col-xl-6">
                            <x-widget-include-badge name="list.__widget-3" />
                            @include('partials.widgets-demo.list.__widget-3', ['widgetClass' => 'card card-xl-stretch mb-5 mb-xl-8'])
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Row-->
                    ...
                    <div class="row g-5 g-xl-8">
                        ...
                        <div class="col-xl-6">
                            ...
                            @include('partials.widgets-demo.mixed.__widget-19', ['variant' => 'a'])
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col-xl-6">
                            <x-widget-include-badge name="mixed.__widget-12" />
                            @include('partials.widgets-demo.mixed.__widget-12')
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Row-->
