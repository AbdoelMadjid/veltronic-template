        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="row g-5 g-xxl-10">
                ...
                <div class="col-xxl-4 mb-xxl-10">
                    ...
                    @include('partials.widgets-demo.card.__widget-22')
                    <x-widget-include-badge name="card.__widget-23" />
                    @include('partials.widgets-demo.card.__widget-23')
                </div>
                <!--end::Col-->
                <!--begin::Col-->
                <div class="col-xxl-8 mb-5 mb-xl-10">
                    <x-widget-include-badge name="engage.__widget-14" />
                    @include('partials.widgets-demo.engage.__widget-14')
                    <x-widget-include-badge name="table.__widget-17" />
                    @include('partials.widgets-demo.table.__widget-17')
                </div>
                <!--end::Col-->
            </div>
            <!--end::Row-->
            <x-widget-include-badge name="engage.__widget-13" />
            @include('partials.widgets-demo.engage.__widget-13')
        </div>
        <!--end::Content-->
    </div>
    <!--end::Content wrapper-->
