            ...
            <div class="container-xxl" id="kt_content_container">
                ...
                <div class="row g-5 g-xl-8">
                    ...
                    <div class="col-xl-4">
                        ...
                        @include('partials.widgets-demo.mixed.__widget-5', ['variant' => 'd'])
                    </div>
                    <!--end::Col-->
                    <!--begin::Col-->
                    <div class="col-xl-8">
                        ...
                        <div class="row gx-5 gx-xl-8 mb-5 mb-xl-8">
                            <div class="col-xl-3 mb-5 mb-xl-0">
                                ...
                                @include('partials.widgets-demo.tiles.__widget-1', ['variant' => 'b'])
                            </div>
                            <div class="col-xl-9">
                                <x-widget-include-badge name="tiles.__widget-4" />
                                @include('partials.widgets-demo.tiles.__widget-4')
                            </div>
                        </div>
                        <!--end::Row-->
                        <!--begin::Row-->
                        <div class="row gx-5 gx-xl-8 mb-5 mb-xl-8">
                            ...
                            <div class="col-xl-6">
                                ...
                                @include('partials.widgets-demo.tiles.__widget-2', ['variant' => 'a'])
                            ...
                            <div class="col-xl-6">
                                ...
                                @include('partials.widgets-demo.mixed.__widget-3', [
                                    'vars' => [
                                        'card_class' =>
                                            'card h-100 bgi-no-repeat bgi-size-cover card-xl-stretch mb-5 mb-xl-8',
                                        'background_image_url' => 'assets/media/misc/bg-2.jpg',
                                        'link_href' => '#',
                                    ],
                                ])
                            </div>
                ...
                <div class="row gy-5 g-xl-8">
                    ...
                    <div class="col-xl-4">
                        ...
                        @include('partials.widgets-demo.mixed.__widget-2', [
                            'vars' => [
                                'card_class' => 'card card-xl-stretch',
                                'header_bg_class' => 'bg-danger',
                                'chart_bg_class' => 'bg-danger',
                                'chart_color' => 'danger',
                                'link_href' => '#',
                            ],
                        ])
                    ...
                    <div class="col-xl-4">
                        ...
                        @include('partials.widgets-demo.list.__widget-5b', [
                            'widgetClass' => 'card card-xl-stretch',
                        ])
                    </div>
                    <!--end::Col-->
                    <!--begin::Col-->
                    <div class="col-xl-4">
                        ...
                        @include('partials.widgets-demo.mixed.__widget-7')
                        <x-widget-include-badge name="mixed.__widget-10" />
                        @include('partials.widgets-demo.mixed.__widget-10')
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Row-->
                ...
                <div class="row gy-5 g-xl-8">
                    ...
                    <div class="col-xl-4">
                        ...
                        @include('partials.widgets-demo.list.__widget-3', [
                            'widgetClass' => 'card card-xl-stretch mb-xl-3',
                        ])
                    </div>
                    <!--end::Col-->
                    <!--begin::Col-->
                ...
                <div class="row gy-5 g-xl-8">
                    <div class="col-xl-6">
                        <x-widget-include-badge name="feed._widget-1" />
                        @include('partials.widgets-demo.feeds.__widget-1')
                    </div>
                    <div class="col-xl-6">
                        <x-widget-include-badge name="feed._widget-2" />
                        @include('partials.widgets-demo.feeds.__widget-2')
                    </div>
                </div>
            </div>
            <!--end::Post-->
