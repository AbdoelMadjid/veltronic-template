        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card mb-5 mb-xl-10">
                <div class="card-body pt-9 pb-0">
                    ...
                    <!--end::Details-->
                    <!--begin::Navs-->
                    @include('pages.pages.account.partials.navs', ['active' => 'activity'])
                    <!--end::Navs-->
                </div>
            </div>
            <!--end::Navbar-->
                                        ...
                                        <div class="overflow-auto pb-5">
                                            ...
                                            <div
                                                ...
                                                <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
                                                    <!--begin::User-->
                                                    <div class="symbol symbol-circle symbol-25px">
                                                        <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-20.jpg', $theme_asset_pack ?? null) }}" alt="img" />
                                                    </div>
                                                    <!--end::User-->
                                                    <!--begin::User-->
                                                    <div class="symbol symbol-circle symbol-25px">
                                        ...
                                        <div class="overflow-auto pb-5">
                                            <div
                                                ...
                                                <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                                    ...
                                                    <div class="ms-1 fw-semibold">
                                                        <!--begin::Desc-->
                                                        <a href="javascript:void(0)" class="fs-6 text-hover-primary fw-bold">Client
                                                ...
                                                <div class="d-flex flex-aligns-center">
                                                    ...
                                                    <div class="ms-1 fw-semibold">
                                                        <!--begin::Desc-->
                                                        <a href="javascript:void(0)" class="fs-6 text-hover-primary fw-bold">Finance
                                                            Reports</a>
                                                        <!--end::Desc-->
                                                        <!--begin::Number-->
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-content mb-10 mt-n1">
                                        ...
                                        <div class="pe-3 mb-5">
                                            ...
                                            <div class="fs-5 fw-semibold mb-2">
                                                Task
                                                <a href="javascript:void(0)" class="text-primary fw-bold me-1">#45890</a>merged with
                                                <a href="javascript:void(0)" class="text-primary fw-bold me-1">#45890</a>in “Ads Pro
                                                Admin Dashboard
                                                project:
                                            </div>
                                            <!--end::Title-->
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-content mb-10 mt-n1">
                                        ...
                                        <div class="pe-3 mb-5">
                                            ...
                                            <div class="fs-5 fw-semibold mb-2">
                                                New case
                                                <a href="javascript:void(0)" class="text-primary fw-bold me-1">#67890</a>is assigned
                                                to you in
                                                Multi-platform
                                            ...
                                            <div class="overflow-auto pb-5">
                                                ...
                                                <div class="d-flex align-items-center mt-1 fs-6">
                                                    ...
                                                    <!--end::Info-->
                                                    <!--begin::User-->
                                                    <a href="javascript:void(0)" class="text-primary fw-bold me-1">Alice Tan</a>
                                                    <!--end::User-->
                                                </div>
                                                <!--end::Wrapper-->
                                            </div>
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-content mt-n1">
                                        ...
                                        <div class="pe-3 mb-5">
                                            ...
                                            <div class="fs-5 fw-semibold mb-2">
                                                New order
                                                <a href="javascript:void(0)" class="text-primary fw-bold me-1">#67890</a>is placed
                                                for Workshow
                                                Planning & Budget
                                                Estimation
                                            </div>
