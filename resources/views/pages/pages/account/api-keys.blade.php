        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card mb-5 mb-xl-10">
                <div class="card-body pt-9 pb-0">
                    ...
                    <!--end::Details-->
                    <!--begin::Navs-->
                    @include('pages.pages.account.partials.navs', ['active' => 'api-keys'])
                    <!--end::Navs-->
                </div>
            </div>
            <!--end::Navbar-->
                ...
                <div class="card-body py-10">
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-6 pb-10 pb-lg-0">
                            ...
                            <a href="javascript:void(0)" class="btn btn-light btn-active-light-primary">Get Started</a>
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col-md-6">
                            ...
                            <a href="javascript:void(0)" class="btn btn-light btn-active-light-primary">Create Rule</a>
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Row-->
