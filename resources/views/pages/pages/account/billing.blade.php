        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card mb-5 mb-xl-10">
                <div class="card-body pt-9 pb-0">
                    ...
                    <!--end::Details-->
                    <!--begin::Navs-->
                    @include('pages.pages.account.partials.navs', ['active' => 'billing'])
                    <!--end::Navs-->
                </div>
            </div>
            <!--end::Navbar-->
                        ...
                        <div class="d-flex flex-stack flex-grow-1">
                            ...
                            <div class="fw-semibold">
                                ...
                                <div class="fs-6 text-gray-700">
                                    ...
                                    please
                                    <a href="javascript:void(0)" class="fw-bold" data-bs-toggle="modal"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="d-flex justify-content-end pb-0 px-0">
                                <a href="javascript:void(0)" class="btn btn-light btn-active-light-primary me-2"
                                    ...
                                    <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                                        ...
                                        <div class="mb-3 mb-md-0 fw-semibold">
                                            ...
                                            <div class="fs-6 text-gray-700 pe-7">
                                                ...
                                                <a href="javascript:void(0)" class="fw-bold me-1">Product Terms</a>adding <br />your
                                                new payment card
                                            </div>
                                        </div>
                                        <!--end::Content-->
                                        <!--begin::Action-->
                                        <a href="javascript:void(0)" class="btn btn-primary px-6 align-self-center text-nowrap"
                ...
                <div class="card-body">
                    ...
                    <div class="mt-10">
                        ...
                        <div class="fw-semibold text-gray-600 fs-6">
                            ...
                            <br />
                            <a class="fw-bold" href="javascript:void(0)">More Info</a>
                        </div>
                    </div>
                    <!--end::Tax info-->
                </div>
                            ...
                            <table class="table table-row-bordered align-middle gy-4 gs-9">
                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    ...
                                    <tr>
                                        <td>Nov 01, 2020</td>
                                        <td>
                                            <a href="javascript:void(0)">Invoice for Ocrober 2024</a>
                                        </td>
                                        <td>$123.79</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>Oct 08, 2020</td>
                                        <td>
                                            <a href="javascript:void(0)">Invoice for September 2024</a>
                                        </td>
                                        <td>$98.03</td>
                                        <td>
                                            <a href="javascript:void(0)"
                                    ...
                                    <tr>
                                        <td>Aug 01, 2020</td>
                                        <td>
                                            <a href="javascript:void(0)">Invoice for July 2024</a>
                                        </td>
                                        <td>$142.80</td>
                                        <td>
                                            <a href="javascript:void(0)"
                                    ...
                                    <tr>
                                        <td>Jul 01, 2020</td>
                                        <td>
                                            <a href="javascript:void(0)">Invoice for June 2024</a>
                                        </td>
                                        <td>$123.79</td>
                                        <td>
                                            <a href="javascript:void(0)"
                                    ...
                                    <tr>
                                        <td>Jun 01, 2020</td>
                                        <td>
                                            <a href="javascript:void(0)">Invoice for May 2024</a>
                                        </td>
                                        <td>$123.79</td>
                                        <td>
                                            <a href="javascript:void(0)"
                            ...
                            <table class="table table-row-bordered align-middle gy-4 gs-9">
                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    ...
                                    <tr>
                                        <td>Dec 01, 2021</td>
                                        <td>
                                            <a href="javascript:void(0)">Billing for Ocrober 2024</a>
                                        </td>
                                        <td>$250.79</td>
                                        <td>
                                            <a href="javascript:void(0)"
                                    ...
                                    <tr>
                                        <td>Oct 08, 2021</td>
                                        <td>
                                            <a href="javascript:void(0)">Statements for September 2024</a>
                                        </td>
                                        <td>$98.03</td>
                                        <td>
                                            <a href="javascript:void(0)"
                                    ...
                                    <tr>
                                        <td>Jul 01, 2021</td>
                                        <td>
                                            <a href="javascript:void(0)">Statements for June 2024</a>
                                        </td>
                                        <td>$123.79</td>
                                        <td>
                                            <a href="javascript:void(0)"
