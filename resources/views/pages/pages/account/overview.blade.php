        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card mb-5 mb-xl-10">
                <div class="card-body pt-9 pb-0">
                    ...
                    <!--end::Details-->
                    <!--begin::Navs-->
                    @include('pages.pages.account.partials.navs', ['active' => 'overview'])
                    <!--end::Navs-->
                </div>
            </div>
            <!--end::Navbar-->
            ...
            <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                ...
                <div class="card-body p-9">
                    ...
                    <div class="row mb-7">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8">
                            <a href="javascript:void(0)" class="fw-semibold fs-6 text-gray-800 text-hover-primary">keenthemes.com</a>
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Input group-->
                        ...
                        <div class="card-body d-flex flex-column flex-center">
                            ...
                            <div class="mb-2">
                                ...
                                <div class="py-10 text-center">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/illustrations/easy/1.svg', $theme_asset_pack ?? null) }}" class="theme-light-show w-200px"
                                        alt="" />
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/illustrations/easy/1-dark.svg', $theme_asset_pack ?? null) }}"
                            ...
                            <div class="hover-scroll-overlay-y pe-6 me-n6" style="height: 415px">
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="{{ \App\Support\ThemeAsset::url('media/stock/ecommerce/210.png', $theme_asset_pack ?? null) }}" class="w-50px ms-n1 me-1"
                                                alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="{{ \App\Support\ThemeAsset::url('media/stock/ecommerce/209.png', $theme_asset_pack ?? null) }}" class="w-50px ms-n1 me-1"
                                                alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <a href="/apps/ecommerce/catalog/edit-product"
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="{{ \App\Support\ThemeAsset::url('media/stock/ecommerce/214.png', $theme_asset_pack ?? null) }}" class="w-50px ms-n1 me-1"
                                                alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <a href="/apps/ecommerce/catalog/edit-product"
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="{{ \App\Support\ThemeAsset::url('media/stock/ecommerce/211.png', $theme_asset_pack ?? null) }}" class="w-50px ms-n1 me-1"
                                                alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <a href="/apps/ecommerce/catalog/edit-product"
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="{{ \App\Support\ThemeAsset::url('media/stock/ecommerce/215.png', $theme_asset_pack ?? null) }}" class="w-50px ms-n1 me-1"
                                                alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <a href="/apps/ecommerce/catalog/edit-product"
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="{{ \App\Support\ThemeAsset::url('media/stock/ecommerce/192.png', $theme_asset_pack ?? null) }}" class="w-50px ms-n1 me-1"
                                                alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <a href="/apps/ecommerce/catalog/edit-product"
