        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card mb-5 mb-xl-10">
                <div class="card-body pt-9 pb-0">
                    ...
                    <!--end::Details-->
                    <!--begin::Navs-->
                    @include('pages.pages.account.partials.navs', ['active' => 'referrals'])
                    <!--end::Navs-->
                </div>
            </div>
            <!--end::Navbar-->
                ...
                <div class="card-body py-10">
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-xl-6 mb-15 mb-xl-0 pe-5">
                            ...
                            <a href="javascript:void(0)" class="btn btn-light btn-active-light-primary fw-bold">Get Started</a>
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col-xl-6">
                    ...
                    <div class="notice d-flex bg-light-primary rounded border-primary border border-dashed p-6">
                        ...
                        <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                            ...
                            <!--end::Content-->
                            <!--begin::Action-->
                            <a href="javascript:void(0)" class="btn btn-primary px-6 align-self-center text-nowrap">Withdraw
                                Money</a>
                            <!--end::Action-->
                        </div>
                        <!--end::Wrapper-->
                            ...
                            <table class="table table-row-bordered align-middle gy-6">
                                ...
                                <tbody class="fs-6 fw-semibold text-gray-600">
                                    <tr>
                                        ...
                                        <td class="ps-0">
                                            <a href="javascript:void(0)" class="text-gray-600 text-hover-primary">Marcus Harris</a>
                                        </td>
                                        <td>Nov 24, 2020</td>
                                        <td>26%</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="ps-0">
                                            <a href="javascript:void(0)" class="text-gray-600 text-hover-primary">Maria Garcia</a>
                                        </td>
                                        <td>Aug 10, 2020</td>
                                        <td>35%</td>
                                    ...
                                    <tr>
                                        <td class="ps-9">678935899</td>
                                        <td class="ps-0">
                                            <a href="javascript:void(0)" class="text-gray-600 text-hover-primary">Robert Smith</a>
                                        </td>
                                        <td>May 06, 2020</td>
                                        <td>18%</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="ps-0">
                                            <a href="javascript:void(0)" class="text-gray-600 text-hover-primary">Williams Brown</a>
                                        </td>
                                        <td>Apr 30, 2020</td>
                                        <td>43%</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="ps-0">
                                            <a href="javascript:void(0)" class="text-gray-600 text-hover-primary">Paul Johnson</a>
                                        </td>
                                        <td>Feb 29, 2020</td>
                                        <td>21%</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="ps-0">
                                            <a href="javascript:void(0)" class="text-gray-600 text-hover-primary">Sarah Jones</a>
                                        </td>
                                        <td>Jan 08, 2020</td>
                                        <td>47%</td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="ps-0">
                                            <a href="javascript:void(0)" class="text-gray-600 text-hover-primary">Juan Carlos</a>
                                        </td>
                                        <td>Jan 02, 2020</td>
                                        <td>35%</td>
