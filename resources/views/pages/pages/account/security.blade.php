        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card mb-5 mb-xl-10">
                <div class="card-body pt-9 pb-0">
                    ...
                    <!--end::Details-->
                    <!--begin::Navs-->
                    @include('pages.pages.account.partials.navs', ['active' => 'security'])
                    <!--end::Navs-->
                </div>
            </div>
            <!--end::Navbar-->
                                ...
                                <div class="carousel-inner pt-6">
                                        ...
                                        <div class="carousel-wrapper">
                                            ...
                                            <div class="d-flex flex-stack pt-8">
                                                <span class="badge badge-light-primary fs-7 fw-bold me-2">Jun 10,
                                                    2021</span>
                                                <a href="javascript:void(0)" class="btn btn-sm btn-light">Learn More</a>
                                            </div>
                                            <!--end::Summary-->
                                        </div>
                                        <!--end::Wrapper-->
                                    ...
                                    <div class="carousel-item">
                                        ...
                                        <div class="carousel-wrapper">
                                            <!--begin::Description-->
                                            <div class="d-flex flex-column flex-grow-1">
                                                <a href="javascript:void(0)" class="fw-bold text-gray-900 text-hover-primary">Login
                                                    Attempt Failed</a>
                                                <p class="text-gray-600 fs-6 fw-semibold pt-3 mb-0">
                                    ...
                                    <div class="carousel-item">
                                        ...
                                        <div class="carousel-wrapper">
                                            <!--begin::Description-->
                                            <div class="d-flex flex-column flex-grow-1">
                                                <a href="javascript:void(0)" class="fw-bold text-gray-900 text-hover-primary">Top
                                                    Picks For You</a>
                                                <p class="text-gray-600 fs-6 fw-semibold pt-3 mb-0">
                                ...
                                <div class="carousel-inner pt-6">
                                        ...
                                        <div class="carousel-wrapper">
                                            ...
                                            <div class="d-flex flex-stack pt-8">
                                                <span class="text-muted fw-semibold fs-6 pe-2">34, Soho Avenue,
                                                    Tokio</span>
                                                <a href="javascript:void(0)" class="btn btn-sm btn-light">Register</a>
                                            </div>
                                            <!--end::Summary-->
                                        </div>
                                        <!--end::Wrapper-->
                                    ...
                                    <div class="carousel-item">
                                        ...
                                        <div class="carousel-wrapper">
                                            <!--begin::Description-->
                                            <div class="d-flex flex-column flex-grow-1">
                                                <a href="javascript:void(0)" class="fw-bold text-gray-900 text-hover-primary">Terms
                                                    Of Use Document</a>
                                                <p class="text-gray-600 fs-6 fw-semibold pt-3 mb-0">
                                                    Today we are excited to share an amazing
                                                    certification opportunity which is
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        ...
                        <a href="javascript:void(0)" class="btn btn-sm btn-primary my-1">Download Report</a>
                    </div>
                    <!--end::Toolbar-->
                </div>
                <!--end::Card header-->
                        ...
                        <table class="table align-middle table-row-bordered table-row-solid gy-4"
                            ...
                            <tbody class="fw-6 fw-semibold text-gray-600">
                                <tr>
                                    ...
                                    <td class="ps-0">
                                        <a href="javascript:void(0)" class="text-hover-primary text-gray-600">DSI: Workstation 2</a>
                                    </td>
                                    <td>236.125.56.78</td>
                                    <td>2 mins ago</td>
                                ...
                                <tr>
                                    ...
                                    <td class="ps-0">
                                        <a href="javascript:void(0)" class="text-hover-primary text-gray-600">ReXe: Workstation
                                            29</a>
                                    </td>
                                    <td>236.125.56.78</td>
                                    <td>3 mins ago</td>
                                ...
                                <tr>
                                    ...
                                    <td class="ps-0">
                                        <a href="javascript:void(0)" class="text-hover-primary text-gray-600">RamenLC: Workstation
                                            2</a>
                                    </td>
                                    <td>654.125.56.34</td>
                                    <td>5 mins ago</td>
                                ...
                                <tr>
                                    ...
                                    <td class="ps-0">
                                        <a href="javascript:void(0)" class="text-hover-primary text-gray-600">Nest Five: Workstation
                                            86</a>
                                    </td>
                                    <td>423.125.56.54</td>
                                    <td>1 mins ago</td>
                                ...
                                <tr>
                                    ...
                                    <td class="ps-0">
                                        <a href="javascript:void(0)" class="text-hover-primary text-gray-600">ReXe: Workstation 7</a>
                                    </td>
                                    <td>745.234.56.21</td>
                                    <td>3 mins ago</td>
                                    <td data-bs-target="license">
                                ...
                                <tr>
                                    ...
                                    <td class="ps-0">
                                        <a href="javascript:void(0)" class="text-hover-primary text-gray-600">Swedline: Workstation
                                            54</a>
                                    </td>
                                    <td>441.967.56.54</td>
                                    <td>8 mins ago</td>
