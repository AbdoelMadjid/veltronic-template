        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card mb-5 mb-xl-10">
                <div class="card-body pt-9 pb-0">
                    ...
                    <!--end::Details-->
                    <!--begin::Navs-->
                    @include('pages.pages.account.partials.navs', ['active' => 'statements'])
                    <!--end::Navs-->
                </div>
            </div>
            <!--end::Navbar-->
                    ...
                    <div class="card card-xxl-stretch mb-5 mb-xxl-10">
                        ...
                        <div class="card-body pb-0">
                            ...
                            <div class="d-flex flex-wrap justify-content-between pb-6">
                                ...
                                <!--end::Row-->
                                <a href="javascript:void(0)" class="btn btn-primary px-6 flex-shrink-0 align-self-center">Withdraw
                                    Earnings</a>
                            </div>
                            <!--end::Left Section-->
                        </div>
