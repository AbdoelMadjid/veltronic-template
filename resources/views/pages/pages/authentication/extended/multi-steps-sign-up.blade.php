                ...
                <div class="d-flex flex-column position-lg-fixed top-0 bottom-0 w-lg-350px w-xl-500px scroll-y bgi-size-cover bgi-position-center"
                    ...
                    <div class="d-flex flex-center py-10 py-lg-20 mt-lg-20">
                        ...
                        <a href="/dashboard" class="mb-5">
                            <img alt="Logo" src="{{ \App\Support\ThemeAsset::url('media/logos/custom-1.png', $theme_asset_pack ?? null) }}" class="h-70px" />
                        </a>
                        <!--end::Logo-->
                    </div>
                    <!--end::Header-->
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="pb-10 pb-lg-15">
                                        ...
                                        <div class="text-muted fw-semibold fs-6">
                                            ...
                                            <a href="javascript:void(0)" class="link-primary fw-bold">Help Page</a>.
                                        </div>
                                        <!--end::Notice-->
                                    </div>
                                    <!--end::Heading-->
                            ...
                            <div class="" data-kt-stepper-element="content">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="pb-10 pb-lg-15">
                                        ...
                                        <div class="text-muted fw-semibold fs-6">
                                            If you need more info, please check out
                                            <a href="javascript:void(0)" class="text-primary fw-bold">Help Page</a>.
                                        </div>
                                        <!--end::Notice-->
                                    </div>
                                    <!--end::Heading-->
