...
@section('content')
    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <style>
            body {
                background-image: url('{{ \App\Support\ThemeAsset::url('media/auth/bg9.jpg', $theme_asset_pack ?? null) }}');
            }

            [data-bs-theme="dark"] body {
                background-image: url('{{ \App\Support\ThemeAsset::url('media/auth/bg9-dark.jpg', $theme_asset_pack ?? null) }}');
            }
        </style>
        <!--end::Page bg image-->
            ...
            <div class="d-flex flex-column flex-center text-center p-10">
                ...
                <div class="card card-flush w-lg-650px py-5">
                    <div class="card-body py-15 py-lg-20">
                        ...
                        <!--begin::Illustration-->
                        <div class="mb-n5">
                            <img src="{{ \App\Support\ThemeAsset::url('media/auth/chart-graph.png', $theme_asset_pack ?? null) }}" class="mw-100 mh-300px theme-light-show"
                                alt="" />
                            <img src="{{ \App\Support\ThemeAsset::url('media/auth/chart-graph-dark.png', $theme_asset_pack ?? null) }}" class="mw-100 mh-300px theme-dark-show"
                                alt="" />
                        </div>
                        <!--end::Illustration-->
                    </div>
...
@section('script')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/authentication/sign-up/coming-soon.js', $theme_asset_pack ?? null) }}"></script>
