                        ...
                        <form class="form w-100 mb-10" novalidate="novalidate" data-kt-redirect-url="index"
                            ...
                            <div class="text-center mb-10">
                                <img alt="Logo" class="theme-light-show mh-125px"
                                    src="{{ \App\Support\ThemeAsset::url('media/svg/misc/smartphone-2.svg', $theme_asset_pack ?? null) }}" />
                                <img alt="Logo" class="theme-dark-show mh-125px"
                                    src="{{ \App\Support\ThemeAsset::url('media/svg/misc/smartphone-2-dark.svg', $theme_asset_pack ?? null) }}" />
                            </div>
                            <!--end::Icon-->
                            <!--begin::Heading-->
                            <div class="text-center mb-10">
...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/authentication/sign-in/two-factor.js', $theme_asset_pack ?? null) }}"></script>
