                        ...
                        <div class="row g-10">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card-xl-stretch mx-md-3">
                                    <!--begin::Image-->
                                    <a class="d-block bgi-no-repeat bgi-size-cover bgi-position-center card-rounded position-relative min-h-175px mb-5"style="background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/600x400/img-74.jpg', $theme_asset_pack ?? null) }}');"
                                        data-fslightbox="lightbox-video-tutorials"
                                        href="https://www.youtube.com/embed/btornGtLwIo">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/svg/misc/video-play.svg', $theme_asset_pack ?? null) }}"
                                            class="position-absolute top-50 start-50 translate-middle" alt="" />
