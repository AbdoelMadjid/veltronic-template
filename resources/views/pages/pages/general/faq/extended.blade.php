                            ...
                            <div class="mb-15">
                                ...
                                <div
                                    ...
                                    <div class="menu-item mb-1">
                                        <!--begin::Link-->
                                        <a href="javascript:void(0)" class="menu-link py-3 active">Bootstrap Admin</a>
                                        <!--end::Link-->
                                    </div>
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <div class="menu-item mb-1">
                                        <!--begin::Link-->
                                        <a href="javascript:void(0)" class="menu-link py-3">Laravel App</a>
                                        <!--end::Link-->
                                    </div>
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <div class="menu-item mb-1">
                                        <!--begin::Link-->
                                        <a href="javascript:void(0)" class="menu-link py-3">Angular Dashbaord</a>
                                        <!--end::Link-->
                                    </div>
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <div class="menu-item mb-1">
                                        <!--begin::Link-->
                                        <a href="javascript:void(0)" class="menu-link py-3">VueJs Dashbaord</a>
                                        <!--end::Link-->
                                    </div>
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <div class="menu-item mb-1">
                                        <!--begin::Link-->
                                        <a href="javascript:void(0)" class="menu-link py-3">React Admin</a>
                                        <!--end::Link-->
                                    </div>
                                    <!--end::Item-->
                                    <!--begin::Item-->
                                    <div class="menu-item">
                                        <!--begin::Link-->
                                        <a href="javascript:void(0)" class="menu-link py-3">Bootstrap Theme</a>
                                        <!--end::Link-->
                                    </div>
                                    <!--end::Item-->
                                </div>
                    ...
                    <div class="card mb-4 bg-light text-center">
                        ...
                        <div class="card-body py-12">
                            ...
                            <a href="javascript:void(0)" class="mx-4">
                                <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/facebook-4.svg', $theme_asset_pack ?? null) }}" class="h-30px my-2"
                                    alt="" />
                            </a>
                            <!--end::Icon-->
                            <!--begin::Icon-->
