                                                ...
                                                <div class="pe-3 mb-5">
                                                    ...
                                                    <div class="d-flex align-items-center mt-1 fs-6">
                                                        ...
                                                        <div class="symbol symbol-circle symbol-25px"
                                                            ...
                                                            <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-14.jpg', $theme_asset_pack ?? null) }}" alt="img" />
                                                        </div>
                                                        <!--end::User-->
                                                    </div>
                                                    <!--end::Description-->
                                                ...
                                                <div class="overflow-auto pb-5">
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <!--begin::User-->
                                                            <div class="symbol symbol-circle symbol-25px">
                                                                <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-20.jpg', $theme_asset_pack ?? null) }}"
                                                                    alt="img" />
                                                            </div>
                                                            <!--end::User-->
                                                            <!--begin::User-->
                                                ...
                                                <div class="overflow-auto pe-3">
                                                    ...
                                                    <div class="d-flex align-items-center mt-1 fs-6">
                                                        ...
                                                        <div class="symbol symbol-circle symbol-25px"
                                                            ...
                                                            <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-1.jpg', $theme_asset_pack ?? null) }}" alt="img" />
                                                        </div>
                                                        <!--end::User-->
                                                    </div>
                                                    <!--end::Description-->
                                                ...
                                                <div class="mb-5 pe-3">
                                                    ...
                                                    <div class="d-flex align-items-center mt-1 fs-6">
                                                        ...
                                                        <div class="symbol symbol-circle symbol-25px"
                                                            ...
                                                            <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-23.jpg', $theme_asset_pack ?? null) }}" alt="img" />
                                                        </div>
                                                        <!--end::User-->
                                                    </div>
                                                    <!--end::Description-->
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                                            ...
                                                            <img alt="" class="w-30px me-3"
                                                                src="{{ \App\Support\ThemeAsset::url('media/svg/files/pdf.svg', $theme_asset_pack ?? null) }}" />
                                                            <!--end::Icon-->
                                                            <!--begin::Info-->
                                                        ...
                                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                                            ...
                                                            <img alt="/apps/projects/project" class="w-30px me-3"
                                                                src="{{ \App\Support\ThemeAsset::url('media/svg/files/doc.svg', $theme_asset_pack ?? null) }}" />
                                                            <!--end::Icon-->
                                                            <!--begin::Info-->
                                                            <div class="ms-1 fw-semibold">
                                                                <!--begin::Desc-->
                                                        ...
                                                        <div class="d-flex flex-aligns-center">
                                                            <!--begin::Icon-->
                                                            <img alt="/apps/projects/project" class="w-30px me-3"
                                                                src="{{ \App\Support\ThemeAsset::url('media/svg/files/css.svg', $theme_asset_pack ?? null) }}" />
                                                            <!--end::Icon-->
                                                            <!--begin::Info-->
                                                            <div class="ms-1 fw-semibold">
                                                                <!--begin::Desc-->
                                            ...
                                            <div class="timeline-content mb-10 mt-n1">
                                                ...
                                                <div class="pe-3 mb-5">
                                                    ...
                                                    <div class="fs-5 fw-semibold mb-2">
                                                        ...
                                                        <a href="javascript:void(0)" class="text-primary fw-bold me-1">#45890</a>in
                                                        “Ads Pro Admin
                                                        Dashboard project:
                                                    </div>
                                                    <!--end::Title-->
                                                ...
                                                <div class="pe-3 mb-5">
                                                    ...
                                                    <div class="d-flex align-items-center mt-1 fs-6">
                                                        ...
                                                        <div class="symbol symbol-circle symbol-25px"
                                                            ...
                                                            <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-2.jpg', $theme_asset_pack ?? null) }}" alt="img" />
                                                        </div>
                                                        <!--end::User-->
                                                    </div>
                                                    <!--end::Description-->
                                                ...
                                                <div class="overflow-auto pb-5">
                                                    <div
                                                        ...
                                                        <div class="overlay me-10">
                                                            ...
                                                            <div class="overlay-wrapper">
                                                                <img alt="img" class="rounded w-150px"
                                                                    src="{{ \App\Support\ThemeAsset::url('media/stock/600x400/img-29.jpg', $theme_asset_pack ?? null) }}" />
                                                            </div>
                                                            <!--end::Image-->
                                                            <!--begin::Link-->
                                                        ...
                                                        <div class="overlay me-10">
                                                            ...
                                                            <div class="overlay-wrapper">
                                                                <img alt="img" class="rounded w-150px"
                                                                    src="{{ \App\Support\ThemeAsset::url('media/stock/600x400/img-31.jpg', $theme_asset_pack ?? null) }}" />
                                                            </div>
                                                            <!--end::Image-->
                                                            <!--begin::Link-->
                                                            <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                                                        ...
                                                        <div class="overlay">
                                                            ...
                                                            <div class="overlay-wrapper">
                                                                <img alt="img" class="rounded w-150px"
                                                                    src="{{ \App\Support\ThemeAsset::url('media/stock/600x400/img-40.jpg', $theme_asset_pack ?? null) }}" />
                                                            </div>
                                                            <!--end::Image-->
                                                            <!--begin::Link-->
                                                            <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                                        ...
                                        <div class="timeline-item">
                                            ...
                                            <div class="timeline-content mb-10 mt-n1">
                                                ...
                                                <div class="pe-3 mb-5">
                                                    ...
                                                    <div class="fs-5 fw-semibold mb-2">
                                                        New case
                                                        <a href="javascript:void(0)" class="text-primary fw-bold me-1">#67890</a>is
                                                        assigned to you in
                                                        Multi-platform
                                                    ...
                                                    <div class="overflow-auto pb-5">
                                                        ...
                                                        <div class="d-flex align-items-center mt-1 fs-6">
                                                            ...
                                                            <!--end::Info-->
                                                            <!--begin::User-->
                                                            <a href="javascript:void(0)" class="text-primary fw-bold me-1">Alice
                                                                Tan</a>
                                                            <!--end::User-->
                                                        </div>
                                                        <!--end::Wrapper-->
                                                ...
                                                <div class="pe-3 mb-5">
                                                    ...
                                                    <div class="d-flex align-items-center mt-1 fs-6">
                                                        ...
                                                        <div class="symbol symbol-circle symbol-25px"
                                                            ...
                                                            <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-4.jpg', $theme_asset_pack ?? null) }}" alt="img" />
                                                        </div>
                                                        <!--end::User-->
                                                    </div>
                                                    <!--end::Description-->
                                            ...
                                            <div class="timeline-content mt-n1">
                                                ...
                                                <div class="pe-3 mb-5">
                                                    ...
                                                    <div class="d-flex align-items-center mt-1 fs-6">
                                                        ...
                                                        <!--end::Info-->
                                                        <!--begin::User-->
                                                        <a href="javascript:void(0)" class="text-primary fw-bold me-1">Jimmy Bold</a>
                                                        <!--end::User-->
                                                    </div>
                                                    <!--end::Description-->
                                                </div>
                                            ...
                                            <div class="timeline-content mt-n1">
                                                ...
                                                <div class="pe-3 mb-5">
                                                    ...
                                                    <div class="d-flex align-items-center mt-1 fs-6">
                                                        ...
                                                        <!--end::Info-->
                                                        <!--begin::User-->
                                                        <a href="javascript:void(0)" class="text-primary fw-bold me-1">Jimmy
                                                            Bold</a>
                                                        <!--end::User-->
                                                    </div>
                                                    <!--end::Description-->
