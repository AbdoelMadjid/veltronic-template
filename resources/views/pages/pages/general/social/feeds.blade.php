            ...
            <div class="d-flex flex-row">
                        ...
                        <div class="card-body pt-15 px-0">
                            ...
                            <div class="d-flex flex-column text-center mb-9 px-9">
                                ...
                                <div class="symbol symbol-80px symbol-lg-150px mb-4">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-3.jpg', $theme_asset_pack ?? null) }}" class="" alt="" />
                                </div>
                                <!--end::Photo-->
                                <!--begin::Info-->
                            ...
                            <div class="timeline-label">
                                ...
                                <div class="timeline-item">
                                    ...
                                    <div class="timeline-content fw-bold text-gray-800 ps-3">
                                        Make deposit
                                        <a href="javascript:void(0)" class="text-primary">USD 700</a>. to
                                        ESL
                                    </div>
                                    <!--end::Desc-->
                                </div>
                ...
                <div class="w-100 flex-lg-row-fluid mx-lg-13">
                        ...
                        <div class="card card-flush mb-10">
                            ...
                            <div class="card-header pt-9">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-50px me-5">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-4.jpg', $theme_asset_pack ?? null) }}" class="" alt="" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Info-->
                                    <div class="flex-grow-1">
                                        <!--begin::Name-->
                                        <a href="javascript:void(0)" class="text-gray-800 text-hover-primary fs-4 fw-bold">Grace
                                            Logan</a>
                                        <!--end::Name-->
                                        <!--begin::Date-->
                                ...
                                <div class="row g-7 h-250px h-md-375px">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <a class="d-block card-rounded overlay h-100" data-fslightbox="lightbox-projects"
                                            href="{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-23.jpg', $theme_asset_pack ?? null) }}">
                                            <!--begin::Image-->
                                            <div
                                                class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-100"style="background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-23.jpg', $theme_asset_pack ?? null) }}');">
                                            </div>
                                            <!--end::Image-->
                                            <!--begin::Action-->
                                        ...
                                        <div class="row g-7 h-250px h-md-375px">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <a class="d-block card-rounded overlay h-100"
                                                    ...
                                                    href="{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-22.jpg', $theme_asset_pack ?? null) }}">
                                                    <!--begin::Image-->
                                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-100"
                                                        style="background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/600x400/img-71.jpg', $theme_asset_pack ?? null) }}');">
                                                    </div>
                                                    <!--end::Image-->
                                                    <!--begin::Action-->
                                                    <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <a class="d-block card-rounded overlay h-100"
                                                    data-fslightbox="lightbox-projects"
                                                    href="{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-21.jpg', $theme_asset_pack ?? null) }}">
                                                    <!--begin::Image-->
                                                    <div
                                                        class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded h-100"style="background-image: url('{{ \App\Support\ThemeAsset::url('media/stock/600x400/img-79.jpg', $theme_asset_pack ?? null) }}');">
                                                    </div>
                                                    <!--end::Image-->
                                                    <!--begin::Action-->
                                                    <div class="overlay-layer card-rounded bg-dark bg-opacity-25">
                            ...
                            <div class="card-footer pt-0">
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="collapse show" id="kt_social_feeds_comments_1">
                                        ...
                                        <div class="d-flex pt-6">
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-45px me-5">
                                                <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-13.jpg', $theme_asset_pack ?? null) }}" alt="" />
                                            </div>
                                            <!--end::Avatar-->
                                            <!--begin::Wrapper-->
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Author-->
                                    <div class="symbol symbol-35px me-3">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-3.jpg', $theme_asset_pack ?? null) }}" alt="" />
                                    </div>
                                    <!--end::Author-->
                                    <!--begin::Input group-->
                        ...
                        <div class="card card-flush mb-10">
                            ...
                            <div class="card-header pt-9">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-50px me-5">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-7.jpg', $theme_asset_pack ?? null) }}" class="" alt="" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Info-->
                                    <div class="flex-grow-1">
                                        <!--begin::Name-->
                                        <a href="javascript:void(0)" class="text-gray-800 text-hover-primary fs-4 fw-bold">Brooklyn
                                            Simmons</a>
                                        <!--end::Name-->
                                        <!--begin::Date-->
                                        <span class="text-gray-500 fw-semibold d-block">Yestarday at 5:06 PM</span>
                        ...
                        <div class="card card-flush mb-10">
                            ...
                            <div class="card-header pt-9">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <!--begin::Name-->
                                        <a href="javascript:void(0)" class="text-gray-800 text-hover-primary fs-4 fw-bold">Finance
                                            Deprt - Annual
                                            Report</a>
                                        <!--end::Name-->
                                        <!--begin::Date-->
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="collapse" id="kt_social_feeds_comments_3">
                                        ...
                                        <div class="d-flex pt-6">
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-45px me-5">
                                                <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-6.jpg', $theme_asset_pack ?? null) }}" alt="" />
                                            </div>
                                            <!--end::Avatar-->
                                            <!--begin::Wrapper-->
                                            <div class="d-flex flex-column flex-row-fluid">
                        ...
                        <div class="card card-flush mb-10">
                            ...
                            <div class="card-header pt-9">
                                ...
                                <div class="d-flex align-items-center">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-50px me-5">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-10.jpg', $theme_asset_pack ?? null) }}" class="" alt="" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Info-->
                                    <div class="flex-grow-1">
                                        <!--begin::Name-->
                                        <a href="javascript:void(0)" class="text-gray-800 text-hover-primary fs-4 fw-bold">Ana
                                            Lee</a>
                                        <!--end::Name-->
                                        <!--begin::Date-->
                                        <span class="text-gray-500 fw-semibold d-block">Yestarday at 5:06 PM</span>
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="collapse" id="kt_social_feeds_comments_4">
                                        ...
                                        <div class="d-flex pt-6">
                                            <!--begin::Avatar-->
                                            <div class="symbol symbol-45px me-5">
                                                <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-25.jpg', $theme_asset_pack ?? null) }}" alt="" />
                                            </div>
                                            <!--end::Avatar-->
                                            <!--begin::Wrapper-->
                                            <div class="d-flex flex-column flex-row-fluid">
                            ...
                            <div class="card card-flush mb-10">
                                ...
                                <div class="card-header pt-9">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-50px me-5">
                                            <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-11.jpg', $theme_asset_pack ?? null) }}" class="" alt="" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Info-->
                                        <div class="flex-grow-1">
                                            <!--begin::Name-->
                                            <a href="javascript:void(0)" class="text-gray-800 text-hover-primary fs-4 fw-bold">Stive
                                                Strong</a>
                                            <!--end::Name-->
                                            <!--begin::Date-->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row g-3 g-lg-6">
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <!--begin::Img-->
                                            <a href="javascript:void(0)">
                                                <img src="{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-14.jpg', $theme_asset_pack ?? null) }}" class="rounded w-100"
                                                    alt="" />
                                            </a>
                                            <!--end::Img-->
                                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <!--begin::Img-->
                                            <a href="javascript:void(0)">
                                                <img src="{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-10.jpg', $theme_asset_pack ?? null) }}" class="rounded w-100"
                                                    alt="" />
                                            </a>
                                            <!--end::Img-->
                                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <!--begin::Img-->
                                            <a href="javascript:void(0)">
                                                <img src="{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-18.jpg', $theme_asset_pack ?? null) }}" class="rounded w-100"
                                                    alt="" />
                                            </a>
                                            <!--end::Img-->
                                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <!--begin::Img-->
                                            <a href="javascript:void(0)">
                                                <img src="{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-30.jpg', $theme_asset_pack ?? null) }}" class="rounded w-100"
                                                    alt="" />
                                            </a>
                                            <!--end::Img-->
                                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <!--begin::Img-->
                                            <a href="javascript:void(0)">
                                                <img src="{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-31.jpg', $theme_asset_pack ?? null) }}" class="rounded w-100"
                                                    alt="" />
                                            </a>
                                            <!--end::Img-->
                                        </div>
                            ...
                            <div class="card card-flush mb-10">
                                ...
                                <div class="card-header pt-9">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <!--begin::Avatar-->
                                        <div class="symbol symbol-50px me-5">
                                            <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-12.jpg', $theme_asset_pack ?? null) }}" class=""
                                                alt="" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Info-->
                                        <div class="flex-grow-1">
                                            <!--begin::Name-->
                                            <a href="javascript:void(0)" class="text-gray-800 text-hover-primary fs-4 fw-bold">Lara
                                                Nilson</a>
                                            <!--end::Name-->
                                            <!--begin::Date-->
                        ...
                        <div class="card card-flush mb-10">
                            ...
                            <div class="card-header pt-9">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <!--begin::Name-->
                                        <a href="javascript:void(0)" class="text-gray-800 text-hover-primary fs-4 fw-bold">Jerry
                                            Kane</a>
                                        <!--end::Name-->
                                        <!--begin::Date-->
                                        <span class="text-gray-500 fw-semibold d-block">Yestarday at 5:06 PM</span>
                    ...
                    <div class="d-flex flex-center">
                        <a href="javascript:void(0)" class="btn btn-primary fw-bold px-6" id="kt_social_feeds_more_posts_btn">
                            <!--begin::Indicator label-->
                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="symbol symbol-40px me-5">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-11.jpg', $theme_asset_pack ?? null) }}" class="h-50 align-self-center"
                                        alt="" />
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Section-->
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Symbol-->
                                <div class="symbol symbol-40px me-5">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-2.jpg', $theme_asset_pack ?? null) }}" class="h-50 align-self-center"
                                        alt="" />
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Section-->
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Symbol-->
                                <div class="symbol symbol-40px me-5">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-7.jpg', $theme_asset_pack ?? null) }}" class="h-50 align-self-center"
                                        alt="" />
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Section-->
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Symbol-->
                                <div class="symbol symbol-40px me-5">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-9.jpg', $theme_asset_pack ?? null) }}" class="h-50 align-self-center"
                                        alt="" />
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Section-->
                            ...
                            <div class="d-flex flex-stack">
                                <!--begin::Symbol-->
                                <div class="symbol symbol-40px me-5">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-12.jpg', $theme_asset_pack ?? null) }}" class="h-50 align-self-center"
                                        alt="" />
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Section-->
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-3 g-lg-6">
                                ...
                                <div class="col-md-6">
                                    <!--begin::Img-->
                                    <a href="javascript:void(0)">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-33.jpg', $theme_asset_pack ?? null) }}" class="rounded w-100"
                                            alt="" />
                                    </a>
                                    <!--end::Img-->
                                </div>
                                ...
                                <div class="col-md-6">
                                    <!--begin::Img-->
                                    <a href="javascript:void(0)">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-26.jpg', $theme_asset_pack ?? null) }}" class="rounded w-100"
                                            alt="" />
                                    </a>
                                    <!--end::Img-->
                                </div>
                                ...
                                <div class="col-md-6">
                                    <!--begin::Img-->
                                    <a href="javascript:void(0)">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-25.jpg', $theme_asset_pack ?? null) }}" class="rounded w-100"
                                            alt="" />
                                    </a>
                                    <!--end::Img-->
                                </div>
                                ...
                                <div class="col-md-6">
                                    <!--begin::Img-->
                                    <a href="javascript:void(0)">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-35.jpg', $theme_asset_pack ?? null) }}" class="rounded w-100"
                                            alt="" />
                                    </a>
                                    <!--end::Img-->
                                </div>
...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/pages/social/feeds.js', $theme_asset_pack ?? null) }}"></script>
