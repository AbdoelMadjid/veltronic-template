        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card mb-6">
                <div class="card-body pt-9 pb-0">
                    ...
                    <!--end::Details-->
                    <!--begin::Navs-->
                    @include('pages.pages.general.user-profile.partials.navs', ['active' => 'activity'])
                    <!--end::Navs-->
                </div>
            </div>
            <!--end::Navbar-->
                                    ...
                                    <div class="timeline-content mb-10 mt-n1">
                                        ...
                                        <div class="overflow-auto pb-5">
                                            <div
                                                ...
                                                <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                                    <!--begin::Icon-->
                                                    <img alt="apps/projects/view" class="w-30px me-3"
                                    ...
                                    <div class="timeline-content mb-10 mt-n1">
                                        ...
                                        <div class="pe-3 mb-5">
                                            ...
                                            <div class="fs-5 fw-semibold mb-2">
                                                ...
                                                <a href="javascript:void(0)"
                                                    class="text-primary fw-bold me-1">#45890</a>in “Ads Pro
                                                Admin Dashboard
                                                project:
                                            </div>
                                            <!--end::Title-->
                                    ...
                                    <div class="timeline-content mb-10 mt-n1">
                                        ...
                                        <div class="pe-3 mb-5">
                                            ...
                                            <div class="fs-5 fw-semibold mb-2">
                                                New case
                                                <a href="javascript:void(0)"
                                                    class="text-primary fw-bold me-1">#67890</a>is assigned
                                                to you in
                                                Multi-platform
                                    ...
                                    <div class="timeline-content mt-n1">
                                        ...
                                        <div class="pe-3 mb-5">
                                            ...
                                            <div class="fs-5 fw-semibold mb-2">
                                                New order
                                                <a href="javascript:void(0)"
                                                    class="text-primary fw-bold me-1">#67890</a>is placed
                                                for Workshow
                                                Planning & Budget
                                                Estimation
                                            </div>
...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/pages/user-profile/general.js', $theme_asset_pack ?? null) }}">
    </script>
