        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card mb-6">
                <div class="card-body pt-9 pb-0">
                    ...
                    <!--end::Details-->
                    <!--begin::Navs-->
                    @include('pages.pages.general.user-profile.partials.navs', ['active' => 'campaigns'])
                    <!--end::Navs-->
                </div>
            </div>
            <!--end::Navbar-->
                        ...
                        <div class="card-header flex-nowrap border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                ...
                                <div class="symbol symbol-45px w-45px bg-light me-5">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/twitch.svg', $theme_asset_pack ?? null) }}" alt="image" class="p-3" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Title-->
                                <a href="javascript:void(0)" class="fs-4 fw-semibold text-hover-primary text-gray-600 m-0">Twitch
                                    Posts</a>
                                <!--end::Title-->
                            </div>
                            <!--end::Card title-->
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-header flex-nowrap border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Icon-->
                                <div class="symbol symbol-45px w-45px bg-light me-5">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/twitter.svg', $theme_asset_pack ?? null) }}" alt="image" class="p-3" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Title-->
                                <a href="javascript:void(0)" class="fs-4 fw-semibold text-hover-primary text-gray-600 m-0">Twitter
                                    Followers</a>
                                <!--end::Title-->
                            </div>
                            <!--end::Card title-->
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-header flex-nowrap border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Icon-->
                                <div class="symbol symbol-45px w-45px bg-light me-5">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/spotify.svg', $theme_asset_pack ?? null) }}" alt="image" class="p-3" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Title-->
                                <a href="javascript:void(0)" class="fs-4 fw-semibold text-hover-primary text-gray-600 m-0">Spotify
                                    Listeners</a>
                                <!--end::Title-->
                            </div>
                            <!--end::Card title-->
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-header flex-nowrap border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Icon-->
                                <div class="symbol symbol-45px w-45px bg-light me-5">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/pinterest-p.svg', $theme_asset_pack ?? null) }}" alt="image"
                                        class="p-3" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Title-->
                                <a href="javascript:void(0)" class="fs-4 fw-semibold text-hover-primary text-gray-600 m-0">Pinterest
                                    Posts</a>
                                <!--end::Title-->
                            </div>
                            <!--end::Card title-->
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-header flex-nowrap border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Icon-->
                                <div class="symbol symbol-45px w-45px bg-light me-5">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/github.svg', $theme_asset_pack ?? null) }}" alt="image" class="p-3" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Title-->
                                <a href="javascript:void(0)" class="fs-4 fw-semibold text-hover-primary text-gray-600 m-0">Github
                                    Contributes</a>
                                <!--end::Title-->
                            </div>
                            <!--end::Card title-->
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-header flex-nowrap border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Icon-->
                                <div class="symbol symbol-45px w-45px bg-light me-5">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/youtube-play.svg', $theme_asset_pack ?? null) }}" alt="image"
                                        class="p-3" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Title-->
                                <a href="javascript:void(0)" class="fs-4 fw-semibold text-hover-primary text-gray-600 m-0">Youtube
                                    Subscribers</a>
                                <!--end::Title-->
                            </div>
                            <!--end::Card title-->
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-header flex-nowrap border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Icon-->
                                <div class="symbol symbol-45px w-45px bg-light me-5">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/telegram.svg', $theme_asset_pack ?? null) }}" alt="image" class="p-3" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Title-->
                                <a href="javascript:void(0)" class="fs-4 fw-semibold text-hover-primary text-gray-600 m-0">Telegram
                                    Posts</a>
                                <!--end::Title-->
                            </div>
                            <!--end::Card title-->
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-header flex-nowrap border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Icon-->
                                <div class="symbol symbol-45px w-45px bg-light me-5">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/reddit.svg', $theme_asset_pack ?? null) }}" alt="image" class="p-3" />
                                </div>
                                <!--end::Icon-->
                                <!--begin::Title-->
                                <a href="javascript:void(0)" class="fs-4 fw-semibold text-hover-primary text-gray-600 m-0">Reddit
                                    Awards</a>
                                <!--end::Title-->
                            </div>
                            <!--end::Card title-->
