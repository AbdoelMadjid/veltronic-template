        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card mb-6">
                <div class="card-body pt-9 pb-0">
                    ...
                    <!--end::Details-->
                    <!--begin::Navs-->
                    @include('pages.pages.general.user-profile.partials.navs', ['active' => 'documents'])
                    <!--end::Navs-->
                </div>
            </div>
            <!--end::Navbar-->
                        ...
                        <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                            ...
                            <a href="/apps/file-manager/files"
                                ...
                                <div class="symbol symbol-75px mb-5">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/files/folder-document.svg', $theme_asset_pack ?? null) }}" class="theme-light-show"
                                        alt="" />
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/files/folder-document-dark.svg', $theme_asset_pack ?? null) }}" class="theme-dark-show"
                                        alt="" />
                                </div>
                                <!--end::Image-->
                                <!--begin::Title-->
                                    ...
                                    <div data-kt-stepper-element="content">
                                        ...
                                        <div class="w-100">
                                            ...
                                            <div class="d-flex flex-center pb-20">
                                                ...
                                                <a href="javascript:void(0)" class="btn btn-lg btn-primary" data-bs-toggle="tooltip"
