        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card mb-5 mb-xxl-8">
                <div class="card-body pt-9 pb-0">
                    ...
                    <!--end::Details-->
                    <!--begin::Navs-->
                    @include('pages.pages.general.user-profile.partials.navs', ['active' => 'overview'])
                    <!--end::Navs-->
                </div>
            </div>
            <!--end::Navbar-->
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex align-items-center flex-grow-1">
                                    ...
                                    <div class="d-flex flex-column">
                                        <a href="javascript:void(0)" class="text-gray-900 text-hover-primary fs-6 fw-bold">Grace
                                            Green</a>
                        ...
                        <div class="card-body pb-0">
                            ...
                            <div class="d-flex align-items-center mb-5">
                                ...
                                <div class="d-flex align-items-center flex-grow-1">
                                    ...
                                    <!--begin::Info-->
                                    <div class="d-flex flex-column">
                                        <a href="javascript:void(0)" class="text-gray-900 text-hover-primary fs-6 fw-bold">Nick
                                            Logan</a>
                                        <span class="text-gray-500 fw-bold">PHP, SQLite, Artisan CLI</span>
                                    </div>
                                    <!--end::Info-->
                        ...
                        <div class="card-body pb-0">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="d-flex align-items-center flex-grow-1">
                                    <!--begin::Avatar-->
                                    <div class="symbol symbol-45px me-5">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-21.jpg', $theme_asset_pack ?? null) }}" alt="" />
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Info-->
                                    <div class="d-flex flex-column">
                                        <a href="javascript:void(0)" class="text-gray-900 text-hover-primary fs-6 fw-bold">Carles
                                            Nilson</a>
                            ...
                            <div class="mb-7">
                                ...
                                <div class="d-flex mb-5">
                                    ...
                                    <div class="d-flex flex-column flex-row-fluid">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap mb-1">
                                            <a href="javascript:void(0)" class="text-gray-800 text-hover-primary fw-bold me-2">Alice
                                                Danchik</a>
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="d-flex flex-column flex-row-fluid">
                                        <!--begin::Info-->
                                        <div class="d-flex align-items-center flex-wrap mb-1">
                                            <a href="javascript:void(0)" class="text-gray-800 text-hover-primary fw-bold me-2">Harris
                                                Bold</a>
                        ...
                        <div class="card-body pb-0">
                            ...
                            <div class="d-flex align-items-center mb-5">
                                ...
                                <div class="d-flex align-items-center flex-grow-1">
                                    ...
                                    <!--begin::Info-->
                                    <div class="d-flex flex-column">
                                        <a href="javascript:void(0)" class="text-gray-800 text-hover-primary fs-6 fw-bold">Carles
                                            Nilson</a>
                                        <span class="text-gray-500 fw-bold">Last week at 10:00 PM</span>
                                    </div>
                                    <!--end::Info-->
