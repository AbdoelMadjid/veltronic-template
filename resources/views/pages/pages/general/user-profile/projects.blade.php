        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            ...
            <div class="card mb-6">
                <div class="card-body pt-9 pb-0">
                    ...
                    <!--end::Details-->
                    <!--begin::Navs-->
                    @include('pages.pages.general.user-profile.partials.navs', ['active' => 'projects'])
                    <!--end::Navs-->
                </div>
            </div>
            <!--end::Navbar-->
                        ...
                        <div class="card-header border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                ...
                                <div class="symbol symbol-50px w-50px bg-light">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/plurk.svg', $theme_asset_pack ?? null) }}" alt="image" class="p-3" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                            <!--end::Car Title-->
                    ...
                    <a href="/apps/projects/view" class="card border-hover-primary">
                        ...
                        <div class="card-header border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-50px w-50px bg-light">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/disqus.svg', $theme_asset_pack ?? null) }}" alt="image" class="p-3" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                            <!--end::Car Title-->
                    ...
                    <a href="/apps/projects/view" class="card border-hover-primary">
                        ...
                        <div class="card-header border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-50px w-50px bg-light">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/figma-1.svg', $theme_asset_pack ?? null) }}" alt="image" class="p-3" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                            <!--end::Car Title-->
                        ...
                        <div class="card-body p-9">
                            ...
                            <div class="symbol-group symbol-hover">
                                ...
                                <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Mad Macy">
                                    <img alt="Pic" src="{{ \App\Support\ThemeAsset::url('media/avatars/300-2.jpg', $theme_asset_pack ?? null) }}" />
                                </div>
                                <!--begin::User-->
                                <!--begin::User-->
                                <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                    ...
                    <a href="/apps/projects/view" class="card border-hover-primary">
                        ...
                        <div class="card-header border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-50px w-50px bg-light">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/sentry-3.svg', $theme_asset_pack ?? null) }}" alt="image" class="p-3" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                            <!--end::Car Title-->
                    ...
                    <a href="/apps/projects/view" class="card border-hover-primary">
                        ...
                        <div class="card-header border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-50px w-50px bg-light">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/xing-icon.svg', $theme_asset_pack ?? null) }}" alt="image"
                                        class="p-3" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                        ...
                        <div class="card-body p-9">
                            ...
                            <div class="symbol-group symbol-hover">
                                ...
                                <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                    ...
                                    <img alt="Pic" src="{{ \App\Support\ThemeAsset::url('media/avatars/300-20.jpg', $theme_asset_pack ?? null) }}" />
                                </div>
                                <!--begin::User-->
                                <!--begin::User-->
                                <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                    title="Michelle Swanston">
                                    <img alt="Pic" src="{{ \App\Support\ThemeAsset::url('media/avatars/300-7.jpg', $theme_asset_pack ?? null) }}" />
                                </div>
                                <!--begin::User-->
                                <!--begin::User-->
                                <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                    ...
                    <a href="/apps/projects/view" class="card border-hover-primary">
                        ...
                        <div class="card-header border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-50px w-50px bg-light">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/tvit.svg', $theme_asset_pack ?? null) }}" alt="image" class="p-3" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                            <!--end::Car Title-->
                    ...
                    <a href="/apps/projects/view" class="card border-hover-primary">
                        ...
                        <div class="card-header border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-50px w-50px bg-light">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/aven.svg', $theme_asset_pack ?? null) }}" alt="image" class="p-3" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                            <!--end::Car Title-->
                        ...
                        <div class="card-body p-9">
                            ...
                            <div class="symbol-group symbol-hover">
                                ...
                                <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                                    title="John Mixin">
                                    <img alt="Pic" src="{{ \App\Support\ThemeAsset::url('media/avatars/300-14.jpg', $theme_asset_pack ?? null) }}" />
                                </div>
                                <!--begin::User-->
                                <!--begin::User-->
                                <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip"
                    ...
                    <a href="/apps/projects/view" class="card border-hover-primary">
                        ...
                        <div class="card-header border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-50px w-50px bg-light">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/treva.svg', $theme_asset_pack ?? null) }}" alt="image" class="p-3" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                            <!--end::Car Title-->
                    ...
                    <a href="/apps/projects/view" class="card border-hover-primary">
                        ...
                        <div class="card-header border-0 pt-9">
                            ...
                            <div class="card-title m-0">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-50px w-50px bg-light">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/kanba.svg', $theme_asset_pack ?? null) }}" alt="image" class="p-3" />
                                </div>
                                <!--end::Avatar-->
                            </div>
                            <!--end::Car Title-->
                                            ...
                                            <div class="w-100">
                                                ...
                                                <div class="pb-7 pb-lg-12">
                                                    ...
                                                    <div class="text-muted fw-semibold fs-4">
                                                        ...
                                                        <a href="javascript:void(0)" class="link-primary fw-bold">FAQ Page</a>
                                                    </div>
                                                    <!--end::Description-->
                                                </div>
                                                <!--end::Heading-->
                                            ...
                                            <div class="w-100">
                                                ...
                                                <div class="pb-12">
                                                    ...
                                                    <div class="text-muted fw-semibold fs-4">
                                                        ...
                                                        <a href="javascript:void(0)" class="link-primary">Project Guidelines</a>
                                                    </div>
                                                    <!--end::Description-->
                                                </div>
                                                <!--end::Heading-->
                                                    ...
                                                    <div class="mh-300px scroll-y me-n7 pe-7">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="symbol symbol-35px symbol-circle">
                                                                    <img alt="Pic"
                                                                        src="{{ \App\Support\ThemeAsset::url('media/avatars/300-6.jpg', $theme_asset_pack ?? null) }}" />
                                                                </div>
                                                                <!--end::Avatar-->
                                                                <!--begin::Details-->
                                                                <div class="ms-5">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="symbol symbol-35px symbol-circle">
                                                                    <img alt="Pic"
                                                                        src="{{ \App\Support\ThemeAsset::url('media/avatars/300-1.jpg', $theme_asset_pack ?? null) }}" />
                                                                </div>
                                                                <!--end::Avatar-->
                                                                <!--begin::Details-->
                                                                <div class="ms-5">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="symbol symbol-35px symbol-circle">
                                                                    <img alt="Pic"
                                                                        src="{{ \App\Support\ThemeAsset::url('media/avatars/300-5.jpg', $theme_asset_pack ?? null) }}" />
                                                                </div>
                                                                <!--end::Avatar-->
                                                                <!--begin::Details-->
                                                                <div class="ms-5">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="symbol symbol-35px symbol-circle">
                                                                    <img alt="Pic"
                                                                        src="{{ \App\Support\ThemeAsset::url('media/avatars/300-25.jpg', $theme_asset_pack ?? null) }}" />
                                                                </div>
                                                                <!--end::Avatar-->
                                                                <!--begin::Details-->
                                                                <div class="ms-5">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="symbol symbol-35px symbol-circle">
                                                                    <img alt="Pic"
                                                                        src="{{ \App\Support\ThemeAsset::url('media/avatars/300-9.jpg', $theme_asset_pack ?? null) }}" />
                                                                </div>
                                                                <!--end::Avatar-->
                                                                <!--begin::Details-->
                                                                <div class="ms-5">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="symbol symbol-35px symbol-circle">
                                                                    <img alt="Pic"
                                                                        src="{{ \App\Support\ThemeAsset::url('media/avatars/300-23.jpg', $theme_asset_pack ?? null) }}" />
                                                                </div>
                                                                <!--end::Avatar-->
                                                                <!--begin::Details-->
                                                                <div class="ms-5">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="symbol symbol-35px symbol-circle">
                                                                    <img alt="Pic"
                                                                        src="{{ \App\Support\ThemeAsset::url('media/avatars/300-13.jpg', $theme_asset_pack ?? null) }}" />
                                                                </div>
                                                                <!--end::Avatar-->
                                                                <!--begin::Details-->
                                                                <div class="ms-5">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="symbol symbol-35px symbol-circle">
                                                                    <img alt="Pic"
                                                                        src="{{ \App\Support\ThemeAsset::url('media/avatars/300-21.jpg', $theme_asset_pack ?? null) }}" />
                                                                </div>
                                                                <!--end::Avatar-->
                                                                <!--begin::Details-->
                                                                <div class="ms-5">
                                                    ...
                                                    <div class="mh-300px scroll-y me-n7 pe-7">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="symbol symbol-35px">
                                                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/files/pdf.svg', $theme_asset_pack ?? null) }}"
                                                                        alt="icon" />
                                                                </div>
                                                                <!--end::Avatar-->
                                                                <!--begin::Details-->
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <!--begin::Avatar-->
                                                                <div class="symbol symbol-35px">
                                                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/files/doc.svg', $theme_asset_pack ?? null) }}"
                                                                        alt="icon" />
                                                                </div>
                                                                <!--end::Avatar-->
                                                                <!--begin::Details-->
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <!--begin::Avatar-->
                                                                <div class="symbol symbol-35px">
                                                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/files/css.svg', $theme_asset_pack ?? null) }}"
                                                                        alt="icon" />
                                                                </div>
                                                                <!--end::Avatar-->
                                                                <!--begin::Details-->
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <!--begin::Avatar-->
                                                                <div class="symbol symbol-35px">
                                                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/files/ai.svg', $theme_asset_pack ?? null) }}"
                                                                        alt="icon" />
                                                                </div>
                                                                <!--end::Avatar-->
                                                                <!--begin::Details-->
                                                        ...
                                                        <div class="d-flex flex-stack py-4">
                                                            <div class="d-flex align-items-center">
                                                                <!--begin::Avatar-->
                                                                <div class="symbol symbol-35px">
                                                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/files/tif.svg', $theme_asset_pack ?? null) }}"
                                                                        alt="icon" />
                                                                </div>
                                                                <!--end::Avatar-->
                                                                <!--begin::Details-->
                                        ...
                                        <div data-kt-stepper-element="content">
                                            ...
                                            <div class="w-100">
                                                ...
                                                <div class="text-center px-4">
                                                    <img src="{{ \App\Support\ThemeAsset::url('media/illustrations/sketchy-1/9.png', $theme_asset_pack ?? null) }}" alt=""
