            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center pb-15 px-5">
                        <img src="{{ \App\Support\ThemeAsset::url('media/illustrations/sketchy-1/16.png', $theme_asset_pack ?? null) }}" alt=""
...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/utilities/modals/create-api-key.js', $theme_asset_pack ?? null) }}"></script>
