                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <a href="javascript:void(0)" id="kt_horizontal_search_advanced_link" class="btn btn-link"
...
@section('scripts')
    ...
    <script src="{{ \App\Support\ThemeAsset::url('js/custom/utilities/search/horizontal.js', $theme_asset_pack ?? null) }}"></script>
