        ...
        <div id="kt_app_content_container" class="app-container container-fluid widget-showcase-masonry">
            <div class="row g-5 g-xl-8 mb-10 widget-showcase-row widget-showcase-featured">
                <div class="col-12 widget-showcase-item">
                    <x-widget-include-badge name="engage.__widget-2" />
                    @include('partials.widgets.engage._widget-2')
                </div>
            </div>
            ...
            <div class="row g-5 g-xl-8 mb-10 widget-showcase-row">
                <div class="col-xl-6 widget-showcase-item">
                    <x-widget-include-badge name="engage.__widget-12" />
                    @include('partials.widgets.engage._widget-12')
                </div>
                <div class="col-xl-6 widget-showcase-item">
                    <x-widget-include-badge name="engage.__widget-13" />
                    @include('partials.widgets.engage._widget-13')
                </div>
            </div>
            <div class="row g-5 g-xl-8 mb-10 widget-showcase-row">
                <div class="col-xl-6 widget-showcase-item">
                    <x-widget-include-badge name="engage.__widget-14" />
                    @include('partials.widgets.engage._widget-14')
                </div>
                <div class="col-xl-6 widget-showcase-item">
                    <x-widget-include-badge name="engage.__widget-15" />
                    @include('partials.widgets.engage._widget-15')
                </div>
            </div>
            <div class="row g-5 g-xl-8 mb-10 widget-showcase-row">
                <div class="col-xl-6 widget-showcase-item">
                    <x-widget-include-badge name="engage.__widget-16" />
                    @include('partials.widgets.engage._widget-16')
                </div>
            </div>
        </div>
    </div>
