        ...
        <div id="kt_app_content_container" class="app-container container-fluid widget-showcase-masonry">
            <div class="row g-5 g-xl-8 mb-10 widget-showcase-row">
                <div class="col-xl-6 widget-showcase-item">
                    <x-widget-include-badge name="feeds.__widget-1" />
                    @include('partials.widgets.feeds._widget-1')
                </div>
                <div class="col-xl-6 widget-showcase-item">
                    <x-widget-include-badge name="feeds.__widget-2" />
                    @include('partials.widgets.feeds._widget-2')
                </div>
            </div>
            <div class="row g-5 g-xl-8 mb-10 widget-showcase-row">
                <div class="col-xl-6 widget-showcase-item">
                    <x-widget-include-badge name="feeds.__widget-3" />
                    @include('partials.widgets.feeds._widget-3')
                </div>
                <div class="col-xl-6 widget-showcase-item">
                    <x-widget-include-badge name="feeds.__widget-4" />
                    @include('partials.widgets.feeds._widget-4')
                </div>
            </div>
            <div class="row g-5 g-xl-8 mb-10 widget-showcase-row">
                <div class="col-xl-6 widget-showcase-item">
                    <x-widget-include-badge name="feeds.__widget-5" />
                    @include('partials.widgets.feeds._widget-5')
                </div>
            </div>
        </div>
    </div>
