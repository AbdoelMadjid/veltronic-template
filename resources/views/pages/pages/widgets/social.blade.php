        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            <div class="row g-5 g-xl-8 mb-10 widget-showcase-row">
                <div class="col-md-6 col-xl-4 widget-showcase-item">
                    <x-widget-include-badge name="social.__widget-1" />
                    @include('partials.widgets.social._widget-1')
                </div>
                <div class="col-md-6 col-xl-4 widget-showcase-item">
                    <x-widget-include-badge name="social.__widget-2" />
                    @include('partials.widgets.social._widget-2')
                </div>
            </div>
        </div>
    </div>
