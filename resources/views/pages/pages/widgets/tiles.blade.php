        ...
        <div id="kt_app_content_container" class="app-container container-fluid widget-showcase-masonry">
            <div class="row g-5 g-xl-8 mb-10 widget-showcase-row">
                <div class="col-md-6 col-xl-4 widget-showcase-item">
                    ...
                    @include('partials.widgets.tiles._widget-1')
                </div>
                <div class="col-md-6 col-xl-4 widget-showcase-item">
                    <x-widget-include-badge name="tiles.__widget-2" />
                    @include('partials.widgets.tiles._widget-2')
                </div>
                <div class="col-md-6 col-xl-4 widget-showcase-item">
                    <x-widget-include-badge name="tiles.__widget-3" />
                    @include('partials.widgets.tiles._widget-3')
                </div>
            </div>
            <div class="row g-5 g-xl-8 mb-10 widget-showcase-row">
                <div class="col-md-6 col-xl-4 widget-showcase-item">
                    <x-widget-include-badge name="tiles.__widget-4" />
                    @include('partials.widgets.tiles._widget-4')
                </div>
                <div class="col-md-6 col-xl-4 widget-showcase-item">
                    <x-widget-include-badge name="tiles.__widget-5" />
                    @include('partials.widgets.tiles._widget-5')
                </div>
            </div>
        </div>
    </div>
