...
<div class="d-flex flex-wrap flex-sm-nowrap align-items-center justify-content-center justify-content-sm-start w-100 text-center text-sm-start">
    <!--begin: Pic-->
    <div class="w-100 w-sm-auto d-flex justify-content-center justify-content-sm-start me-0 me-sm-7 mb-4 mb-sm-0">
    ...
    <div class="flex-grow-1 w-100 w-sm-auto">
        <!--begin::Title-->
        <div class="d-flex justify-content-center justify-content-sm-between align-items-center align-items-sm-start flex-wrap mb-2">
            <!--begin::User-->
            <div class="d-flex flex-column align-items-center align-items-sm-start">
                ...
                <!--begin::Info-->
                <div class="d-flex flex-wrap justify-content-center justify-content-sm-start fw-semibold fs-6 mb-4 pe-0 pe-sm-2">
                    <a href="javascript:void(0)"
                        class="d-flex align-items-center text-white text-opacity-90 text-hover-primary mx-2 me-sm-5 ms-sm-0 mb-2" style="text-shadow: 0 1px 3px rgba(0,0,0,0.55);">
                    ...
                    <a href="javascript:void(0)"
                        class="d-flex align-items-center text-white text-opacity-90 text-hover-primary mx-2 me-sm-0 ms-sm-0 mb-2" style="text-shadow: 0 1px 3px rgba(0,0,0,0.55);">
            ...
            <!--begin::Actions-->
            <div class="d-flex justify-content-center justify-content-sm-end my-4 w-100 w-sm-auto">
        ...
        <!--begin::Stats-->
        <div class="d-flex flex-wrap flex-stack justify-content-center justify-content-sm-between">
            <!--begin::Wrapper-->
            <div class="d-flex flex-column flex-grow-1 pe-0 pe-sm-8 w-100 w-sm-auto">
                <!--begin::Stats-->
                <div class="d-flex flex-wrap justify-content-center justify-content-sm-start">
                    <!--begin::Stat: Total Poin-->
                    <div
                        class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-2 me-sm-6 mb-3 bg-body bg-opacity-75 backdrop-blur-sm shadow-xs text-center text-sm-start">
                        <!--begin::Number-->
                    ...
                    <div
                        class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-0 me-sm-6 mb-3 bg-body bg-opacity-75 backdrop-blur-sm shadow-xs text-center text-sm-start">
                        <!--begin::Number-->
                        <div class="d-flex align-items-center justify-content-center justify-content-sm-start">
            ...
            <!--begin::Progress-->
            <div class="d-flex align-items-center w-250px w-sm-300px flex-column mt-3 mx-auto mx-sm-0 bg-body bg-opacity-75 backdrop-blur-sm rounded p-3 border border-gray-300 border-dashed shadow-xs">
