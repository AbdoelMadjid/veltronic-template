...
<div id="kt_activities" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities" data-kt-drawer-activate="true"
    ...
    <div class="card shadow-none border-0 rounded-0">
                        ...
                        <div class="timeline-content mb-10 mt-n1">
                            ...
                            <div class="overflow-auto pb-5">
                                ...
                                <div
                                    ...
                                    <!--begin::Title-->
                                    <a href="{{ route('apps.projects.view') }}"
                        ...
                        <div class="timeline-content mb-10 mt-n1">
                            ...
                            <div class="pe-3 mb-5">
                                ...
                                <div class="fs-5 fw-semibold mb-2">
                                    Task <a href="javascript:void(0)" class="text-primary fw-bold me-1">#45890</a>
                                    merged with <a href="javascript:void(0)"
                                        class="text-primary fw-bold me-1">#45890</a> in “Ads
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content mb-10 mt-n1">
                            ...
                            <div class="pe-3 mb-5">
                                <!--begin::Title-->
                                <div class="fs-5 fw-semibold mb-2">
                                    New case <a href="javascript:void(0)" class="text-primary fw-bold me-1">#67890</a>
                    ...
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content mt-n1">
                            ...
                            <div class="pe-3 mb-5">
                                <!--begin::Title-->
                                <div class="fs-5 fw-semibold mb-2">
                                    New order <a href="javascript:void(0)"
        ...
        <div class="card-footer py-5 text-center" id="kt_activities_footer">
            <a href="{{ route('pages.general.user-profile.activity') }}" class="btn btn-bg-body text-primary">
