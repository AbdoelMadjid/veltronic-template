...
<!--begin::Demos drawer-->
<div id="kt_engage_demos" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="explore" data-kt-drawer-activate="true"
                ...
                <div class="mb-0">
                    ...
                    <div class="mb-7">
                        <div class="d-flex flex-stack">
                            ...
                            <a href="https://themeforest.net/licenses/standard" target="_blank" class="fw-semibold"
                    ...
                    <a href="https://1.envato.market/EA4JP" target="_blank"
                        class="btn btn-primary fw-bold mb-15 w-100">Buy Now</a>
                    <!--end::Purchase-->
                    <!--begin::Demos-->
                    <div class="mb-0">
                        ...
                        <div class="row g-5">
                            ...
                            <div class="col-6">
                                ...
                                <div
                                    ...
                                    <div class="overlay-wrapper">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/demos/demo1.png', $theme_asset_pack ?? null) }}"
                                            alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <a href="https://preview.keenthemes.com/metronic8/demo1"
                                            class="btn btn-sm btn-success shadow" target="_blank">Demo 1</a>
                                    </div>
                                </div>
                                <!--end::Demo-->
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div
                                    ...
                                    <div class="overlay-wrapper">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/demos/demo2.png', $theme_asset_pack ?? null) }}"
                                            alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <a href="https://preview.keenthemes.com/metronic8/demo2"
                                            class="btn btn-sm btn-success shadow" target="_blank">Demo 2</a>
                                    </div>
                                </div>
                                <!--end::Demo-->
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div
                                    class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/demos/demo3.png', $theme_asset_pack ?? null) }}"
                                            alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <a href="https://preview.keenthemes.com/metronic8/demo3"
                                            class="btn btn-sm btn-success shadow" target="_blank">Demo 3</a>
                                    </div>
                                </div>
                                <!--end::Demo-->
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div
                                    class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/demos/demo4.png', $theme_asset_pack ?? null) }}"
                                            alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <a href="https://preview.keenthemes.com/metronic8/demo4"
                                            class="btn btn-sm btn-success shadow" target="_blank">Demo 4</a>
                                    </div>
                                </div>
                                <!--end::Demo-->
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div
                                    class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/demos/demo5.png', $theme_asset_pack ?? null) }}"
                                            alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <a href="https://preview.keenthemes.com/metronic8/demo5"
                                            class="btn btn-sm btn-success shadow" target="_blank">Demo 5</a>
                                    </div>
                                </div>
                                <!--end::Demo-->
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div
                                    class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/demos/demo6.png', $theme_asset_pack ?? null) }}"
                                            alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <a href="https://preview.keenthemes.com/metronic8/demo6"
                                            class="btn btn-sm btn-success shadow" target="_blank">Demo 6</a>
                                    </div>
                                </div>
                                <!--end::Demo-->
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div
                                    class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/demos/demo7.png', $theme_asset_pack ?? null) }}"
                                            alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <a href="https://preview.keenthemes.com/metronic8/demo7"
                                            class="btn btn-sm btn-success shadow" target="_blank">Demo 7</a>
                                    </div>
                                </div>
                                <!--end::Demo-->
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div
                                    class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/demos/demo8.png', $theme_asset_pack ?? null) }}"
                                            alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <a href="https://preview.keenthemes.com/metronic8/demo8"
                                            class="btn btn-sm btn-success shadow" target="_blank">Demo 8</a>
                                    </div>
                                </div>
                                <!--end::Demo-->
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div
                                    class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/demos/demo9.png', $theme_asset_pack ?? null) }}"
                                            alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <a href="https://preview.keenthemes.com/metronic8/demo9"
                                            class="btn btn-sm btn-success shadow" target="_blank">Demo 9</a>
                                    </div>
                                </div>
                                <!--end::Demo-->
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div
                                    class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/demos/demo10.png', $theme_asset_pack ?? null) }}"
                                            alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <a href="https://preview.keenthemes.com/metronic8/demo10"
                                            class="btn btn-sm btn-success shadow" target="_blank">Demo 10</a>
                                    </div>
                                </div>
                                <!--end::Demo-->
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div
                                    class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/demos/demo11.png', $theme_asset_pack ?? null) }}"
                                            alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <a href="https://preview.keenthemes.com/metronic8/demo11"
                                            class="btn btn-sm btn-success shadow" target="_blank">Demo 11</a>
                                    </div>
                                </div>
                                <!--end::Demo-->
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div
                                    class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/demos/demo12.png', $theme_asset_pack ?? null) }}"
                                            alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <a href="https://preview.keenthemes.com/metronic8/demo12"
                                            class="btn btn-sm btn-success shadow" target="_blank">Demo 12</a>
                                    </div>
                                </div>
                                <!--end::Demo-->
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div
                                    class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/demos/demo13.png', $theme_asset_pack ?? null) }}"
                                            alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <a href="https://preview.keenthemes.com/metronic8/demo13"
                                            class="btn btn-sm btn-success shadow" target="_blank">Demo 13</a>
                                    </div>
                                </div>
                                <!--end::Demo-->
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div
                                    class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/demos/demo14.png', $theme_asset_pack ?? null) }}"
                                            alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <a href="https://preview.keenthemes.com/metronic8/demo14"
                                            class="btn btn-sm btn-success shadow" target="_blank">Demo 14</a>
                                    </div>
                                </div>
                                <!--end::Demo-->
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div
                                    class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/demos/demo15.png', $theme_asset_pack ?? null) }}"
                                            alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <a href="https://preview.keenthemes.com/metronic8/demo15"
                                            class="btn btn-sm btn-success shadow" target="_blank">Demo 15</a>
                                    </div>
                                </div>
                                <!--end::Demo-->
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div
                                    class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/demos/demo16.png', $theme_asset_pack ?? null) }}"
                                            alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <a href="https://preview.keenthemes.com/metronic8/demo16"
                                            class="btn btn-sm btn-success shadow" target="_blank">Demo 16</a>
                                    </div>
                                </div>
                                <!--end::Demo-->
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div
                                    class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/demos/demo17.png', $theme_asset_pack ?? null) }}"
                                            alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <a href="https://preview.keenthemes.com/metronic8/demo17"
                                            class="btn btn-sm btn-success shadow" target="_blank">Demo 17</a>
                                    </div>
                                </div>
                                <!--end::Demo-->
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div
                                    class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/demos/demo18.png', $theme_asset_pack ?? null) }}"
                                            alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <a href="https://preview.keenthemes.com/metronic8/demo18"
                                            class="btn btn-sm btn-success shadow" target="_blank">Demo 18</a>
                                    </div>
                                </div>
                                <!--end::Demo-->
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div
                                    class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/demos/demo19.png', $theme_asset_pack ?? null) }}"
                                            alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <a href="https://preview.keenthemes.com/metronic8/demo19"
                                            class="btn btn-sm btn-success shadow" target="_blank">Demo 19</a>
                                    </div>
                                </div>
                                <!--end::Demo-->
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div
                                    class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/demos/demo20.png', $theme_asset_pack ?? null) }}"
                                            alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <a href="https://preview.keenthemes.com/metronic8/demo20"
                                            class="btn btn-sm btn-success shadow" target="_blank">Demo 20</a>
                                    </div>
                                </div>
                                <!--end::Demo-->
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div
                                    class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/demos/demo21.png', $theme_asset_pack ?? null) }}"
                                            alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <a href="https://preview.keenthemes.com/metronic8/demo21"
                                            class="btn btn-sm btn-success shadow" target="_blank">Demo 21</a>
                                    </div>
                                </div>
                                <!--end::Demo-->
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div
                                    class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/demos/demo22.png', $theme_asset_pack ?? null) }}"
                                            alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <a href="https://preview.keenthemes.com/metronic8/demo22"
                                            class="btn btn-sm btn-success shadow" target="_blank">Demo 22</a>
                                    </div>
                                </div>
                                <!--end::Demo-->
                            </div>
                            ...
                            <div class="col-6">
                                ...
                                <div
                                    class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/demos/demo23.png', $theme_asset_pack ?? null) }}"
                            ...
                            <div class="col-6">
                                ...
                                <div
                                    class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ \App\Support\ThemeAsset::url('media/demos/demo24.png', $theme_asset_pack ?? null) }}"
                                            alt="demo" class="w-100 opacity-25" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <div class="badge badge-white px-6 py-4 fw-semibold fs-base shadow">Coming
            ...
            <div id="kt_help_scroll" class="hover-scroll-overlay-y" data-kt-scroll="true"
                ...
                <div class="rounded border border-dashed border-gray-300 p-6 p-lg-8 mb-10">
                    ...
                    <h2 class="fw-bold mb-5">Support at
                        <a href="https://devs.keenthemes.com" target="_blank" class="">devs.keenthemes.com</a>
                    </h2>
                    <!--end::Heading-->
                    <!--begin::Description-->
                    <div class="fs-5 fw-semibold mb-5">
                        ...
                        <a class="explore-link d-none" target="_blank"
                ...
                <div class="d-flex align-items-center mb-7">
                    ...
                    <div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                        ...
                        <div class="d-flex flex-column me-2 me-lg-5">
                            <!--begin::Title-->
                            <a href="{{ url('docs/getting-started/setup') }}" target="_blank"
                ...
                <div class="d-flex align-items-center mb-7">
                    ...
                    <div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                        ...
                        <div class="d-flex flex-column me-2 me-lg-5">
                            <!--begin::Title-->
                            <a href="{{ url('docs/base/utilities') }}" target="_blank"
                    ...
                    <div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                        ...
                        <div class="d-flex flex-column me-2 me-lg-5">
                            ...
                            <a href="https://preview.keenthemes.com/metronic8/demo1/layout-builder.html"
                                target="_blank" class="text-dark text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">Layout
                                Builder</a>
                            <!--end::Title-->
                            <!--begin::Description-->
                ...
                <div class="d-flex align-items-center mb-7">
                    ...
                    <div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                        ...
                        <div class="d-flex flex-column me-2 me-lg-5">
                            <!--begin::Title-->
                            <a href="https://devs.keenthemes.com/metronic" target="_blank"
                ...
                <div class="d-flex align-items-center mb-7">
                    ...
                    <div class="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                        ...
                        <div class="d-flex flex-column me-2 me-lg-5">
                            <!--begin::Title-->
                            <a href="{{ url('docs/getting-started/changelog') }}" target="_blank"
