<!--begin::Menu Notifications v2-->
<div class="menu menu-sub menu-sub-dropdown menu-column w-375px w-sm-400px w-md-425px" data-kt-menu="true" id="kt_menu_notifications_v2">
    <!--begin::Heading-->
    <div class="d-flex flex-column bgi-no-repeat rounded-top px-6 pt-6 pb-2"
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <div>
                ...
                <span class="fs-8 text-white opacity-75" id="notif_header_badge_v2">0 belum dibaca</span>
            </div>
            <button type="button" class="btn btn-xs btn-color-white btn-active-color-primary bg-white bg-opacity-10 py-1 px-3 border-0 fs-8 rounded-pill shadow-xs" id="btn_mark_all_read_v2">
        ...
        <ul class="nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-semibold border-0 d-flex justify-content-between px-0 overflow-hidden">
            ...
            <li class="nav-item">
                <a class="nav-link text-white opacity-75 opacity-state-100 pb-3 fs-7 px-2 d-inline-flex align-items-center gap-1" data-bs-toggle="tab"
                    href="#kt_topbar_notif_friendship_v2">
                    Pertemanan
                    <span class="badge badge-circle badge-success fs-9 w-16px h-16px d-none" id="notif_tab_count_friends_v2">0</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white opacity-75 opacity-state-100 pb-3 fs-7 px-2 d-inline-flex align-items-center gap-1" data-bs-toggle="tab"
                    href="#kt_topbar_notif_security_v2">
                    Keamanan
                    <span class="badge badge-circle badge-warning fs-9 w-16px h-16px d-none" id="notif_tab_count_security_v2">0</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white opacity-75 opacity-state-100 pb-3 fs-7 px-2 d-inline-flex align-items-center gap-1" data-bs-toggle="tab"
                    href="#kt_topbar_notif_chat_v2">
                    Pesan
                    <span class="badge badge-circle badge-info fs-9 w-16px h-16px d-none" id="notif_tab_count_chat_v2">0</span>
                </a>
            </li>
        </ul>
        <!--end::Tabs Navigation-->
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade show active" id="kt_topbar_notif_all_v2" role="tabpanel">
            <div class="scroll-y mh-350px my-2 px-6" id="notif_list_all_v2">
        ...
        <div class="tab-pane fade" id="kt_topbar_notif_friendship_v2" role="tabpanel">
            <div class="scroll-y mh-350px my-2 px-6" id="notif_list_friendship_v2">
                <div class="text-center py-10 px-4">
        ...
        <div class="tab-pane fade" id="kt_topbar_notif_security_v2" role="tabpanel">
            <div class="scroll-y mh-350px my-2 px-6" id="notif_list_security_v2">
                <div class="text-center py-10 px-4">
        ...
        <div class="tab-pane fade" id="kt_topbar_notif_chat_v2" role="tabpanel">
            <div class="scroll-y mh-350px my-2 px-6" id="notif_list_chat_v2">
                <div class="text-center py-10 px-4">
