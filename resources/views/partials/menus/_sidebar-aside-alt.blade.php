...
<div id="kt_app_aside" class="app-aside flex-column z-inde-1" data-kt-drawer="true" data-kt-drawer-name="app-aside"
    ...
    <!--begin::Navbar-->
    <div class="app-navbar flex-stack flex-shrink-0 p-5 pt-lg-12 pb-lg-8 px-lg-14" id="kt_app_aside_navbar">
        <!--begin:Author-->
        <div class="d-flex align-items-center me-5 me-lg-10">
            ...
            <div class="d-flex flex-column">
                <a href="pages/user-profile/overview.html"
                    class="app-navbar-user-name text-gray-900 text-hover-primary fs-5 fw-bold">Alice Page</a>
    ...
    <div id="kt_app_aside_content_wrapper"
        class="app-aside_content-wrapper hover-scroll-overlay-y mx-3 ps-5 ps-lg-11 pe-3 pe-lg-11 pb-10"
