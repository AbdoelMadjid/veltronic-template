                ...
                <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">
                    @if (app()->getLocale() == 'id')
                        {{ __('menu.indonesian') }} <img class="w-15px h-15px rounded-1 ms-2"
                            src="{{ $assetBase }}/media/flags/indonesia.svg" alt="" />
                    @else
                        {{ __('menu.english') }} <img class="w-15px h-15px rounded-1 ms-2"
                            src="{{ $assetBase }}/media/flags/united-states.svg" alt="" />
                    @endif
                </span>
            </span>
        </a>
        ...
        <div class="menu-sub menu-sub-dropdown w-175px py-4">
            ...
            <div class="menu-item px-3">
                <a href="{{ route('lang.switch', 'en') }}"
                    ...
                    <span class="symbol symbol-20px me-4">
                        <img class="rounded-1" src="{{ $assetBase }}/media/flags/united-states.svg"
                            alt="" />
                    </span>
                    {{ __('menu.english') }}
                </a>
            ...
            <div class="menu-item px-3">
                <a href="{{ route('lang.switch', 'id') }}"
                    ...
                    <span class="symbol symbol-20px me-4">
                        <img class="rounded-1" src="{{ $assetBase }}/media/flags/indonesia.svg" alt="" />
                    </span>
                    {{ __('menu.indonesian') }}
                </a>
            </div>
    ...
    <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
        ...
        <a href="javascript:void(0)" class="menu-link px-5">
            <span class="menu-title position-relative">
                Version
                <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">
                    {{ 'Metronic ' . strtoupper($currentVersion) }}
                </span>
            </span>
        </a>
        <!--begin::Menu sub-->
