...
<div class="d-flex flex-column mb-7 fv-row">
    ...
    <div class="position-relative">
        ...
        <div class="position-absolute translate-middle-y top-50 end-0 me-5">
            <img src="{{ \App\Support\ThemeAsset::url('media/svg/card-logos/visa.svg', $theme_asset_pack ?? null) }}" alt="" class="h-25px" />
            <img src="{{ \App\Support\ThemeAsset::url('media/svg/card-logos/mastercard.svg', $theme_asset_pack ?? null) }}" alt="" class="h-25px" />
            <img src="{{ \App\Support\ThemeAsset::url('media/svg/card-logos/american-express.svg', $theme_asset_pack ?? null) }}" alt="" class="h-25px" />
        </div>
        <!--end::Card logos-->
    </div>
    <!--end::Input wrapper-->
