            ...
            <div class="modal-body scroll-y m-5">
                ...
                <div class="stepper stepper-links d-flex flex-column" id="kt_modal_offer_a_deal_stepper">
                    ...
                    <form class="mx-auto mw-500px w-100 pt-15 pb-10" novalidate="novalidate"
                        ...
                        <!--begin::Type-->
                        @include('partials.modals.offer-a-deal._type')
                        <!--end::Type-->
                        <!--begin::Details-->
                        @include('partials.modals.offer-a-deal._details')
                        <!--end::Details-->
                        <!--begin::Budget-->
                        @include('partials.modals.offer-a-deal._budget')
                        <!--end::Budget-->
                        <!--begin::Complete-->
                        @include('partials.modals.offer-a-deal._complete')
                        <!--end::Complete-->
                    </form>
                    <!--end::Form-->
                </div>
