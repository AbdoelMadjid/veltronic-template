                    ...
                    <div class="card card-flush">
                            ...
                            <div class="card-title flex-stack flex-row-fluid">
                                ...
                                <div class="me-n2">
                                    ...
                                    <span class="badge badge-light-success align-self-center fs-base">
                                        <i class="{{ $vars["p17_0"] ?? "ki-outline ki-arrow-up fs-5 text-success ms-n1" }}"></i>{{ $vars["p17_1"] ?? "2.2%" }}</span>
                                    <!--end::Badge-->
                                </div>
                                <!--end::Wrapper-->
                            </div>
                        ...
                        <div class="card-body d-flex align-items-end">
                            ...
                            <div class="d-flex flex-column">
                                <span class="fw-bolder fs-2x text-gray-900">{{ $vars["p29_1"] ?? "$65,209.00" }}</span>
