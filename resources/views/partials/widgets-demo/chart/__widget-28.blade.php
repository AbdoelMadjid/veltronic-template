...
<div class="{{ $vars['card_class'] ?? 'card card-flush h-xl-100' }}">
    ...
    <div class="card-header py-7">
        ...
        <div class="m-0">
            ...
            <div class="d-flex align-items-center mb-2">
                <!--begin::Title-->
                <span class="{{ $vars['value_class'] ?? 'fs-2hx fw-bold text-gray-800 me-2 lh-1 ls-n2' }}">{{ $vars['value'] ?? '2,579' }}</span>
                <!--end::Title-->
                <!--begin::Label-->
                <span class="{{ $vars['badge_class'] ?? 'badge badge-light-success fs-base' }}">
                    <i class="{{ $vars['trend_icon_class'] ?? 'ki-outline ki-arrow-up fs-5 text-success ms-n1' }}">
                        @if ($vars['trend_icon_duotone'] ?? false)
                            <span class="path1"></span>
                            <span class="path2"></span>
                        @endif
                    </i>{{ $vars['trend_text'] ?? '2.2%' }}</span>
                <!--end::Label-->
            </div>
            <!--end::Heading-->
            <!--begin::Description-->
            <span class="{{ $vars['description_class'] ?? 'fs-6 fw-semibold text-gray-500' }}">{{ $vars['description'] ?? 'Domain External Links' }}</span>
            <!--end::Description-->
        </div>
        <!--end::Statistics-->
        <!--begin::Toolbar-->
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px"
                ...
                <div class="menu-item px-3" data-kt-menu-trigger="hover"
                    ...
                    <div class="menu-sub menu-sub-dropdown w-175px py-4">
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a href="{{ $vars['menu_admin_href'] ?? ($vars['menu_href'] ?? 'javascript:void(0)') }}" class="menu-link px-3">Admin
                                Group</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a href="{{ $vars['menu_staff_href'] ?? ($vars['menu_href'] ?? 'javascript:void(0)') }}" class="menu-link px-3">Staff
                                Group</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a href="{{ $vars['menu_member_href'] ?? ($vars['menu_href'] ?? 'javascript:void(0)') }}" class="menu-link px-3">Member
                                Group</a>
                        </div>
                        <!--end::Menu item-->
                    </div>
    ...
    <!--end::Header-->
    <!--begin::Body-->
    <div class="{{ $vars['body_class'] ?? 'card-body d-flex align-items-end ps-4 pe-0 pb-4' }}">
        <!--begin::Chart-->
        <div id="{{ $vars['chart_id'] ?? 'kt_charts_widget_28' }}" class="{{ $vars['chart_class'] ?? 'h-300px w-100 min-h-auto' }}"></div>
        <!--end::Chart-->
    </div>
    <!--end::Body-->
</div>
