...
<div class="{{ $vars['card_class'] ?? 'card card-flush h-xl-100' }}">
    ...
    <div class="card-header py-7">
        ...
        <div class="m-0">
            ...
            <div class="d-flex align-items-center mb-2">
                <!--begin::Title-->
                <span class="{{ $vars['value_class'] ?? 'fs-2hx fw-bold text-gray-800 me-2 lh-1 ls-n2' }}">{{ $vars['value'] ?? '7,9' }}</span>
                <!--end::Title-->
                <!--begin::Label-->
            ...
            <!--end::Heading-->
            <!--begin::Description-->
            <span class="{{ $vars['description_class'] ?? 'fs-6 fw-semibold text-gray-500' }}">{{ $vars['description'] ?? 'Avarage Position' }}</span>
            <!--end::Description-->
        </div>
        <!--end::Statistics-->
        <!--begin::Toolbar-->
    ...
    <!--end::Header-->
    <!--begin::Body-->
    <div class="{{ $vars['body_class'] ?? 'card-body d-flex align-items-end p-0' }}">
        <!--begin::Chart-->
        <div id="{{ $vars['chart_id'] ?? 'kt_charts_widget_29' }}" class="{{ $vars['chart_class'] ?? 'h-300px w-100 min-h-auto ps-7 pe-0 mb-5' }}"></div>
        <!--end::Chart-->
    </div>
    <!--end::Body-->
</div>
