                    ...
                    <table class="table align-middle gs-0 gy-4">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <a href="javascript:void(0)"
                                        class="text-gray-600 fw-bold fs-6">12:40 AM</a>
                                </td>
                                <td class="pe-0 text-end">
                            ...
                            <tr>
                                <td>
                                    <a href="javascript:void(0)"
                                        class="text-gray-600 fw-bold fs-6">11:30 PM</a>
                                </td>
                                <td class="pe-0 text-end">
                            ...
                            <tr>
                                <td>
                                    <a href="javascript:void(0)"
                                        class="text-gray-600 fw-bold fs-6">4:25 PM</a>
                                </td>
                                <td class="pe-0 text-end">
                                    <span class="text-gray-800 fw-bold fs-6 me-1">$2,756.26</span>
                                </td>
                    ...
                    <table class="table align-middle gs-0 gy-4">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <a href="javascript:void(0)"
                                        class="text-gray-600 fw-bold fs-6">3:20 PM</a>
                                </td>
                                <td class="pe-0 text-end">
                            ...
                            <tr>
                                <td>
                                    <a href="javascript:void(0)"
                                        class="text-gray-600 fw-bold fs-6">10:30 AM</a>
                                </td>
                                <td class="pe-0 text-end">
                            ...
                            <tr>
                                <td>
                                    <a href="javascript:void(0)"
                                        class="text-gray-600 fw-bold fs-6">1:30 AM</a>
                                </td>
                                <td class="pe-0 text-end">
                                    <span class="text-gray-800 fw-bold fs-6 me-1">$2,756.26</span>
                                </td>
