    ...
    <div class="card-header pt-5 mb-6">
        ...
        <div class="card-toolbar">
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px"
                ...
                <!--begin::Menu item-->
                <div class="menu-item px-3">
                    <a href="{{ $vars['menu_ticket_href'] ?? ($vars['link_href'] ?? '#') }}" class="menu-link px-3">New Ticket</a>
                </div>
                <!--end::Menu item-->
                <!--begin::Menu item-->
                <div class="menu-item px-3">
                    <a href="{{ $vars['menu_customer_href'] ?? ($vars['link_href'] ?? '#') }}" class="menu-link px-3">New Customer</a>
                </div>
                <!--end::Menu item-->
                <!--begin::Menu item-->
                <div class="menu-item px-3" data-kt-menu-trigger="hover"
                    ...
                    <!--begin::Menu item-->
                    <a href="{{ $vars['menu_group_href'] ?? ($vars['link_href'] ?? '#') }}" class="menu-link px-3">
                    ...
                    <div class="menu-sub menu-sub-dropdown w-175px py-4">
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a href="{{ $vars['menu_admin_href'] ?? ($vars['link_href'] ?? '#') }}" class="menu-link px-3">Admin Group</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a href="{{ $vars['menu_staff_href'] ?? ($vars['link_href'] ?? '#') }}" class="menu-link px-3">Staff Group</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a href="{{ $vars['menu_member_href'] ?? ($vars['link_href'] ?? '#') }}" class="menu-link px-3">Member Group</a>
                        </div>
                        <!--end::Menu item-->
                    </div>
                    <!--end::Menu sub-->
                ...
                <!--begin::Menu item-->
                <div class="menu-item px-3">
                    <a href="{{ $vars['menu_contact_href'] ?? ($vars['link_href'] ?? '#') }}" class="menu-link px-3">New Contact</a>
                </div>
                <!--end::Menu item-->
                <!--begin::Menu separator-->
                ...
                <div class="menu-item px-3">
                    <div class="menu-content px-3 py-3">
                        <a class="btn btn-primary btn-sm px-4" href="{{ $vars['menu_report_href'] ?? ($vars['link_href'] ?? '#') }}">Generate Reports</a>
                    </div>
                </div>
                <!--end::Menu item-->
            </div>
                ...
                <div class="table-responsive mx-9 mt-n6">
                    ...
                    <table class="table align-middle gs-0 gy-4">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <a href="{{ $vars['link_href'] ?? '#' }}" class="text-gray-600 fw-bold fs-6">2:30 PM</a>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <a href="{{ $vars['link_href'] ?? '#' }}" class="text-gray-600 fw-bold fs-6">3:10 PM</a>
                                </td>
                                <td class="pe-0 text-end">
                            ...
                            <tr>
                                <td>
                                    <a href="{{ $vars['link_href'] ?? '#' }}" class="text-gray-600 fw-bold fs-6">3:55 PM</a>
                                </td>
                                <td class="pe-0 text-end">
                ...
                <div class="table-responsive mx-9 mt-n6">
                    ...
                    <table class="table align-middle gs-0 gy-4">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <a href="{{ $vars['link_href'] ?? '#' }}" class="text-gray-600 fw-bold fs-6">4:30 PM</a>
                                </td>
                                <td class="pe-0 text-end">
                            ...
                            <tr>
                                <td>
                                    <a href="{{ $vars['link_href'] ?? '#' }}" class="text-gray-600 fw-bold fs-6">11:35
                                        AM</a>
                                </td>
                                <td class="pe-0 text-end">
                            ...
                            <tr>
                                <td>
                                    <a href="{{ $vars['link_href'] ?? '#' }}" class="text-gray-600 fw-bold fs-6">3:30 PM</a>
                                </td>
                                <td class="pe-0 text-end">
                ...
                <div class="table-responsive mx-9 mt-n6">
                    ...
                    <table class="table align-middle gs-0 gy-4">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <a href="{{ $vars['link_href'] ?? '#' }}" class="text-gray-600 fw-bold fs-6">3:20 AM</a>
                                </td>
                                <td class="pe-0 text-end">
                            ...
                            <tr>
                                <td>
                                    <a href="{{ $vars['link_href'] ?? '#' }}" class="text-gray-600 fw-bold fs-6">12:30
                                        AM</a>
                                </td>
                                <td class="pe-0 text-end">
                                    <span class="text-gray-800 fw-bold fs-6 me-1">$2,756.26</span>
                ...
                <div class="table-responsive mx-9 mt-n6">
                    ...
                    <table class="table align-middle gs-0 gy-4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a href="{{ $vars['link_href'] ?? '#' }}" class="text-gray-600 fw-bold fs-6">5:30 AM</a>
                                </td>
                                <td class="pe-0 text-end">
                                    <span class="text-gray-800 fw-bold fs-6 me-1">$1,756.26</span>
                                </td>
                ...
                <div class="table-responsive mx-9 mt-n6">
                    ...
                    <table class="table align-middle gs-0 gy-4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a href="{{ $vars['link_href'] ?? '#' }}" class="text-gray-600 fw-bold fs-6">3:30 AM</a>
                                </td>
                                <td class="pe-0 text-end">
                                    <span class="text-gray-800 fw-bold fs-6 me-1">$756.26</span>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <a href="{{ $vars['link_href'] ?? '#' }}" class="text-gray-600 fw-bold fs-6">10:30
                                        PM</a>
                                </td>
                                <td class="pe-0 text-end">
                                    <span class="text-gray-800 fw-bold fs-6 me-1">$1.756.26</span>
