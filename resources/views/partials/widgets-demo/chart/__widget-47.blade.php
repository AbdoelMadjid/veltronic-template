...
<i class="ki-outline ki-handcart text-white fs-1">
</i>
</div>
</div>
<!--end::Symbol-->
...
<a href="javascript:void(0)"                                            class="btn btn-sm btn-text-white bg-white bg-opacity-10"                                            style="border: 1px solid rgba(255, 255, 255, 0.20)">Today</a>
</div>
<!--end::Toolbar-->
</div>
<!--end::Header-->
...
<!--end::Block-->
<!--begin::Chart-->
<div id="kt_charts_widget_47" class="h-125px w-200px min-h-auto">
</div>
<!--end::Chart-->
</div>
<!--end::Wrapper-->
