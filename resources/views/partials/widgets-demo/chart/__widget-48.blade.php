...
<i class="ki-outline ki-handcart text-info fs-1">
</i>
</div>
</div>
<!--end::Symbol-->
...
<a href="javascript:void(0)" class="btn btn-sm btn-secondary">Month</a>
</div>
<!--end::Toolbar-->
</div>
<!--end::Header-->
...
<!--end::Wrapper-->
<!--begin::Chart-->
<div id="kt_charts_widget_48" class="h-125px w-200px min-h-auto">
</div>
<!--end::Chart-->
</div>
<!--end::Wrapper-->
