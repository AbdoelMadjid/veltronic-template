...
<div class="{{ $vars['card_class'] ?? 'card card-flush h-md-100' }}">
    <!--begin::Header-->
    <div class="{{ $vars['header_class'] ?? 'card-header flex-nowrap pt-5' }}">
        <!--begin::Title-->
        <h3 class="{{ $vars['title_wrapper_class'] ?? 'card-title align-items-start flex-column' }}">
            <span class="{{ $vars['title_class'] ?? 'card-label fw-bold text-gray-900' }}">{{ $vars['title'] ?? 'Top Selling Categories' }}</span>
            <span class="{{ $vars['subtitle_class'] ?? 'text-gray-500 pt-2 fw-semibold fs-6' }}">{{ $vars['subtitle'] ?? '8k social visitors' }}</span>
        </h3>
        <!--end::Title-->
        <!--begin::Toolbar-->
    ...
    <!--end::Header-->
    <!--begin::Body-->
    <div class="{{ $vars['body_class'] ?? 'card-body pt-5 ps-6' }}">
        <div id="{{ $vars['chart_id'] ?? 'kt_charts_widget_5' }}" class="{{ $vars['chart_class'] ?? 'min-h-auto' }}"></div>
    </div>
    <!--end::Body-->
</div>
<!--end::Chart widget 5-->
