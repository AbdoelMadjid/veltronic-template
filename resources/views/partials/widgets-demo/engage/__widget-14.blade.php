...
<i class="ki-outline ki-abstract-41 fs-5 text-white">
</i>
</span>
</div>
<!--end::Symbol-->
...
<div class="symbol symbol-30px symbol-circle me-3">
<span class="symbol-label" style="background: rgba(255, 255, 255, 0.1)">
<i class="ki-outline ki-abstract-26 fs-5 text-white">
</i>
</span>
</div>
<!--end::Symbol-->
...
<a href="javascript:void(0)" class="btn btn-success me-lg-2"                                            data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">Upgrade</a>
<a href="javascript:void(0)" class="btn text-white"                                            style="background: rgba(255, 255, 255, 0.2)" data-bs-toggle="modal"                                            data-bs-target="#kt_modal_create_app">Help</a>
</div>
<!--end::Action-->
</div>
<!--end::Col-->
...
<!--begin::Illustration-->
<div class="bgi-no-repeat bgi-size-contain bgi-position-x-end bgi-position-y-bottom h-325px"                                        style="background-image:url('{{ \App\Support\ThemeAsset::url('media/svg/illustrations/easy/8.svg', $theme_asset_pack ?? null) }}')">
</div>
<!--end::Illustration-->
</div>
<!--end::Col-->
