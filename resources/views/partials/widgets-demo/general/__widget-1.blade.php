...
@php
    ...
    $wrapper_class = $vars['wrapper_class'] ?? 'mb-10';
    $tabs_class = $vars['tabs_class'] ?? 'nav row mb-10';
    $tab_link_class =
        $vars['tab_link_class'] ??
        'nav-link btn btn-flex btn-color-gray-500 btn-outline btn-active-primary d-flex flex-grow-1 flex-column flex-center py-5 h-1250px h-lg-175px';
@endphp
<div class="{{ $wrapper_class }}">
    <!--begin::Tabs-->
    <ul class="{{ $tabs_class }}">
        <li class="nav-item col-12 col-lg mb-5 mb-lg-0">
            <a class="{{ $tab_link_class }}"
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                            data-kt-menu="true" id="kt_menu_65a10ad535ae2">
                            <!--begin::Header-->
                            <div class="px-7 py-5">
                                ...
                                <div class="mb-10">
                                    ...
                                    <div>
                                        <select class="form-select form-select-solid"
                                            ...
                                            data-dropdown-parent="#kt_menu_65a10ad535ae2"
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
                            ...
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="javascript:void(0)" class="menu-link flex-stack px-3">Create
                                    Payment
                                    ...
                                    <td>
                                        <div class="symbol symbol-50px me-2">
                                            <span class="symbol-label bg-light-warning">
                                                <i
                                                    class="ki-duotone ki-abstract-26 fs-2x text-warning">
                                                    <span class="path1"></span>
                                                    <span class="path2"></span>
                                                </i>
                                            </span>
                                    ...
                                    <td>
                                        <div class="symbol symbol-50px me-2">
                                            <span class="symbol-label bg-light-primary">
                                                <i
                                                    class="ki-duotone ki-abstract-41 fs-2x text-primary">
                                                    <span class="path1"></span>
                                                    <span class="path2"></span>
                                                </i>
                                            </span>
                                ...
                                <table class="table align-middle gs-0 gy-3">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="symbol symbol-50px">
                                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/avatars/043-boy-18.svg', $theme_asset_pack ?? null) }}"
                                                        alt="" />
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="symbol symbol-50px">
                                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/avatars/014-girl-7.svg', $theme_asset_pack ?? null) }}"
                                                        alt="" />
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="symbol symbol-50px">
                                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/avatars/018-girl-9.svg', $theme_asset_pack ?? null) }}"
                                                        alt="" />
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="symbol symbol-50px">
                                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/avatars/001-boy.svg', $theme_asset_pack ?? null) }}"
                                                        alt="" />
                                                </div>
                                            </td>
                                            <td>
                                ...
                                <table class="table align-middle gs-0 gy-3">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="symbol symbol-50px">
                                                    <img src="{{ \App\Support\ThemeAsset::url('media/svg/avatars/047-girl-25.svg', $theme_asset_pack ?? null) }}"
                                                        alt="" />
                                                </div>
                                            </td>
                                            <td>
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        <!--begin::Menu 1-->
                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                            data-kt-menu="true" id="kt_menu_65a10ad535fa1">
                            <!--begin::Header-->
                            <div class="px-7 py-5">
                                <div class="fs-5 text-gray-900 fw-bold">Filter Options</div>
                            </div>
                                ...
                                <div class="mb-10">
                                    ...
                                    <div>
                                        <select class="form-select form-select-solid"
                                            ...
                                            data-close-on-select="false"
                                            data-placeholder="Select option"
                                            data-dropdown-parent="#kt_menu_65a10ad535fa1"
                                            data-allow-clear="true">
                                            <option></option>
                                            <option value="1">Approved</option>
                                            <option value="2">Pending</option>
