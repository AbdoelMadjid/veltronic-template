    ...
    <div class="card-header border-0 pt-5">
        ...
        <div class="card-toolbar">
            ...
            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
                id="{{ $vars['menu_id'] ?? 'kt_menu_65a10bc439417' }}">
                <!--begin::Header-->
                <div class="px-7 py-5">
                    ...
                    <div class="mb-10">
                        ...
                        <div>
                            <select class="form-select form-select-solid" multiple="multiple"
                                ...
                                data-dropdown-parent="#{{ $vars['menu_id'] ?? 'kt_menu_65a10bc439417' }}" data-allow-clear="true">
                                <option></option>
    ...
    <div class="card-body pt-5">
        ...
        <div class="d-flex align-items-center mb-7">
            ...
            <div class="d-flex flex-column">
                <a href="{{ $vars['project_href'] ?? ($vars['item_href'] ?? 'javascript:void(0)') }}"
        ...
        <div class="d-flex align-items-center mb-7">
            ...
            <!--begin::Text-->
            <div class="d-flex flex-column">
                <a href="{{ $vars['concept_href'] ?? ($vars['item_href'] ?? 'javascript:void(0)') }}"
        ...
        <div class="d-flex align-items-center mb-7">
            ...
            <!--begin::Text-->
            <div class="d-flex flex-column">
                <a href="{{ $vars['logic_href'] ?? ($vars['item_href'] ?? 'javascript:void(0)') }}"
        ...
        <div class="d-flex align-items-center mb-7">
            ...
            <!--begin::Text-->
            <div class="d-flex flex-column">
                <a href="{{ $vars['development_href'] ?? ($vars['item_href'] ?? 'javascript:void(0)') }}"
        ...
        <div class="d-flex align-items-center">
            ...
            <!--begin::Text-->
            <div class="d-flex flex-column">
                <a href="{{ $vars['testing_href'] ?? ($vars['item_href'] ?? 'javascript:void(0)') }}"
