...
@php
    $widgetClass = $widgetClass ?? 'card card-flush h-lg-100';
    $linkHref = $linkHref ?? 'javascript:void(0)';
    $widgetId = $widgetId ?? uniqid('kt_list_widget_');
@endphp
...
<div class="{{ $widgetClass }}">
    ...
    <div class="card-header pt-7">
        ...
        <div class="card-toolbar">
            <a href="{{ $linkHref }}" class="btn btn-sm btn-light" data-bs-toggle='tooltip'
    ...
    <div class="card-body">
        ...
        <ul class="nav nav-pills nav-pills-custom row position-relative mx-0 mb-9">
            ...
            <li class="nav-item col-4 mx-0 p-0">
                ...
                <a class="nav-link active d-flex justify-content-center w-100 border-0 h-100"
                    data-bs-toggle="pill" href="#{{ $widgetId }}_tab_1">
                    <!--begin::Subtitle-->
            ...
            <li class="nav-item col-4 mx-0 px-0">
                ...
                <a class="nav-link d-flex justify-content-center w-100 border-0 h-100"
                    data-bs-toggle="pill" href="#{{ $widgetId }}_tab_2">
                    <!--begin::Subtitle-->
            ...
            <li class="nav-item col-4 mx-0 px-0">
                <!--begin::Link-->
                <a class="nav-link d-flex justify-content-center w-100 border-0 h-100"
                    data-bs-toggle="pill" href="#{{ $widgetId }}_tab_3">
                    <!--begin::Subtitle-->
        ...
        <div class="tab-content">
            <!--begin::Tap pane-->
            <div class="tab-pane fade show active" id="{{ $widgetId }}_tab_1">
                <!--begin::Item-->
                <div class="m-0">
                    <!--begin::Wrapper-->
            ...
            <!--end::Tap pane-->
            <!--begin::Tap pane-->
            <div class="tab-pane fade" id="{{ $widgetId }}_tab_2">
                <!--begin::Item-->
                <div class="m-0">
                    <!--begin::Wrapper-->
                    <div class="d-flex align-items-sm-center mb-5">
            ...
            <!--end::Tap pane-->
            <!--begin::Tap pane-->
            <div class="tab-pane fade" id="{{ $widgetId }}_tab_3">
                <!--begin::Item-->
                <div class="m-0">
                    <!--begin::Wrapper-->
                    <div class="d-flex align-items-sm-center mb-5">
