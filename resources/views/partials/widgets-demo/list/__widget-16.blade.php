    ...
    <div class="card-body">
        ...
        <div class="mb-6">
            ...
            <div class="row row-cols-3" data-kt-buttons="true"
                ...
                <div class="col mb-4">
                    <!--begin::Link-->
                    <a href="{{ url('apps/support-center/licenses') }}"
                        class="btn btn-icon btn-outline btn-bg-light btn-active-light-primary btn-flex flex-column flex-center w-lg-90px h-lg-90px w-70px h-70px border-gray-200"
                        data-kt-button="true">
                        <!--begin::Icon-->
                        <span class="mb-2">
                ...
                <div class="col mb-4">
                    <!--begin::Link-->
                    <a href="{{ url('apps/projects/budget') }}"
                        class="btn btn-icon btn-outline btn-bg-light btn-active-light-primary btn-flex flex-column flex-center w-lg-90px h-lg-90px w-70px h-70px border-gray-200"
                        data-kt-button="true">
                        <!--begin::Icon-->
                        <span class="mb-2">
                ...
                <div class="col mb-4">
                    <!--begin::Link-->
                    <a href="{{ url('apps/subscriptions/getting-started') }}"
                        class="btn btn-icon btn-outline btn-bg-light btn-active-light-primary btn-flex flex-column flex-center w-lg-90px h-lg-90px w-70px h-70px border-gray-200"
                        data-kt-button="true">
                        <!--begin::Icon-->
                        <span class="mb-2">
                ...
                <div class="col mb-4">
                    <!--begin::Link-->
                    <a href="{{ url('apps/contacts/getting-started') }}"
                        class="btn btn-icon btn-outline btn-bg-light btn-active-light-primary btn-flex flex-column flex-center w-lg-90px h-lg-90px w-70px h-70px border-gray-200"
                        data-kt-button="true">
                        <!--begin::Icon-->
                        <span class="mb-2">
                ...
                <div class="col mb-4">
                    <!--begin::Link-->
                    <a href="{{ url('apps/file-manager/folders') }}"
                        class="btn btn-icon btn-outline btn-bg-light btn-active-light-primary btn-flex flex-column flex-center w-lg-90px h-lg-90px w-70px h-70px border-gray-200"
                        data-kt-button="true">
                        <!--begin::Icon-->
                        <span class="mb-2">
                ...
                <div class="col mb-4">
                    <!--begin::Link-->
                    <a href="{{ url('apps/contacts/add-contact') }}"
