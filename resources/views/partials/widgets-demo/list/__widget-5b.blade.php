<!--begin::List Widget 5-->
@php
    $widgetClass = $widgetClass ?? 'card mb-10';
    $linkHref = $linkHref ?? 'javascript:void(0)';
    $menuId = $menuId ?? uniqid('kt_menu_list_widget_5_');
@endphp
        ...
        <div class="timeline-label">
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-content fw-bold text-gray-800 ps-3">Make deposit
                    <a href="{{ $linkHref }}" class="text-primary">USD 700</a>. to ESL
                </div>
                <!--end::Desc-->
            </div>
            <!--end::Item-->
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-content fw-semibold text-gray-800 ps-3">New order placed
                    <a href="{{ $linkHref }}" class="text-primary">#XF-2356</a>.
                </div>
                <!--end::Desc-->
            </div>
            <!--end::Item-->
