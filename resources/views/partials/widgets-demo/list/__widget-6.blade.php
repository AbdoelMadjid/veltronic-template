<!--begin::List Widget 6-->
@php
    $widgetClass = $widgetClass ?? 'card h-xl-100';
    ...
    <div class="card-body pt-0">
        ...
        <div class="d-flex align-items-center bg-light-warning rounded p-5 mb-7">
            ...
            <div class="flex-grow-1 me-2">
                <a href="{{ $linkHref }}"
                    class="fw-bold text-gray-800 text-hover-primary fs-6">Group lunch
                    celebration</a>
        ...
        <div class="d-flex align-items-center bg-light-success rounded p-5 mb-7">
            ...
            <div class="flex-grow-1 me-2">
                <a href="{{ $linkHref }}"
                    class="fw-bold text-gray-800 text-hover-primary fs-6">Navigation
                    optimization</a>
                <span class="text-muted fw-semibold d-block">Due in 2 Days</span>
            </div>
            <!--end::Title-->
        ...
        <div class="d-flex align-items-center bg-light-danger rounded p-5 mb-7">
            ...
            <div class="flex-grow-1 me-2">
                <a href="{{ $linkHref }}"
                    class="fw-bold text-gray-800 text-hover-primary fs-6">Rebrand
                    strategy planning</a>
        ...
        <div class="d-flex align-items-center bg-light-info rounded p-5">
            ...
            <div class="flex-grow-1 me-2">
                <a href="{{ $linkHref }}"
                    class="fw-bold text-gray-800 text-hover-primary fs-6">Product goals
                    strategy</a>
