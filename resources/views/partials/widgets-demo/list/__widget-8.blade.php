<!--begin::List widget 8-->
@php
    $widgetClass = $widgetClass ?? 'card card-flush h-xl-100';
...
<div class="{{ $widgetClass }}">
    ...
    <div class="card-header pt-7 mb-5">
        ...
        <div class="card-toolbar">
            <a href="{{ url('apps/ecommerce/sales/listing') }}" class="btn btn-sm btn-light">View
                All</a>
        </div>
        <!--end::Toolbar-->
    </div>
    ...
    <div class="card-body pt-0">
        ...
        <div class="m-0">
            ...
            <div class="d-flex flex-stack">
                <!--begin::Flag-->
                <img src="{{ \App\Support\ThemeAsset::url('media/flags/brazil.svg', $theme_asset_pack ?? null) }}"
                    class="me-4 w-25px" style="border-radius: 4px" alt="" />
                <!--end::Flag-->
                <!--begin::Section-->
                <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
            ...
            <div class="d-flex flex-stack">
                <!--begin::Flag-->
                <img src="{{ \App\Support\ThemeAsset::url('media/flags/turkey.svg', $theme_asset_pack ?? null) }}"
                    class="me-4 w-25px" style="border-radius: 4px" alt="" />
                <!--end::Flag-->
                <!--begin::Section-->
                <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
            ...
            <div class="d-flex flex-stack">
                <!--begin::Flag-->
                <img src="{{ \App\Support\ThemeAsset::url('media/flags/france.svg', $theme_asset_pack ?? null) }}"
                    class="me-4 w-25px" style="border-radius: 4px" alt="" />
                <!--end::Flag-->
                <!--begin::Section-->
                <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
            ...
            <div class="d-flex flex-stack">
                <!--begin::Flag-->
                <img src="{{ \App\Support\ThemeAsset::url('media/flags/india.svg', $theme_asset_pack ?? null) }}"
                    class="me-4 w-25px" style="border-radius: 4px" alt="" />
                <!--end::Flag-->
                <!--begin::Section-->
                <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
            ...
            <div class="d-flex flex-stack">
                <!--begin::Flag-->
                <img src="{{ \App\Support\ThemeAsset::url('media/flags/sweden.svg', $theme_asset_pack ?? null) }}"
                    class="me-4 w-25px" style="border-radius: 4px" alt="" />
                <!--end::Flag-->
                <!--begin::Section-->
                <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
