...
<div class="{{ $widgetClass }}">
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px"
                ...
                <div class="menu-item px-3" data-kt-menu-trigger="hover"
                    ...
                    <div class="menu-sub menu-sub-dropdown w-175px py-4">
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a href="{{ $linkHref }}" class="menu-link px-3">Admin
                                Group</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a href="{{ $linkHref }}" class="menu-link px-3">Staff
                                Group</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a href="{{ $linkHref }}" class="menu-link px-3">Member
                                Group</a>
                        </div>
                        <!--end::Menu item-->
                    </div>
    ...
    <div class="card-body card-body d-flex justify-content-between flex-column pt-3">
        ...
        <div class="d-flex flex-stack">
            <!--begin::Flag-->
            <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/linkedin-1.svg', $theme_asset_pack ?? null) }}"
                class="me-4 w-30px" style="border-radius: 4px" alt="" />
            <!--end::Flag-->
            <!--begin::Section-->
            <div
                ...
                <div class="me-5">
                    <!--begin::Title-->
                    <a href="{{ $linkHref }}"
                        class="text-gray-800 fw-bold text-hover-primary fs-6">Linked In</a>
                    <!--end::Title-->
                    <!--begin::Desc-->
        ...
        <div class="d-flex flex-stack">
            <!--begin::Flag-->
            <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/slack-icon.svg', $theme_asset_pack ?? null) }}"
                class="me-4 w-30px" style="border-radius: 4px" alt="" />
            <!--end::Flag-->
            <!--begin::Section-->
            <div
