    ...
    <div class="card-body pt-5">
        ...
        <div class="d-flex mb-7">
            ...
            <div class="d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1">
                ...
                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                    <a href="#"
                        class="fs-5 text-gray-800 text-hover-primary fw-bold">Cup & Green</a>
        ...
        <div class="d-flex mb-7">
            ...
            <div class="d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1">
                ...
                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                    <a href="#"
                        class="fs-5 text-gray-800 text-hover-primary fw-bold">Yellow Hearts</a>
                    <span class="text-gray-500 fw-semibold fs-7 my-1">Study highway
                        types</span>
                    <span class="text-gray-500 fw-semibold fs-7">By:
        ...
        <div class="d-flex mb-7">
            ...
            <div class="d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1">
                ...
                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                    <a href="#"
                        class="fs-5 text-gray-800 text-hover-primary fw-bold">Nike & Blue</a>
                    <span class="text-gray-500 fw-semibold fs-7 my-1">Study highway
                        types</span>
                    <span class="text-gray-500 fw-semibold fs-7">By:
        ...
        <div class="d-flex mb-7">
            ...
            <div class="d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1">
                ...
                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
                    <a href="#"
                        class="fs-5 text-gray-800 text-hover-primary fw-bold">Red Boots</a>
                    <span class="text-gray-500 fw-semibold fs-7 my-1">Study highway
                        types</span>
                    <span class="text-gray-500 fw-semibold fs-7">By:
