@php($vars = $vars ?? [])
                    ...
                    <div class="card h-md-100">
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <div>
                                                <select class="form-select form-select-solid" multiple="multiple"
                                                    ...
                                                    data-dropdown-parent="{{ $vars["p43_0"] ?? "#kt_menu_65a10bfcd07e3" }}" data-allow-clear="true">
                                                    <option></option>
                        ...
                        <div class="card-body p-0 d-flex flex-column">
                            ...
                            <!--end::Stats-->
                            <!--begin::Chart-->
                            <div class="mixed-widget-6-chart card-rounded-bottom" data-kt-chart-color="{{ $vars["p224_1"] ?? "danger" }}"
