...
<div class="{{ $cardClass }}">
    ...
    <div class="card-header pt-7">
        ...
        <div class="card-toolbar">
            <a href="{{ url('apps/ecommerce/catalog/add-product') }}"
                ...
                <tbody>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="symbol symbol-50px me-3">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-49.jpg', $theme_asset_pack ?? null) }}"
                                        class="" alt="" />
                                </div>
                                <div class="d-flex justify-content-start flex-column">
                                    <a href="javascript:void(0)"
                                        class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">The
                                        Art</a>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="symbol symbol-50px me-3">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-43.jpg', $theme_asset_pack ?? null) }}"
                                        class="" alt="" />
                                </div>
                                <div class="d-flex justify-content-start flex-column">
                                    <a href="javascript:void(0)"
                                        class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Blue
                                        Bubble Art</a>
                                    <span class="text-gray-500 fw-semibold d-block fs-7">Guy
                                        Hawkins</span>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="symbol symbol-50px me-3">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-46.jpg', $theme_asset_pack ?? null) }}"
                                        class="" alt="" />
                                </div>
                                <div class="d-flex justify-content-start flex-column">
                                    <a href="javascript:void(0)"
                                        class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Color
                                        Face Art</a>
                                    <span class="text-gray-500 fw-semibold d-block fs-7">Wade
                                        Warren</span>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="symbol symbol-50px me-3">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-54.jpg', $theme_asset_pack ?? null) }}"
                                        class="" alt="" />
                                </div>
                                <div class="d-flex justify-content-start flex-column">
                                    <a href="javascript:void(0)"
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="symbol symbol-50px me-3">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-45.jpg', $theme_asset_pack ?? null) }}"
                                        class="" alt="" />
                                </div>
                                <div class="d-flex justify-content-start flex-column">
                                    <a href="javascript:void(0)"
                                        class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Awesome
                                        Bird Art</a>
                                    <span class="text-gray-500 fw-semibold d-block fs-7">Jacob
                                        Jones</span>
                                </div>
                            </div>
                        </td>
