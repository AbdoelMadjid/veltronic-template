@php
    $vars = $vars ?? [];
    $iconVariant = $vars['iconVariant'] ?? ($iconVariant ?? 'outline');
    $iconPrefix = $iconVariant === 'duotone' ? 'ki-duotone' : 'ki-outline';
@endphp
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_4_table">
            ...
            <tbody class="fw-bold text-gray-600">
                    ...
                    <td colspan="2">
                        <div class="d-flex align-items-center gap-3">
                            <a href="javascript:void(0)"
                                ...
                                <img src=""
                                    data-kt-src-path="{{ asset(\App\Support\ThemeVersion::assetBase($theme_asset_pack ?? null) . '/media/stock/ecommerce/') }}"
                ...
                <tr>
                    ...
                    <td class="text-end">
                        <a href="javascript:void(0)" class="text-gray-600 text-hover-primary">Albert
                            Flores</a>
                    </td>
                    ...
                    <td class="text-end">
                        <button type="button"
                            ...
                            <i class="{{ $iconPrefix }} ki-plus fs-4 m-0 toggle-off"></i>
                            <i class="{{ $iconPrefix }} ki-minus fs-4 m-0 toggle-on"></i>
                        </button>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="text-end">
                        <a href="javascript:void(0)" class="text-gray-600 text-hover-primary">Jenny
                            Wilson</a>
                    </td>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        <a href="javascript:void(0)" class="text-gray-600 text-hover-primary">Robert
                            Fox</a>
                    </td>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        <a href="javascript:void(0)" class="text-gray-600 text-hover-primary">Cody
                            Fisher</a>
                    </td>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        <a href="javascript:void(0)" class="text-gray-600 text-hover-primary">Arlene
                            McCoy</a>
                    </td>
                ...
                <tr>
                    ...
                    <td class="text-end">2 day ago</td>
                    <td class="text-end">
                        <a href="javascript:void(0)" class="text-gray-600 text-hover-primary">Eleanor
                            Pena</a>
                    </td>
                ...
                <tr>
                    ...
                    <td class="text-end">7 min ago</td>
                    <td class="text-end">
                        <a href="javascript:void(0)" class="text-gray-600 text-hover-primary">Dan
                            Wilson</a>
                    </td>
