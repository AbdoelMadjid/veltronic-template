...
<a href="javascript:void(0)"                                                            class="text-gray-900 fw-bold text-hover-primary mb-1 fs-6">Emma                                                            Smith</a>
<a href="javascript:void(0)"                                                            class="text-muted text-hover-primary fw-semibold text-muted d-block fs-7">
...
<td class="text-end">
<a href="javascript:void(0)"                                                    class="text-gray-900 fw-bold text-hover-primary d-block mb-1 fs-6">$560,000</a>
...
<!--begin::Name-->
<div class="d-flex justify-content-start flex-column">
<a href="javascript:void(0)"                                                            class="text-gray-900 fw-bold text-hover-primary mb-1 fs-6">Melody                                                            Macy</a>
<a href="javascript:void(0)"                                                            class="text-muted text-hover-primary fw-semibold text-muted d-block fs-7">
...
<td class="text-end">
<a href="javascript:void(0)"                                                    class="text-gray-900 fw-bold text-hover-primary d-block mb-1 fs-6">$2,000,000</a>
<span class="text-muted fw-semibold text-muted d-block fs-7">Paid</span>
</td>
...
<!--begin::Name-->
<div class="d-flex justify-content-start flex-column">
<a href="javascript:void(0)"                                                            class="text-gray-900 fw-bold text-hover-primary mb-1 fs-6">Max                                                            Smith</a>
<a href="javascript:void(0)"                                                            class="text-muted text-hover-primary fw-semibold text-muted d-block fs-7">
...
<td class="text-end">
<a href="javascript:void(0)"                                                    class="text-gray-900 fw-bold text-hover-primary d-block mb-1 fs-6">$760,000</a>
<span class="text-muted fw-semibold text-muted d-block fs-7">Paid</span>
</td>
...
<!--begin::Name-->
<div class="d-flex justify-content-start flex-column">
<a href="javascript:void(0)"                                                            class="text-gray-900 fw-bold text-hover-primary mb-1 fs-6">Sean                                                            Bean</a>
<a href="javascript:void(0)"                                                            class="text-muted text-hover-primary fw-semibold text-muted d-block fs-7">
...
<td class="text-end">
<a href="javascript:void(0)"                                                    class="text-gray-900 fw-bold text-hover-primary d-block mb-1 fs-6">$257,000</a>
<span class="text-muted fw-semibold text-muted d-block fs-7">Paid</span>
</td>
...
<!--begin::Name-->
<div class="d-flex justify-content-start flex-column">
<a href="javascript:void(0)"                                                            class="text-gray-900 fw-bold text-hover-primary mb-1 fs-6">Brian                                                            Cox</a>
<a href="javascript:void(0)"                                                            class="text-muted text-hover-primary fw-semibold text-muted d-block fs-7">
