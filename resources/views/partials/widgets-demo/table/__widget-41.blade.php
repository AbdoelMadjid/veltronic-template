...
@php
    $vars = $vars ?? [];
    $card_class = $vars['card_class'] ?? 'card card-flush h-xl-100';
    $profile_href = $vars['profile_href'] ?? url('pages/general/user-profile/overview');
    $view_href = $vars['view_href'] ?? 'javascript:void(0)';
@endphp
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-50px me-3">
                                            <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-7.jpg', $theme_asset_pack ?? null) }}"
                                                class="" alt="" />
                                        </div>
                                        <div class="d-flex justify-content-start flex-column">
                                            <a href="{{ $profile_href }}"
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-50px me-3">
                                            <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-24.jpg', $theme_asset_pack ?? null) }}"
                                                class="" alt="" />
                                        </div>
                                        <div class="d-flex justify-content-start flex-column">
                                            <a href="{{ $profile_href }}"
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-50px me-3">
                                            <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-17.jpg', $theme_asset_pack ?? null) }}"
                                                class="" alt="" />
                                        </div>
                                        <div class="d-flex justify-content-start flex-column">
                                            <a href="{{ $profile_href }}"
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-50px me-3">
                                            <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-11.jpg', $theme_asset_pack ?? null) }}"
                                                class="" alt="" />
                                        </div>
                                        <div class="d-flex justify-content-start flex-column">
                                            <a href="{{ $profile_href }}"
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-50px me-3">
                                            <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-12.jpg', $theme_asset_pack ?? null) }}"
                                                class="" alt="" />
                                        </div>
                                        <div class="d-flex justify-content-start flex-column">
                                            <a href="{{ $profile_href }}"
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="symbol symbol-50px me-3">
                                            <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-30.jpg', $theme_asset_pack ?? null) }}"
                                                class="" alt="" />
                                        </div>
                                        <div class="d-flex justify-content-start flex-column">
                                            <a href="{{ $profile_href }}"
