@php
    $vars = $vars ?? [];
    $cardClass = $vars['card_class'] ?? ($cardClass ?? 'card card-flush h-xl-100');
    $title = $vars['title'] ?? ($title ?? 'Stock Report');
    $subtitle = $vars['subtitle'] ?? ($subtitle ?? 'Total 2,356 Items in the Stock');
    $viewStockHref = $vars['view_stock_href'] ?? ($viewStockHref ?? url('apps/ecommerce/catalog/products'));
@endphp
    ...
    <div class="card-header pt-7">
        ...
        <div class="card-toolbar">
            ...
            <div class="d-flex flex-stack flex-wrap gap-4">
                ...
                <!--end::Status-->
                <!--begin::Search-->
                <a href="{{ $viewStockHref }}"
                    class="btn btn-light btn-sm">View
                    Stock</a>
                <!--end::Search-->
            </div>
            <!--begin::Filters-->
