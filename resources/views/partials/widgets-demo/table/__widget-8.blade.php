...
<!--end::Title-->
<!--begin::Bullet-->
<span                                            class="bullet-custom position-absolute z-index-2 w-100 h-2px top-100 bottom-n100 bg-primary rounded">
</span>
<!--end::Bullet-->
</a>
<!--end::Nav link-->
...
<th class="min-w-100px p-0">
</th>
<th class="min-w-80px p-0">
</th>
</tr>
</thead>
<!--end::Table head-->
...
<td class="fs-6 fw-bold text-gray-500">lesson 1:                                                        <span class="text-gray-800">French class</span>
</td>
<td class="fs-6 fw-bold text-gray-500">Cabinet:                                                        <span class="text-gray-800">5</span>
</td>
...
<td class="fs-6 fw-bold text-gray-500">lesson 2:                                                        <span class="text-gray-800">Physics class</span>
</td>
<td class="fs-6 fw-bold text-gray-500">Cabinet:                                                        <span class="text-gray-800">13</span>
</td>
<td class="pe-0 text-end">
<button class="btn btn-sm btn-light">Skip</button>
</td>
...
<td class="fs-6 fw-bold text-gray-500">lesson 3:                                                        <span class="text-gray-800">Chemistry class</span>
</td>
<td class="fs-6 fw-bold text-gray-500">Court:                                                        <span class="text-gray-800">Main</span>
</td>
<td class="pe-0 text-end">
<button class="btn btn-sm btn-light">Skip</button>
</td>
...
<td class="fs-6 fw-bold text-gray-500">lesson 4:                                                        <span class="text-gray-800">Biology class</span>
<!--begin::Icon-->
...
<td class="fs-6 fw-bold text-gray-500">Cabinet:                                                        <span class="text-gray-800">23</span>
</td>
<td class="pe-0 text-end">
<button class="btn btn-sm btn-light">Skip</button>
</td>
...
<td class="fs-6 fw-bold text-gray-500">lesson 1:                                                        <span class="text-gray-800">Geography class</span>
</td>
<td class="fs-6 fw-bold text-gray-500">Cabinet:                                                        <span class="text-gray-800">45</span>
</td>
<td class="pe-0 text-end">
<button class="btn btn-sm btn-light">Skip</button>
</td>
...
<td class="fs-6 fw-bold text-gray-500">lesson 2:                                                        <span class="text-gray-800">English class</span>
</td>
<td class="fs-6 fw-bold text-gray-500">Cabinet:                                                        <span class="text-gray-800">9</span>
</td>
<td class="pe-0 text-end">
<button class="btn btn-sm btn-light">Skip</button>
</td>
...
<td class="fs-6 fw-bold text-gray-500">lesson 3:                                                        <span class="text-gray-800">Sports class</span>
</td>
<td class="fs-6 fw-bold text-gray-500">Court:                                                        <span class="text-gray-800">Main</span>
</td>
<td class="pe-0 text-end">
...
<td class="fs-6 fw-bold text-gray-500">lesson 4:                                                        <span class="text-gray-800">Picture class</span>
<!--begin::Icon-->
...
<td class="fs-6 fw-bold text-gray-500">Cabinet:                                                        <span class="text-gray-800">12</span>
</td>
<td class="pe-0 text-end">
<button class="btn btn-sm btn-light">Skip</button>
</td>
...
<td class="fs-6 fw-bold text-gray-500">lesson 1:                                                        <span class="text-gray-800">Math class</span>
</td>
<td class="fs-6 fw-bold text-gray-500">Cabinet:                                                        <span class="text-gray-800">45</span>
</td>
<td class="pe-0 text-end">
...
<td class="fs-6 fw-bold text-gray-500">lesson 2:                                                        <span class="text-gray-800">History class</span>
</td>
<td class="fs-6 fw-bold text-gray-500">Cabinet:                                                        <span class="text-gray-800">12</span>
</td>
<td class="pe-0 text-end">
...
<td class="fs-6 fw-bold text-gray-500">lesson 4:                                                        <span class="text-gray-800">Chemistry class</span>
<!--begin::Icon-->
...
<td class="fs-6 fw-bold text-gray-500">Cabinet:                                                        <span class="text-gray-800">19</span>
</td>
<td class="pe-0 text-end">
<button class="btn btn-sm btn-light">Skip</button>
</td>
...
<td class="fs-6 fw-bold text-gray-500">Cabinet:                                                        <span class="text-gray-800">15</span>
</td>
<td class="pe-0 text-end">
<button class="btn btn-sm btn-light">Skip</button>
</td>
...
<!--begin::Action-->
<div class="float-end">
<a href="javascript:void(0)" class="btn btn-sm btn-light me-2" data-bs-toggle="modal"                                    data-bs-target="#kt_modal_create_project">Add Lesson</a>
<a href="javascript:void(0)" class="btn btn-sm btn-danger" data-bs-toggle="modal"                                    data-bs-target="#kt_modal_create_app">Call Sick for Today</a>
</div>
<!--end::Action-->
</div>
<!--end: Card Body-->
