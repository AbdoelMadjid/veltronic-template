                    ...
                    <table class="table align-middle gs-0 gy-4">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:void(0)" class="text-gray-800 text-hover-primary fw-bold fs-6">Book p.
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:void(0)" class="text-gray-800 text-hover-primary fw-bold fs-6">Workbook p.
                                        17, tasks 1-6</a>
                            ...
                            <tr>
                                ...
                                <td class="ps-0">
                                    <div class="form-check form-check-custom form-check-success form-check-solid">
                                        <input class="form-check-input" type="checkbox" value=""
                                            checked="checked" data-kt-element="checkbox" />
                                    </div>
                                </td>
                                <td>
                                    <a href="javascript:void(0)" class="text-gray-800 text-hover-primary fw-bold fs-6">Learn
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:void(0)" class="text-gray-800 text-hover-primary fw-bold fs-6">Write
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:void(0)" class="text-gray-800 text-hover-primary fw-bold fs-6">Internal
                    ...
                    <table class="table align-middle gs-0 gy-4">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:void(0)" class="text-gray-800 text-hover-primary fw-bold fs-6">Workbook
                                        p. 17, tasks 1-6</a>
                                    <span class="text-gray-500 fw-bold fs-7 d-block">Mathematics</span>
                                </td>
                                <td class="text-end">
