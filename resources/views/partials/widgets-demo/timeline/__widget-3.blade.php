...
<div class="card h-md-100">
    ...
    <div class="card-header border-0 pt-5">
        ...
        <div class="card-toolbar">
            <a href="javascript:void(0)" class="btn btn-sm btn-light">Report Cecnter</a>
        </div>
        <!--end::Toolbar-->
    </div>
    <!--end::Header-->
    ...
    <div class="card-body pt-7 px-0">
            ...
            <div class="tab-pane fade" id="kt_timeline_widget_3_tab_content_1">
                ...
                <div class="d-flex align-items-center mb-6">
                    ...
                    <div class="flex-grow-1 me-5">
                        ...
                        <div class="text-gray-500 fw-semibold fs-7">Lead by
                            <!--begin::Name-->
                            <a href="javascript:void(0)" class="text-primary opacity-75-hover fw-semibold">Peter Marcus</a>
                            <!--end::Name-->
                        </div>
                        <!--end::Link-->
                    </div>
                ...
                <div class="d-flex align-items-center mb-6">
                    ...
                    <div class="flex-grow-1 me-5">
                        ...
                        <div class="text-gray-500 fw-semibold fs-7">Lead by
                            <!--begin::Name-->
                            <a href="javascript:void(0)" class="text-primary opacity-75-hover fw-semibold">Lead by Bob</a>
                            <!--end::Name-->
                        </div>
                        <!--end::Link-->
                    </div>
                ...
                <div class="d-flex align-items-center mb-6">
                    ...
                    <div class="flex-grow-1 me-5">
                        ...
                        <div class="text-gray-500 fw-semibold fs-7">Lead by
                            <!--begin::Name-->
                            <a href="javascript:void(0)" class="text-primary opacity-75-hover fw-semibold">Lead by Mark
                                Morris</a>
                            <!--end::Name-->
                        </div>
                        <!--end::Link-->
        ...
        <div class="float-end d-none">
            <a href="javascript:void(0)" class="btn btn-sm btn-light me-2" data-bs-toggle="modal"
