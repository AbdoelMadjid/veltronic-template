@php
    $widget1CardClass = $widget1CardClass ?? 'card card-flush border-0 h-xl-100';
    $widget1BackgroundColor = $widget1BackgroundColor ?? '#22232B';
    $widget1BorderOpacity = $widget1BorderOpacity ?? '0.15';
    $widget1ChartColor = $widget1ChartColor ?? 'primary';
@endphp
<!--begin::Card widget 1-->
<div class="{{ $widget1CardClass }}" data-bs-theme="light" style="background-color: {{ $widget1BackgroundColor }}">
	<!--begin::Header-->
	...
	<div class="card-body d-flex justify-content-between flex-column pt-1 px-0 pb-0">
		...
		<div class="d-flex flex-wrap px-9 mb-5">
			<!--begin::Stat-->
			<div class="rounded min-w-125px py-3 px-4 my-1 me-6" style="border: 1px dashed rgba(255, 255, 255, {{ $widget1BorderOpacity }})">
				<!--begin::Number-->
			...
			<!--end::Stat-->
			<!--begin::Stat-->
			<div class="rounded min-w-125px py-3 px-4 my-1" style="border: 1px dashed rgba(255, 255, 255, {{ $widget1BorderOpacity }})">
				<!--begin::Number-->
				<div class="d-flex align-items-center">
		...
		<!--end::Wrapper-->
		<!--begin::Chart-->
		<div id="kt_card_widget_1_chart" data-kt-chart-color="{{ $widget1ChartColor }}" style="height: 105px"></div>
		<!--end::Chart-->
	</div>
	<!--end::Body-->
</div>
