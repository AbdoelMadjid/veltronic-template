@php
    $chart24CardClass = $chart24CardClass ?? 'card card-flush overflow-hidden h-xl-100';
    $chart24ChartHeight = $chart24ChartHeight ?? '300px';
@endphp
<!--begin::Chart widget 24-->
<div class="{{ $chart24CardClass }}">
	<!--begin::Header-->
	...
	<div class="card-body pt-0">
		<!--begin::Chart-->
		<div id="kt_charts_widget_24" class="min-h-auto" style="height: {{ $chart24ChartHeight }}"></div>
		<!--end::Chart-->
	</div>
	<!--end::Card body-->
</div>
