	...
	<div class="card-body py-0 px-0">
		...
		<ul class="nav d-flex justify-content-between mb-3 mx-9">
			...
			<li class="nav-item mb-3">
				...
				<a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px active"
					data-bs-toggle="tab" id="kt_charts_widget_33_tab_1" href="#kt_charts_widget_33_tab_content_1">1d</a>
				<!--end::Link-->
			</li>
			<!--end::Item-->
			<!--begin::Item-->
			<li class="nav-item mb-3">
				...
				<a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px"
					data-bs-toggle="tab" id="kt_charts_widget_33_tab_2" href="#kt_charts_widget_33_tab_content_2">5d</a>
				<!--end::Link-->
			</li>
			<!--end::Item-->
			<!--begin::Item-->
			<li class="nav-item mb-3">
				<!--begin::Link-->
				<a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px"
					data-bs-toggle="tab" id="kt_charts_widget_33_tab_3" href="#kt_charts_widget_33_tab_content_3">1m</a>
				<!--end::Link-->
			</li>
			<!--end::Item-->
			<!--begin::Item-->
			<li class="nav-item mb-3">
				<!--begin::Link-->
				<a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px"
					data-bs-toggle="tab" id="kt_charts_widget_33_tab_4" href="#kt_charts_widget_33_tab_content_4">6m</a>
				<!--end::Link-->
			</li>
			<!--end::Item-->
			<!--begin::Item-->
			<li class="nav-item mb-3">
				<!--begin::Link-->
				<a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px"
					data-bs-toggle="tab" id="kt_charts_widget_33_tab_5" href="#kt_charts_widget_33_tab_content_5">1y</a>
				<!--end::Link-->
			</li>
			<!--end::Item-->
		</ul>
		...
		<div class="tab-content mt-n6">
				...
				<div class="table-responsive mx-9 mt-n6">
					...
					<table class="table align-middle gs-0 gy-4">
						...
						<tbody>
							<tr>
								<td>
									<a href="javascript:void(0)" class="text-gray-600 fw-bold fs-6">2:30 PM</a>
								</td>
							...
							<tr>
								<td>
									<a href="javascript:void(0)" class="text-gray-600 fw-bold fs-6">3:10 PM</a>
								</td>
								<td class="pe-0 text-end">
							...
							<tr>
								<td>
									<a href="javascript:void(0)" class="text-gray-600 fw-bold fs-6">3:55 PM</a>
								</td>
								<td class="pe-0 text-end">
			...
			<div class="tab-pane fade" id="kt_charts_widget_33_tab_content_3">
				<!--begin::Chart-->
				<div id="kt_charts_widget_33_chart_3" data-kt-chart-color="info" class="min-h-auto h-200px ps-3 pe-6">
				</div>
				<!--end::Chart-->
				<!--begin::Table container-->
				<div class="table-responsive mx-9 mt-n6">
					...
					<table class="table align-middle gs-0 gy-4">
						...
						<tbody>
							<tr>
								<td>
									<a href="javascript:void(0)" class="text-gray-600 fw-bold fs-6">12:40 AM</a>
								</td>
								<td class="pe-0 text-end">
							...
							<tr>
								<td>
									<a href="javascript:void(0)" class="text-gray-600 fw-bold fs-6">11:30 PM</a>
								</td>
								<td class="pe-0 text-end">
							...
							<tr>
								<td>
									<a href="javascript:void(0)" class="text-gray-600 fw-bold fs-6">4:25 PM</a>
								</td>
								<td class="pe-0 text-end">
									<span class="text-gray-800 fw-bold fs-6 me-1">$2,756.26</span>
								</td>
			...
			<div class="tab-pane fade" id="kt_charts_widget_33_tab_content_4">
				<!--begin::Chart-->
				<div id="kt_charts_widget_33_chart_4" data-kt-chart-color="info" class="min-h-auto h-200px ps-3 pe-6">
				</div>
				<!--end::Chart-->
				<!--begin::Table container-->
				<div class="table-responsive mx-9 mt-n6">
					...
					<table class="table align-middle gs-0 gy-4">
						...
						<tbody>
							<tr>
								<td>
									<a href="javascript:void(0)" class="text-gray-600 fw-bold fs-6">3:20 PM</a>
								</td>
								<td class="pe-0 text-end">
							...
							<tr>
								<td>
									<a href="javascript:void(0)" class="text-gray-600 fw-bold fs-6">10:30 AM</a>
								</td>
								<td class="pe-0 text-end">
							...
							<tr>
								<td>
									<a href="javascript:void(0)" class="text-gray-600 fw-bold fs-6">1:30 AM</a>
								</td>
								<td class="pe-0 text-end">
									<span class="text-gray-800 fw-bold fs-6 me-1">$2,756.26</span>
								</td>
			...
			<div class="tab-pane fade" id="kt_charts_widget_33_tab_content_5">
				<!--begin::Chart-->
				<div id="kt_charts_widget_33_chart_5" data-kt-chart-color="info" class="min-h-auto h-200px ps-3 pe-6">
				</div>
				<!--end::Chart-->
				<!--begin::Table container-->
				<div class="table-responsive mx-9 mt-n6">
					...
					<table class="table align-middle gs-0 gy-4">
						...
						<tbody>
							<tr>
								<td>
									<a href="javascript:void(0)" class="text-gray-600 fw-bold fs-6">3:30 PM</a>
								</td>
								<td class="pe-0 text-end">
							...
							<tr>
								<td>
									<a href="javascript:void(0)" class="text-gray-600 fw-bold fs-6">12:30 AM</a>
								</td>
								<td class="pe-0 text-end">
