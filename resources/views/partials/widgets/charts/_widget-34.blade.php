	...
	<div class="card-body py-0 px-0">
		...
		<div class="tab-content mt-n6">
				...
				<div class="table-responsive mx-9 mt-n6">
					...
					<table class="table align-middle gs-0 gy-4">
						...
						<tbody>
							<tr>
								<td>
									<a href="javascript:void(0)" class="text-gray-600 fw-bold fs-6">Donates</a>
								</td>
							...
							<tr>
								<td>
									<a href="javascript:void(0)" class="text-gray-600 fw-bold fs-6">Podcasts</a>
								</td>
								<td class="pe-0 text-end">
			...
			<div class="tab-pane fade" id="kt_charts_widget_34_tab_content_4">
				<!--begin::Chart-->
				<div id="kt_charts_widget_34_chart_4" data-kt-chart-color="info" class="min-h-auto h-200px ps-3 pe-6">
				</div>
				<!--end::Chart-->
				<!--begin::Table container-->
				<div class="table-responsive mx-9 mt-n6">
			...
			<div class="tab-pane fade" id="kt_charts_widget_34_tab_content_5">
				<!--begin::Chart-->
				<div id="kt_charts_widget_34_chart_5" data-kt-chart-color="info" class="min-h-auto h-200px ps-3 pe-6">
				</div>
				<!--end::Chart-->
				<!--begin::Table container-->
				<div class="table-responsive mx-9 mt-n6">
