	...
	<div class="card-body py-0 px-0">
		...
		<div class="tab-content mt-n6">
			...
			<div class="tab-pane fade" id="kt_charts_widget_37_tab_content_2">
				<!--begin::Chart-->
				<div id="kt_charts_widget_37_chart_2" data-kt-chart-color="danger" class="min-h-auto h-200px ps-3 pe-6">
				</div>
				<!--end::Chart-->
				<!--begin::Table container-->
				<div class="table-responsive mx-9 mt-n6">
			...
			<div class="tab-pane fade" id="kt_charts_widget_37_tab_content_3">
				<!--begin::Chart-->
				<div id="kt_charts_widget_37_chart_3" data-kt-chart-color="danger" class="min-h-auto h-200px ps-3 pe-6">
				</div>
				<!--end::Chart-->
				<!--begin::Table container-->
				<div class="table-responsive mx-9 mt-n6">
			...
			<div class="tab-pane fade" id="kt_charts_widget_37_tab_content_4">
				<!--begin::Chart-->
				<div id="kt_charts_widget_37_chart_4" data-kt-chart-color="danger" class="min-h-auto h-200px ps-3 pe-6">
				</div>
				<!--end::Chart-->
				<!--begin::Table container-->
				<div class="table-responsive mx-9 mt-n6">
			...
			<div class="tab-pane fade" id="kt_charts_widget_37_tab_content_5">
				<!--begin::Chart-->
				<div id="kt_charts_widget_37_chart_5" data-kt-chart-color="danger" class="min-h-auto h-200px ps-3 pe-6">
				</div>
				<!--end::Chart-->
				<!--begin::Table container-->
				<div class="table-responsive mx-9 mt-n6">
