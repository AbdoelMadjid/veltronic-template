        ...
        <div class="m-0">
                ...
                <div class="d-flex align-items-center me-2">
                    ...
                    <div class="symbol symbol-50px me-5">
                        <div class="symbol-label bg-light">
                            <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/plurk.svg', $theme_asset_pack ?? null) }}" class="h-50" alt="" />
                        </div>
                    </div>
                    <!--end::Symbol-->
                    <!--begin::Title-->
            ...
            <div class="d-flex flex-stack mb-9">
                ...
                <div class="d-flex align-items-center me-2">
                    ...
                    <div class="symbol symbol-50px me-5">
                        <div class="symbol-label bg-light">
                            <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/telegram-2.svg', $theme_asset_pack ?? null) }}" class="h-50" alt="" />
                        </div>
                    </div>
                    <!--end::Symbol-->
                    <!--begin::Title-->
                    <div>
                        <a href="javascript:void(0)" class="fs-6 text-gray-800 text-hover-primary fw-bold">Binford Ltd.</a>
            ...
            <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center me-2">
                    ...
                    <div class="symbol symbol-50px me-5">
                        <div class="symbol-label bg-light">
                            <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/vimeo.svg', $theme_asset_pack ?? null) }}" class="h-50" alt="" />
                        </div>
                    </div>
                    <!--end::Symbol-->
                    <!--begin::Title-->
                    <div>
                        <a href="javascript:void(0)" class="fs-6 text-gray-800 text-hover-primary fw-bold">Biffco Enterprises</a>
