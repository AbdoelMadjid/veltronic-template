	...
	<div class="card-body py-0">
		...
		<div class="row align-items-center lh-1 h-100">
			...
			<div class="col-7 ps-xl-10 pe-5">
				...
				<!--end::Title-->
				<!--begin::Text-->
				<span class="fw-semibold text-white fs-6 mb-10 d-block opacity-75">Flat cartoony and illustrations with
				...
				<div class="d-flex d-grid gap-2">
					<a href="javascript:void(0)" class="btn btn-success me-lg-2" data-bs-toggle="modal"
						data-bs-target="#kt_modal_upgrade_plan">Upgrade</a>
					<a href="javascript:void(0)" class="btn text-white" style="background: rgba(255, 255, 255, 0.2)"
			...
			<div class="col-5 pt-5 pt-lg-15">
				...
				<div class="bgi-no-repeat bgi-size-contain bgi-position-x-end bgi-position-y-bottom h-325px"
					style="background-image:url('{{ \App\Support\ThemeAsset::url('media/svg/illustrations/easy/8.svg', $theme_asset_pack ?? null) }}')"></div>
				<!--end::Illustration-->
			</div>
			<!--end::Col-->
		</div>
