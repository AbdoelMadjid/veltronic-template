...
<div class="card card-xl-stretch bg-body border-0 mb-5 mb-xl-0">
	...
	<div class="card-body d-flex flex-column flex-lg-row flex-stack p-lg-15">
		...
		<div
			...
			<a href='javascript:void(0)' class="btn btn-success fw-semibold px-6 py-3" data-bs-toggle="modal"
				data-bs-target="#kt_modal_create_campaign">Create an Store</a>
		</div>
		<!--end::Info-->
		<!--begin::Illustration-->
		<img src="{{ \App\Support\ThemeAsset::url('media/illustrations/sketchy-1/11.png', $theme_asset_pack ?? null) }}" alt="" class="mw-200px mw-lg-350px mt-lg-n10" />
		<!--end::Illustration-->
	</div>
	<!--end::Body-->
</div>
