	...
	<div class="card-body d-flex flex-column pt-13 pb-14">
		...
		<div class="m-0">
			...
			<div class="flex-grow-1 bgi-no-repeat bgi-size-contain bgi-position-x-center card-rounded-bottom h-200px mh-200px my-5 mb-lg-12"
				style="background-image:url('{{ \App\Support\ThemeAsset::url('media/svg/illustrations/easy/6.svg', $theme_asset_pack ?? null) }}')"></div>
			<!--end::Illustration-->
		</div>
		<!--end::Heading-->
		<!--begin::Links-->
		<div class="text-center">
			<!--begin::Link-->
			<a class="btn btn-sm btn-success btn-color-white me-2" data-bs-target="#kt_modal_invite_friends"
				data-bs-toggle="modal">Psychologist</a>
			<!--end::Link-->
			<!--begin::Link-->
			<a class="btn btn-sm bg-white btn-color-white bg-opacity-20" href="{{ url('pages/general/careers/list') }}">Nurse</a>
			<!--end::Link-->
		</div>
		<!--end::Links-->
	</div>
