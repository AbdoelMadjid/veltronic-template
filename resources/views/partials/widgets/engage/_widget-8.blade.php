	...
	<div class="card-body">
		...
		<div class="row align-items-center h-100">
			...
			<div class="col-7 ps-xl-13">
				...
				<!--end::Title-->
				<!--begin::Text-->
				<span class="fw-semibold text-white fs-6 mb-8 d-block opacity-75">Flat cartoony and illustrations with
					vivid unblended purple hair lady</span>
				<!--end::Text-->
				<!--begin::Items-->
				...
				<div class="d-flex flex-column flex-sm-row d-grid gap-2">
					<a href="javascript:void(0)" class="btn btn-success flex-shrink-0 me-lg-2" data-bs-toggle="modal"
						data-bs-target="#kt_modal_upgrade_plan">Upgrade Plan</a>
					<a href="javascript:void(0)" class="btn btn-primary flex-shrink-0" style="background: rgba(255, 255, 255, 0.2)"
