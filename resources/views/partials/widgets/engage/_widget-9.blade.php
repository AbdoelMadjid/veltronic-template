		...
		<div class="row align-items-center">
			...
			<div class="col-sm-7 pe-0 mb-5 mb-sm-0">
				...
				<div class="d-flex justify-content-between h-100 flex-column pt-xl-5 pb-xl-2 ps-xl-7">
					...
					<div class="mb-7">
						...
						<div class="d-flex align-items-center flex-wrap d-grid gap-2">
							...
							<div class="d-flex align-items-center me-5 me-xl-13">
								...
								<!--begin::Info-->
								<div class="m-0">
									<a href="{{ url('pages/general/user-profile/projects') }}"
							...
							<div class="d-flex align-items-center">
								...
								<!--begin::Info-->
								<div class="m-0">
									<a href="{{ url('apps/user-management/users/list') }}"
					...
					<!--begin::Action-->
					<div class="m-0">
						<a href="javascript:void(0)" class="btn btn-color-white bg-white bg-opacity-15 bg-hover-opacity-25 fw-semibold"
