...
<div class="card mb-5 mb-xxl-8">
	...
	<div class="card-body pb-0">
		...
		<div class="d-flex align-items-center mb-5">
			...
			<div class="d-flex align-items-center flex-grow-1">
				...
				<div class="d-flex flex-column">
					<a href="javascript:void(0)" class="text-gray-900 text-hover-primary fs-6 fw-bold">Nick Logan</a>
		...
		<div class="mb-5">
			<!--begin::Text-->
			<p class="text-gray-800 fw-normal mb-5">Outlines keep you honest. They stop you from indulging in poorly
				thought-out metaphors about driving and keep you focused on the overall structure of your post</p>
			<!--end::Text-->
			<!--begin::Toolbar-->
			<div class="d-flex align-items-center mb-5">
