    ...
    <div class="card-body pt-4">
        ...
        <div class="d-flex flex-stack">
            ...
            <div class="d-flex align-items-center me-5">
                ...
                <div class="me-5">
                    <!--begin::Title-->
                    <a href="javascript:void(0)" class="text-gray-800 fw-bold text-hover-primary fs-6">Ships</a>
                    <!--end::Title-->
                    <!--begin::Desc-->
        ...
        <div class="d-flex flex-stack">
            ...
            <div class="d-flex align-items-center me-5">
                ...
                <div class="me-5">
                    <!--begin::Title-->
                    <a href="javascript:void(0)" class="text-gray-800 fw-bold text-hover-primary fs-6">Trucks</a>
                    <!--end::Title-->
                    <!--begin::Desc-->
        ...
        <div class="d-flex flex-stack">
            ...
            <div class="d-flex align-items-center me-5">
                ...
                <div class="me-5">
                    <!--begin::Title-->
                    <a href="javascript:void(0)" class="text-gray-800 fw-bold text-hover-primary fs-6">Planes</a>
                    <!--end::Title-->
                    <!--begin::Desc-->
        ...
        <div class="d-flex flex-stack">
            ...
            <div class="d-flex align-items-center me-5">
                ...
                <div class="me-5">
                    <!--begin::Title-->
                    <a href="javascript:void(0)" class="text-gray-800 fw-bold text-hover-primary fs-6">Trains</a>
                    <!--end::Title-->
                    <!--begin::Desc-->
        ...
        <div class="text-center pt-9">
            <a href="{{ url('apps/ecommerce/catalog/add-product') }}" class="btn btn-primary">Add Vehicle</a>
        </div>
    </div>
    <!--end::Body-->
</div>
