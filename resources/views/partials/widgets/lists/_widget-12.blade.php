        ...
        <div class="w-100">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="d-flex align-items-center flex-stack flex-wrap d-grid gap-1 flex-row-fluid">
                    ...
                    <div class="me-5">
                        <!--begin::Title-->
                        <a href="javascript:void(0)" class="text-gray-800 fw-bold text-hover-primary fs-6">Direct Source</a>
                        <!--end::Title-->
                        <!--begin::Desc-->
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="d-flex align-items-center flex-stack flex-wrap d-grid gap-1 flex-row-fluid">
                    ...
                    <div class="me-5">
                        <!--begin::Title-->
                        <a href="javascript:void(0)" class="text-gray-800 fw-bold text-hover-primary fs-6">Social Networks</a>
                        <!--end::Title-->
                        <!--begin::Desc-->
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="d-flex align-items-center flex-stack flex-wrap d-grid gap-1 flex-row-fluid">
                    ...
                    <div class="me-5">
                        <!--begin::Title-->
                        <a href="javascript:void(0)" class="text-gray-800 fw-bold text-hover-primary fs-6">Email Newsletter</a>
                        <!--end::Title-->
                        <!--begin::Desc-->
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="d-flex align-items-center flex-stack flex-wrap d-grid gap-1 flex-row-fluid">
                    ...
                    <div class="me-5">
                        <!--begin::Title-->
                        <a href="javascript:void(0)" class="text-gray-800 fw-bold text-hover-primary fs-6">Referrals</a>
                        <!--end::Title-->
                        <!--begin::Desc-->
            ...
            <div class="text-center pt-8 d-1">
                <a href="{{ url('apps/ecommerce/sales/details') }}" class="text-primary opacity-75-hover fs-6 fw-bold">View
                    Store Analytics
