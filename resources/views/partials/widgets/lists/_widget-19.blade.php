...
<div class="card card-flush h-xl-100">
    ...
    <div class="card-header rounded bgi-no-repeat bgi-size-cover bgi-position-y-top bgi-position-x-center align-items-start h-250px"
        style="background-image:url('{{ \App\Support\ThemeAsset::url('media/svg/shapes/top-green.png', $theme_asset_pack ?? null) }}')" data-bs-theme="light">
        <!--begin::Title-->
        <h3 class="card-title align-items-start flex-column text-white pt-15">
            ...
            <div class="fs-4 text-white">
                ...
                <span class="position-relative d-inline-block">
                    <a href="{{ url('pages/general/user-profile/projects') }}" class="link-white opacity-75-hover fw-bold d-block mb-1">4
                        tasks</a>
                    <!--begin::Separator-->
                    <span
