    ...
    <div class="card-body pt-6">
        ...
        <div class="d-flex flex-stack">
            ...
            <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                <!--begin:Author-->
                <div class="flex-grow-1 me-2">
                    <a href="{{ url('pages/general/user-profile/overview') }}" class="text-gray-800 text-hover-primary fs-6 fw-bold">QA
                        Analysis</a>
        ...
        <div class="d-flex flex-stack">
            ...
            <div class="d-flex align-items-center flex-row-fluid flex-wrap">
                <!--begin:Author-->
                <div class="flex-grow-1 me-2">
                    <a href="{{ url('pages/general/user-profile/overview') }}" class="text-gray-800 text-hover-primary fs-6 fw-bold">Web
                        Development</a>
