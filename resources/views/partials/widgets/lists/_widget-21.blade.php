...
<div class="card card-flush h-xl-100">
    ...
    <div class="card-header border-0 pt-5">
        ...
        <div class="card-toolbar">
            <a href="javascript:void(0)" class="btn btn-sm btn-light">All Lessons</a>
        </div>
        <!--end::Toolbar-->
    </div>
    <!--end::Header-->
    ...
    <div class="card-body pt-5">
        ...
        <div class="d-flex flex-stack">
            ...
            <div class="d-flex align-items-center me-3">
                <!--begin::Logo-->
                <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/laravel-2.svg', $theme_asset_pack ?? null) }}" class="me-4 w-30px" alt="" />
                <!--end::Logo-->
                <!--begin::Section-->
                <div class="flex-grow-1">
                    <!--begin::Text-->
                    <a href="javascript:void(0)" class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Laravel</a>
                    <!--end::Text-->
                    <!--begin::Description-->
        ...
        <div class="d-flex flex-stack">
            ...
            <div class="d-flex align-items-center me-3">
                <!--begin::Logo-->
                <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/vue-9.svg', $theme_asset_pack ?? null) }}" class="me-4 w-30px" alt="" />
                <!--end::Logo-->
                <!--begin::Section-->
                <div class="flex-grow-1">
                    <!--begin::Text-->
                    <a href="javascript:void(0)" class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Vue 3</a>
                    <!--end::Text-->
                    <!--begin::Description-->
        ...
        <div class="d-flex flex-stack">
            ...
            <div class="d-flex align-items-center me-3">
                <!--begin::Logo-->
                <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/bootstrap5.svg', $theme_asset_pack ?? null) }}" class="me-4 w-30px" alt="" />
                <!--end::Logo-->
                <!--begin::Section-->
                <div class="flex-grow-1">
                    <!--begin::Text-->
                    <a href="javascript:void(0)" class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Bootstrap 5</a>
                    <!--end::Text-->
                    <!--begin::Description-->
        ...
        <div class="d-flex flex-stack">
            ...
            <div class="d-flex align-items-center me-3">
                <!--begin::Logo-->
                <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/angular-icon.svg', $theme_asset_pack ?? null) }}" class="me-4 w-30px" alt="" />
                <!--end::Logo-->
                <!--begin::Section-->
                <div class="flex-grow-1">
                    <!--begin::Text-->
                    <a href="javascript:void(0)" class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Angular 16</a>
                    <!--end::Text-->
                    <!--begin::Description-->
                    <span class="text-gray-500 fw-semibold d-block fs-6">JS Framework</span>
                    <!--end::Description=-->
        ...
        <div class="d-flex flex-stack">
            ...
            <div class="d-flex align-items-center me-3">
                <!--begin::Logo-->
                <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/spring-3.svg', $theme_asset_pack ?? null) }}" class="me-4 w-30px" alt="" />
                <!--end::Logo-->
                <!--begin::Section-->
                <div class="flex-grow-1">
                    <!--begin::Text-->
                    <a href="javascript:void(0)" class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">Spring</a>
                    <!--end::Text-->
                    <!--begin::Description-->
        ...
        <div class="d-flex flex-stack">
            ...
            <div class="d-flex align-items-center me-3">
                <!--begin::Logo-->
                <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/typescript-1.svg', $theme_asset_pack ?? null) }}" class="me-4 w-30px" alt="" />
                <!--end::Logo-->
                <!--begin::Section-->
                <div class="flex-grow-1">
                    <!--begin::Text-->
                    <a href="javascript:void(0)" class="text-gray-800 text-hover-primary fs-5 fw-bold lh-0">TypeScript</a>
                    <!--end::Text-->
                    <!--begin::Description-->
