...
<div class="card card-flush h-lg-50">
    ...
    <div class="card-body pt-5">
        ...
        <div class="d-flex flex-stack">
            <!--begin::Section-->
            <a href="javascript:void(0)" class="text-primary fw-semibold fs-6 me-2">Avg. Client Rating</a>
            <!--end::Section-->
            <!--begin::Action-->
            <button type="button"
        ...
        <div class="d-flex flex-stack">
            <!--begin::Section-->
            <a href="javascript:void(0)" class="text-primary fw-semibold fs-6 me-2">Instagram Followers</a>
            <!--end::Section-->
            <!--begin::Action-->
            <button type="button"
                class="btn btn-icon btn-sm h-auto btn-color-gray-500 btn-active-color-primary justify-content-end">
        ...
        <div class="d-flex flex-stack">
            <!--begin::Section-->
            <a href="javascript:void(0)" class="text-primary fw-semibold fs-6 me-2">Google Ads CPC</a>
            <!--end::Section-->
            <!--begin::Action-->
            <button type="button"
                class="btn btn-icon btn-sm h-auto btn-color-gray-500 btn-active-color-primary justify-content-end">
