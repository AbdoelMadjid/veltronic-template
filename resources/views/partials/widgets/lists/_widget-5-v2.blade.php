...
<div class="card card-xl-stretch">
    ...
    <div class="card-header align-items-center border-0 mt-4">
        ...
        <div class="card-toolbar">
            ...
            @include('partials.menus._menu-1-v2')
            <!--end::Menu-->
        </div>
    </div>
    <!--end::Header-->
        ...
        <div class="timeline-label">
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-content fw-bold text-gray-800 ps-3">
                    Make deposit
                    <a href="javascript:void(0)" class="text-primary">USD 700</a>.
                    to ESL
                </div>
                <!--end::Desc-->
            </div>
            ...
            <div class="timeline-item">
                ...
                <div class="timeline-content fw-semibold text-gray-800 ps-3">
                    New order placed <a href="javascript:void(0)" class="text-primary">#XF-2356</a>.
                </div>
                <!--end::Desc-->
            </div>
            <!--end::Item-->
