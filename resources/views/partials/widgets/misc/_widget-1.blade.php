...
<div class="row mb-5 mb-xl-8 g-5 g-xl-8">
    ...
    <div class="col-6">
        ...
        <a class="card flex-column justfiy-content-start align-items-start text-start w-100 text-gray-800 text-hover-primary p-10"
            href="{{ url('pages/account/overview') }}">
    ...
    <div class="col-6">
        <!--begin::Card-->
        <a class="card flex-column justfiy-content-start align-items-start text-start w-100 text-gray-800 text-hover-primary p-10"
            href="{{ url('pages/account/statements') }}">
    ...
    <div class="col-6">
        <!--begin::Card-->
        <a class="card flex-column justfiy-content-start align-items-start text-start w-100 text-gray-800 text-hover-primary p-10"
            href="{{ url('pages/account/referrals') }}">
    ...
    <div class="col-6">
        <!--begin::Card-->
        <a class="card flex-column justfiy-content-start align-items-start text-start w-100 text-gray-800 text-hover-primary p-10"
            href="{{ url('apps/chat/private') }}">
            <i class="ki-duotone ki-timer fs-2tx mb-5 ms-n1 text-gray-500">
                <span class="path1"></span>
                <span class="path2"></span>
                <span class="path3"></span>
            </i>
            <span class="fs-4 fw-bold">Messages</span>
        </a>
        <!--end::Card-->
    </div>
    <!--end::Col-->
