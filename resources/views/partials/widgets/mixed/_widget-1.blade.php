        ...
        <div class="bg-body shadow-sm card-rounded mx-9 mb-9 px-6 py-9 position-relative z-index-1"
            ...
            <div class="d-flex align-items-center mb-6">
                ...
                <div class="d-flex align-items-center flex-wrap w-100">
                    ...
                    <div class="mb-1 pe-3 flex-grow-1">
                        <a href="javascript:void(0)" class="fs-5 text-gray-800 text-hover-primary fw-bold">Sales</a>
            ...
            <div class="d-flex align-items-center mb-6">
                ...
                <div class="d-flex align-items-center flex-wrap w-100">
                    <!--begin::Title-->
                    <div class="mb-1 pe-3 flex-grow-1">
                        <a href="javascript:void(0)" class="fs-5 text-gray-800 text-hover-primary fw-bold">Revenue</a>
            ...
            <div class="d-flex align-items-center mb-6">
                ...
                <div class="d-flex align-items-center flex-wrap w-100">
                    <!--begin::Title-->
                    <div class="mb-1 pe-3 flex-grow-1">
                        <a href="javascript:void(0)" class="fs-5 text-gray-800 text-hover-primary fw-bold">Growth</a>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="d-flex align-items-center flex-wrap w-100">
                    <!--begin::Title-->
                    <div class="mb-1 pe-3 flex-grow-1">
                        <a href="javascript:void(0)" class="fs-5 text-gray-800 text-hover-primary fw-bold">Dispute</a>
