...
<div class="card card-xl-stretch bg-body border-0">
    ...
    <div class="card-body pt-5 mb-xl-9 position-relative">
                        ...
                        <div class="mb-10">
                            ...
                            <div>
                                <select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true"
                                    ...
                                    data-dropdown-parent="#kt_menu_65a10ad53593a" data-allow-clear="true">
                                    <option></option>
        ...
        <div class="text-center position-absolute bottom-0 start-50 translate-middle-x w-100 mb-10">
            <!--begin::Text-->
            <p class="fw-semibold fs-4 text-gray-500 mb-7 px-5">Long before you sit down to put the
                <br />make sure you breathe
            </p>
            <!--end::Text-->
            <!--begin::Action-->
            <div class="m-0">
                <a href='javascript:void(0)' class="btn btn-success fw-semibold" data-bs-toggle="modal"
