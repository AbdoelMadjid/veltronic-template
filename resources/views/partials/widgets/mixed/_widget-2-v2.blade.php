        ...
        <div class="card-p mt-n20 position-relative">
            ...
            <div class="row g-0">
                ...
                <div class="col d-flex flex-column bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                    <i class="ki-duotone ki-chart-simple fs-2x text-warning my-2"><span class="path1"></span><span
                            class="path2"></span><span class="path3"></span><span class="path4"></span></i> <a
                        href="javascript:void(0)" class="text-warning fw-semibold fs-6">
                        Weekly Sales
                    </a>
                </div>
                <!--end::Col-->
                ...
                <div class="col d-flex flex-column bg-light-primary px-6 py-8 rounded-2 mb-7">
                    <i class="ki-duotone ki-briefcase fs-2x text-primary my-2"><span class="path1"></span><span
                            class="path2"></span></i> <a href="javascript:void(0)" class="text-primary fw-semibold fs-6">
                        New Projects
                    </a>
                </div>
                <!--end::Col-->
            ...
            <div class="row g-0">
                ...
                <div class="col d-flex flex-column bg-light-danger px-6 py-8 rounded-2 me-7">
                    <i class="ki-duotone ki-abstract-26 fs-2x text-danger my-2"><span class="path1"></span><span
                            class="path2"></span></i> <a href="javascript:void(0)" class="text-danger fw-semibold fs-6 mt-2">
                        Item Orders
                    </a>
                </div>
                <!--end::Col-->
                ...
                <div class="col d-flex flex-column bg-light-success px-6 py-8 rounded-2">
                    <i class="ki-duotone ki-sms fs-2x text-success my-2"><span class="path1"></span><span
                            class="path2"></span></i> <a href="javascript:void(0)" class="text-success fw-semibold fs-6 mt-2">
                        Bug Reports
                    </a>
                </div>
                <!--end::Col-->
