@php
    $mixedWidget2Variant = $mixedWidget2Variant ?? null
@endphp
@if ($mixedWidget2Variant === 'a')
        ...
        <div class="card-p mt-n20 position-relative">
            ...
            <div class="row g-0">
                ...
                <div class="col d-flex flex-column bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                    ...
                    <a href="javascript:void(0)" class="text-warning fw-semibold fs-6">Weekly Sales</a>
                </div>
                <!--end::Col-->
                <!--begin::Col-->
                <div class="col d-flex flex-column bg-light-primary px-6 py-8 rounded-2 mb-7">
                    ...
                    <a href="javascript:void(0)" class="text-primary fw-semibold fs-6">New Projects</a>
                </div>
                <!--end::Col-->
            </div>
            <!--end::Row-->
            ...
            <div class="row g-0">
                ...
                <div class="col d-flex flex-column bg-light-danger px-6 py-8 rounded-2 me-7">
                    ...
                    <a href="javascript:void(0)" class="text-danger fw-semibold fs-6 mt-2">Item Orders</a>
                </div>
                <!--end::Col-->
                <!--begin::Col-->
                <div class="col d-flex flex-column bg-light-success px-6 py-8 rounded-2">
                    ...
                    <a href="javascript:void(0)" class="text-success fw-semibold fs-6 mt-2">Bug Reports</a>
                </div>
                <!--end::Col-->
            </div>
            <!--end::Row-->
