...
<div class="card card-xl-stretch mb-xl-8">
                    ...
                    <div class="mb-10">
                        ...
                        <div>
                            <select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true"
                                ...
                                data-dropdown-parent="#kt_menu_65a12148735bd" data-allow-clear="true">
                                <option></option>
    ...
    <div class="card-body d-flex flex-column">
        ...
        <div class="pt-5">
            ...
            <a href="javascript:void(0)" class="btn btn-primary w-100 py-3">Take Action</a>
        </div>
    </div>
    <!--end::Body-->
</div>
