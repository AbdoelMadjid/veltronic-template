@php
    $mixedWidget5Variant = $mixedWidget5Variant ?? null
@endphp
@if ($mixedWidget5Variant === 'a')
        ...
        <div class="mt-5">
            ...
            <div class="d-flex flex-stack mb-5">
                ...
                <div class="d-flex align-items-center me-2">
                    ...
                    <div class="symbol symbol-50px me-3">
                        <div class="symbol-label bg-light">
                            <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/figma-1.svg', $theme_asset_pack ?? null) }}" class="h-50" alt="" />
                        </div>
                    </div>
                    <!--end::Symbol-->
                    <!--begin::Title-->
