        ...
        <ul class="nav nav-pills nav-pills-custom mb-3">
            ...
            <li class="nav-item mb-3 me-3 me-lg-6">
                ...
                <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden active w-80px h-85px py-4"
                    ...
                    <!--begin::Icon-->
                    <div class="nav-icon">
                        <img alt="" src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/beats-electronics.svg', $theme_asset_pack ?? null) }}" class="" />
                    </div>
                    <!--end::Icon-->
                    <!--begin::Subtitle-->
            ...
            <li class="nav-item mb-3 me-3 me-lg-6">
                ...
                <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                    ...
                    <!--begin::Icon-->
                    <div class="nav-icon">
                        <img alt="Logo" src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/amazon.svg', $theme_asset_pack ?? null) }}" class="theme-light-show" />
                        <img alt="Logo" src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/amazon-dark.svg', $theme_asset_pack ?? null) }}"
            ...
            <li class="nav-item mb-3 me-3 me-lg-6">
                ...
                <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                    ...
                    <!--begin::Icon-->
                    <div class="nav-icon">
                        <img alt="" src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/bp-2.svg', $theme_asset_pack ?? null) }}" class="" />
                    </div>
                    <!--end::Icon-->
                    <!--begin::Subtitle-->
            ...
            <li class="nav-item mb-3 me-3 me-lg-6">
                ...
                <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
                    ...
                    <!--begin::Icon-->
                    <div class="nav-icon">
                        <img alt="" src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/slack-icon.svg', $theme_asset_pack ?? null) }}" class="nav-icon" />
                    </div>
                    <!--end::Icon-->
                    <!--begin::Subtitle-->
            ...
            <li class="nav-item mb-3">
                <!--begin::Link-->
                <a class="nav-link d-flex flex-center overflow-hidden w-80px h-85px" data-bs-toggle="modal"
                    data-bs-target="#kt_modal_create_campaign" href="javascript:void(0)">
                    <!--begin::Icon-->
                    <div class="nav-icon">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table align-middle gs-0 gy-4 my-0">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <a href="javascript:void(0)" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Best
                            ...
                            <tr>
                                <td>
                                    <a href="javascript:void(0)" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">New
                                        Model BS 2000 X</a>
                                </td>
                                <td class="text-end">
                            ...
                            <tr>
                                <td>
                                    <a href="javascript:void(0)" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">2022
