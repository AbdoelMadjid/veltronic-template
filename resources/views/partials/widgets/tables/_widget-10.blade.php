@php
    $tablesWidget10Variant = $tablesWidget10Variant ?? null
@endphp
@if ($tablesWidget10Variant === 'a')
        ...
        <div class="table-responsive">
            ...
            <table class="table table-row-dashed align-middle gs-0 gy-4">
                ...
                <tbody>
                    <tr>
                        <td class="" colspan="2">
                            <a href="javascript:void(0)" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Index</a>
                        </td>
                    ...
                    <tr>
                        <td class="" colspan="2">
                            <a href="javascript:void(0)" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Products</a>
                        </td>
                        <td class="pe-0" colspan="2">
                            <div class="d-flex justify-content-end">
                    ...
                    <tr>
                        <td class="" colspan="2">
                            <a href="javascript:void(0)" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Licenses</a>
                        </td>
                        <td class="pe-0" colspan="2">
                            <div class="d-flex justify-content-end">
