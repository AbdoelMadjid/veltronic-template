                ...
                <tbody>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex justify-content-start flex-column">
                                    <a href="javascript:void(0)" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Mivy
                                        App</a>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="symbol symbol-50px me-3">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-40.jpg', $theme_asset_pack ?? null) }}" class="" alt="" />
                                </div>
                                <div class="d-flex justify-content-start flex-column">
                                    <a href="javascript:void(0)"
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="symbol symbol-50px me-3">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-39.jpg', $theme_asset_pack ?? null) }}" class="" alt="" />
                                </div>
                                <div class="d-flex justify-content-start flex-column">
                                    <a href="javascript:void(0)" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Charto
                                        CRM</a>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="symbol symbol-50px me-3">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-47.jpg', $theme_asset_pack ?? null) }}" class="" alt="" />
                                </div>
                                <div class="d-flex justify-content-start flex-column">
                                    <a href="javascript:void(0)" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Tower
                                        Hill</a>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="symbol symbol-50px me-3">
                                    <img src="{{ \App\Support\ThemeAsset::url('media/stock/600x600/img-48.jpg', $theme_asset_pack ?? null) }}" class="" alt="" />
                                </div>
                                <div class="d-flex justify-content-start flex-column">
                                    <a href="javascript:void(0)" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">9
                                        Degree</a>
