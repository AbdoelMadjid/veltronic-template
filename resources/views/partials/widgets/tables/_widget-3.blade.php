@php
    $tableWidget3CardClass = $tableWidget3CardClass ?? 'card card-flush h-xl-100';
    $tableWidget3FilterMenuId = $tableWidget3FilterMenuId ?? 'kt_menu_65a12155119f5';
@endphp
<!--begin::Table Widget 3-->
<div class="{{ $tableWidget3CardClass }}">
    <!--begin::Card header-->
    <div class="card-header py-7">
        ...
        <div class="card-title pt-3 mb-0 gap-4 gap-lg-10 gap-xl-15 nav nav-tabs border-bottom-0"
            ...
            <div class="fs-4 fw-bold pb-3 border-bottom border-3 border-primary cursor-pointer"
                data-kt-table-widget-3="tab" data-kt-table-widget-3-value="Show All">All Campaigns (47)</div>
            <!--end::Tab item-->
            <!--begin::Tab item-->
        ...
        <div class="card-toolbar">
            <a href="javascript:void(0)" type="button" class="btn btn-primary" data-bs-toggle="modal"
    ...
    <div class="card-body pt-1">
        ...
        <div class="d-flex flex-stack flex-wrap gap-4">
            ...
            <div class="d-flex align-items-center gap-4">
                <!--begin::Filter button-->
                <a href="javascript:void(0)" class="text-hover-primary ps-4" data-kt-menu-trigger="click"
                        ...
                        <div class="mb-10">
                            ...
                            <div>
                                <select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true"
                                    ...
                                    data-dropdown-parent="#{{ $tableWidget3FilterMenuId }}" data-allow-clear="true">
                                    <option></option>
            ...
            <tbody>
                <tr>
                    <td class="min-w-175px">
                        <div class="position-relative ps-6 pe-3 py-2">
                            ...
                            <a href="javascript:void(0)" class="mb-1 text-gray-900 text-hover-primary fw-bold">Happy
                                Christmas</a>
                    ...
                    <td>
                        ...
                        <div class="d-flex gap-2 mb-2">
                            ...
                            <a href="javascript:void(0)">
                                <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/twitter-2.svg', $theme_asset_pack ?? null) }}"
                                    class="w-20px" alt="" />
                            </a>
                            <a href="javascript:void(0)">
                                <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/linkedin-2.svg', $theme_asset_pack ?? null) }}"
                                    class="w-20px" alt="" />
                            </a>
                            <a href="javascript:void(0)">
                                <img src="{{ \App\Support\ThemeAsset::url('media/svg/brand-logos/youtube-3.svg', $theme_asset_pack ?? null) }}"
                                    class="w-20px" alt="" />
                            </a>
                        </div>
                        <!--end::Icons-->
                    ...
                    <td class="min-w-125px">
                        ...
                        <div class="symbol-group symbol-hover mb-1">
                            ...
                            <!--begin::Member-->
                            <div class="symbol symbol-circle symbol-25px">
                                <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-5.jpg', $theme_asset_pack ?? null) }}"
                                    alt="" />
                            </div>
                            <!--end::Member-->
                            <!--begin::Member-->
                            <div class="symbol symbol-circle symbol-25px">
                                <img src="{{ \App\Support\ThemeAsset::url('media/avatars/300-25.jpg', $theme_asset_pack ?? null) }}"
                                    alt="" />
                            </div>
                            <!--end::Member-->
                            <!--begin::Member-->
                ...
                <tr>
                    <td class="min-w-175px">
                        <div class="position-relative ps-6 pe-3 py-2">
                            ...
                            <a href="javascript:void(0)" class="mb-1 text-gray-900 text-hover-primary fw-bold">Cyber
                                Monday</a>
                            <div class="fs-7 text-muted fw-bold">Created on 24 Dec 21</div>
                        </div>
                    </td>
                ...
                <tr>
                    <td class="min-w-175px">
                        <div class="position-relative ps-6 pe-3 py-2">
                            <div class="position-absolute start-0 top-0 w-4px h-100 rounded-2 bg-success"></div>
                            <a href="javascript:void(0)" class="mb-1 text-gray-900 text-hover-primary fw-bold">Team
                                Getaway</a>
                            <div class="fs-7 text-muted fw-bold">Created on 24 Dec 21</div>
                        </div>
                    </td>
