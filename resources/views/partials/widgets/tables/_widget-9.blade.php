@php
    $tablesWidget9Variant = $tablesWidget9Variant ?? null
@endphp
@if ($tablesWidget9Variant === 'a')
        ...
        <div class="table-responsive">
            ...
            <table class="table table-row-dashed align-middle gs-0 gy-4">
                ...
                <tbody>
                    <tr>
                        <td class="" colspan="2">
                            <a href="javascript:void(0)" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Google</a>
                        </td>
                    ...
                    <tr>
                        <td class="" colspan="2">
                            <a href="javascript:void(0)" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Facebook</a>
                        </td>
                        <td class="pe-0" colspan="2">
                            <div class="d-flex justify-content-end">
                    ...
                    <tr>
                        <td class="" colspan="2">
                            <a href="javascript:void(0)" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Bol.com</a>
                        </td>
                        <td class="pe-0" colspan="2">
                            <div class="d-flex justify-content-end">
                    ...
                    <tr>
                        <td class="" colspan="2">
                            <a href="javascript:void(0)" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Themeforest</a>
                        </td>
                        <td class="pe-0" colspan="2">
                            <div class="d-flex justify-content-end">
